# MTZ-BETHA-Geracao_do_Meio_Magnetico_sit_especial

- **Fonte:** MTZ-BETHA-Geracao_do_Meio_Magnetico_sit_especial.docx
...
Além disso, essa OS visas incluir novos municípios a serem atendidos pelo validador BETHA\.
...
A geração dos registros de entrada deve seguir as regras já estabelecidas para a geração normal\.

Obs: O arquivo deve conter apenas notas cujo código do município ISS da capa da nota fiscal está preenchido com o município referente a BETHA em questão\.
