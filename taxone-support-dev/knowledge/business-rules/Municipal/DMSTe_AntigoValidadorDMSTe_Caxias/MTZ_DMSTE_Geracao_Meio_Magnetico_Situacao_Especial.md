# MTZ_DMSTE_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_DMSTE_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o município de Caxias do Sul/RS\.
...
O arquivo deve conter apenas o registro de serviços Tomados e Prestados com a mesma estrutura do layout\. \(vide: MTZ\_DMSTE\_Caxias do Sul\_Geracao do Meio\_Magnetico\.docx\)
