# MTZ_EISS_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_EISS_Geracao_Meio_Magnetico_Situacao_Especial.docx
- **Modificado:** 2021-09-28
- **Tamanho:** 65 KB
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o município de Louveira\.

MFS\-73049

Alessandra Cristina Navatta

Alteração da descrição do validador de EISS Louveira para EISS
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador EISS LOUVEIRA e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
Desconsiderar as notas fiscais com as seguintes características:

- Se a pessoa física/jurídica vinculada na nota fiscal for do exterior \(campo UF da tabela SAFX04 = “EX”\)

O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide MTZ\_EISS\_LOUVEIRA\_Geracao\_Meio\_Magnetico\.docx MTZ\_EISS\_Geracao\_Meio\_Magnetico\.docx\)
