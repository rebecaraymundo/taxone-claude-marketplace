# MTZ_NFSE_GIAP_PRESCON_Geracao_Meio_Magnetico_sit_especial

- **Fonte:** MTZ_NFSE_GIAP_PRESCON_Geracao_Meio_Magnetico_sit_especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador NFSE GIAP – Bragança Paulista/SP

MFS\-73910

Elisabete Costa

Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador NFSE GIAP – Cotia/SP
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador “NFSE\-GIAP\-PRESCON” \(7605\) \-Bragança Paulista\-SP e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador “NFSE\-GIAP\-PRESCON” \(13009\) \-Cotia\-SP e que estejam devidamente licenciados e cadastrados no menu: MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais com uma ou mais inscrições municipais eventuais válidas para o município em questão\.
...
__\[MFS988031\] __Tratamento das notas fiscais eletrônicas
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide MTZ\_NFSE\_GIAP\_PRESCON\_Geracao\_Meio\_Magnetico\.docx\)
