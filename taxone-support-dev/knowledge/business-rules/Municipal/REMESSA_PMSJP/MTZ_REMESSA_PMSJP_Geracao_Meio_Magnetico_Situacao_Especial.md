# MTZ_REMESSA_PMSJP_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_REMESSA_PMSJP_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Remessa de Escrituração – São José dos Pinhais
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o município de São José dos Pinhais\.
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador REMESSA PMSJP e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide MTZ\_REMESSA\_PMSJP\_Geracao\_Meio\_Magnetico\.docx\)
