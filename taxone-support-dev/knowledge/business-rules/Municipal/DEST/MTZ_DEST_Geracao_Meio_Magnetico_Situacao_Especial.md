# MTZ_DEST_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_DEST_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador DEST\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout \(vide MTZ\_DEST\_Geracao\_Meio\_Magnetico\.docx\), e obedecer inclusive a regra de negócio para gravação do arquivo\.
