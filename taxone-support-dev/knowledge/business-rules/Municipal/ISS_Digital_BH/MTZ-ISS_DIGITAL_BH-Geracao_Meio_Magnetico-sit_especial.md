# MTZ-ISS_DIGITAL_BH-Geracao_Meio_Magnetico-sit_especial

- **Fonte:** MTZ-ISS_DIGITAL_BH-Geracao_Meio_Magnetico-sit_especial.docx
- **Modificado:** 2020-03-11
- **Tamanho:** 40 KB

---

# ISS DIGITAL BH \- Geração do meio magnético p/ estabelecimentos fora do município em questão 
...
DW \- MUNICIPAL \- ISS DIGITAL BH \- Atendimento a constução civil/telecomunicações/utilities
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador  ISS DIGITAL BH e que estejam devidamente licenciados e cadastrados no menu: MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais com uma ou mais inscrições municipais eventuais válidas para o município em questão\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide MTZ \- ISS DIGITAL BH \- Geracao do Meio Magnético\.doc\)
