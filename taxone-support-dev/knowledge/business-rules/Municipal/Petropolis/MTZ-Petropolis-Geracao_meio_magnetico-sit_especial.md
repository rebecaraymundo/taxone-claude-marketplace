# MTZ-Petropolis-Geracao_meio_magnetico-sit_especial

- **Fonte:** MTZ-Petropolis-Geracao_meio_magnetico-sit_especial.docx
- **Modificado:** 2020-03-11
- **Tamanho:** 33 KB

---

# PETROPOLIS \- Geração do meio magnético p/ estabelecimentos fora do município em questão 
...
DW \- MUNICIPAL \- PETROPOLIS \- Atendimento a constução civil/telecomunicações/utilities

Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o município atendido pelo validador PETROPOLIS\. 
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador  Petrópolis e que estejam devidamente licenciados e cadastrados no menu: MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais com uma ou mais inscrições municipais eventuais válidas para o município em questão\.
...
- Classificação do documento \(cód\_class\_doc\_fis = ‘2’, ‘3’\) 
