# MTZ_DIR_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_DIR_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o município de Caçador\.
...
Número do Lote:__ __O campo deve permitir que o usuário digite o número do lote desejado, com no máximo 10 posições\. Este campo é de preenchimento __obrigatório__\. Caso o usuário não informe valor para este campo, o sistema deverá exibir a mensagem de preenchimento obrigatório\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide: MTZ \_DIR\_Geracao\_do\_Meio\_Magnetico\.docx\)
