# MTZ_DESONLINE_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_DESONLINE_Geracao_Meio_Magnetico_Situacao_Especial.docx
- **Modificado:** 2021-07-19
- **Tamanho:** 65 KB
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador DES ONLINE\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout\. \(vide MTZ\_DESONLINE\_Geracao\_do\_Meio\_Magnetico\.docx\)
