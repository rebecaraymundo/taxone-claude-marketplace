# MTZ_SAATRI_NFSE_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_SAATRI_NFSE_Geracao_Meio_Magnetico_Situacao_Especial.docx
- **Modificado:** 2021-07-29
- **Tamanho:** 63 KB
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador SAATRI NFSE\.
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador SAATRI NFSE e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
O arquivo deve conter apenas o registro de serviços Tomados com a mesma estrutura do layout\. \(Vide: MTZ\_SAATRI\_NFSE\_Geracao\_Meio\_Magnetico\.docx\)\.
