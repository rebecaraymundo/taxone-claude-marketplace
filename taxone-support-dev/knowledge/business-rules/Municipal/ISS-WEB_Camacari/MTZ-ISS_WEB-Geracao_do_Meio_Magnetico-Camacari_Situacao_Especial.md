# MTZ-ISS_WEB-Geracao_do_Meio_Magnetico-Camacari_Situacao_Especial

- **Fonte:** MTZ-ISS_WEB-Geracao_do_Meio_Magnetico-Camacari_Situacao_Especial.docx
- **Modificado:** 2026-02-07
- **Tamanho:** 63 KB
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador ISS WEB Camaçari\.
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador ISS WEB Camaçari e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout \(vide MTZ\-ISS\_WEB\-Geracao\_do\_Meio\_Magnetico\-Camacari\.docx\), e obedecer inclusive a regra de negócio para gravação do arquivo\.
