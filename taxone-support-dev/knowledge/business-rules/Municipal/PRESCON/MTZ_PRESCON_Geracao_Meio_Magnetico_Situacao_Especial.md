# MTZ_PRESCON_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_PRESCON_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador Prescon\.
...
__Regra dos campos Data Envio Arquivo da tela Obrigações – Meio Magnético:__

Data Envio Arquivo: deve ser exibido através de um TextBox, com a máscara DD/MM/AAAA\. O sistema deve exibir o campo zerado para preenchimento do usuário\.
...
O arquivo deve conter apenas o registro de serviços tomados com a mesma estrutura do layout \(vide MTZ\_PRESCON\_Geracao\_Meio\_Magnetico\.docx\), e obedecer inclusive a regra de negócio para gravação do arquivo\.
