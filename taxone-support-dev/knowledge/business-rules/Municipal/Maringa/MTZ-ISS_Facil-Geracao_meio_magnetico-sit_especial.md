# MTZ-ISS_Facil-Geracao_meio_magnetico-sit_especial

- **Fonte:** MTZ-ISS_Facil-Geracao_meio_magnetico-sit_especial.docx
- **Modificado:** 2020-03-11
- **Tamanho:** 40 KB

---

# MARINGA \- Geração do meio magnético p/ estabelecimentos fora do município em questão 
...
DW \- MUNICIPAL \- MARINGA \- Atendimento a constução civil/telecomunicações/utilities
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador  Maringa e que estejam devidamente licenciados e cadastrados no menu: MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais com uma ou mais inscrições municipais eventuais válidas para o município em questão\.
