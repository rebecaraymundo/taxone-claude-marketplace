# MTZ_NFSENACIONAL_Geracao_Meio_Magnetico_Situacao_Especial

- **Fonte:** MTZ_NFSENACIONAL_Geracao_Meio_Magnetico_Situacao_Especial.docx
...
Este documento tem como objetivo criar a geração do meio magnético para os segmentos de Construção Civil, Utilities e Telecom para o validador NFSE Nacional\. 
...
Esse campo deverá exibir somente os estabelecimentos que não pertencem ao município em questão do validador NFSE NACIONAL e que estejam devidamente licenciados e cadastrados no menu: *MasterSAF DW – Manutenção – Cadastros – Inscrições Municipais *com uma ou mais inscrições municipais eventuais válidas para o município em* questão*\.
...
O arquivo deve conter apenas o registro de serviços Tomados com a mesma estrutura do layout\. \(vide: MTZ\_NFSENACIONAL\_Geracao do Meio\_Magnetico\.docx\)
