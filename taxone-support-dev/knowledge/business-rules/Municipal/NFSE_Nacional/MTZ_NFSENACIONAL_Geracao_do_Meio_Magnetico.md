...
Este documento tem como objetivo incluir o município de Cubatão no validador NFSE Nacional\.

Não recebemos o layout do município \(as regras e o desenvolvimento estão sendo realizados apenas com base no XML, conforme indicado no escopo da demanda\)\.

Regras criadas/ajustadas

RN08, RN09\.a, RN11\.a, RN14\.a, RN17,RN18, RN21, RN25, RN39, RN44, RN45, RN46, RN47, RN54,RN55, RN67, RN69, RN74, RN76\.1, RN78, RN103, RN104, RN105, RN106, RN108, RN117\.01, RN128, RN129

Elisabete Costa

Desprezar todas as regras criadas na MFS\-68956

Obs\.: Todas as regras referente a MFS\-68956 foram desvinculadas do código para o município de Cubatão/SP, pois o cliente aplicou o pacote desvinculado em produção e fez a entrega da obrigação ref\.ao período de 07/2021 a 03/2022, estávamos aguardando retorno do cliente e do suporte e essa demanda não foi integrada, depois o cliente comunicou que a prefeitura voltou a utilizar o validador antigo\.
...
__Para o município de Cubatão__

Além das regras citadas acima, considerar :
...
__Para o município de Cubatão:__
...
<ConsultarNfseFaixaResposta xmlns:ns2="http://www\.w3\.org/2000/09/xmldsig\#" xmlns="http://www\.abrasf\.org\.br/nfse\.xsd">
      ...
      <CompNfse>
         ...
         <Nfse versao="2\.01">
            ...
            <InfNfse>
               ...
               <DataEmissao>2019\-08\-07</DataEmissao>

               <ValoresNfse>

                  <BaseCalculo>1280\.00</BaseCalculo>

                  <Aliquota>0\.00</Aliquota>

                  <ValorIss>0\.00</ValorIss>

                  <ValorLiquidoNfse>1280\.00</ValorLiquidoNfse>
               ...
               <PrestadorServico>
                  ...
                  <Endereco>
                     ...
                     <Endereco>DIST\. 0</Endereco>

                     <Numero />

					  <Bairro>ZONA RURAL</Bairro>

                     <Complemento>KM 646, Ã€ ESQUERDA SEGUE MAIS 800 METROS</Complemento>
                  ...
                  <InfDeclaracaoPrestacaoServico>
                     ...
                     <Servico>
                        ...
                        <Valores>
                           ...
                           <ValorServicos>1280\.00</ValorServicos>
                        ...
                        <ItemListaServico>7\.16</ItemListaServico>

                        <CodigoCnae>161003</CodigoCnae>

                        <Discriminacao>PRESTACAO DE SERVICOS DE CARPA QUIMICA NA FAZENDA BOA VISTA MUNICIPIO DE GOIATUBAGO</Discriminacao>
                     ...
                     <Prestador>
                        ...
                        <CpfCnpj>
                           ...
                           <Cnpj>56124506000100</Cnpj>

                        </CpfCnpj>

                        <InscricaoMunicipal>38519001</InscricaoMunicipal>
                     ...
                     <Tomador>
                        ...
                        <IdentificacaoTomador>
                           ...
                           <CpfCnpj>
                              ...
                              <Cpf>00868335000126</Cpf>

                           </CpfCnpj>

                            <InscricaoMunicipal>872960</InscricaoMunicipal>

                        </IdentificacaoTomador>

                        <RazaoSocial>TESTE TOMADOR</RazaoSocial>

                        <Endereco>

                           <Endereco>KM 646, Ã€ ESQUERDA SEGUE MAIS 800 METROS</Endereco>

                           <Numero>S/N</Numero>

                           <Complemento>ESTRADA MATA PRETA KM 33</Complemento>

                           <Bairro>ZONA RURAL</Bairro>

                           <CodigoMunicipio>5213806</CodigoMunicipio>
...
__Regra para o campo __[__<ConsultarNfseServicoPrestadoResposta>__](file:///C:/Users/u6038715/Desktop/MasterSaf%20DW/Backlog%20Novo%20e%20Evolução/MFS%20-%20Municipal/MFS_11924%20-%20IPATINGA_MG/xml_tomada.xml)__ __Tag relacionada à abertura da resposta do serviço com o texto fixo: __<ConsultarNfseFaixaResposta xmlns:ns2="http://www\.w3\.org/2000/09/xmldsig\#" xmlns="http://www\.abrasf\.org\.br/nfse\.xsd">__
...
__Para o município de José Bonifácio e Cubatão__
...
__\[ALTERAÇÃO MFS\-68956 \] Município de Cubatão__

Não apresentar este campo
...
__\[ALTERAÇÃO MFS\-68956 \]  Para o município de Cubatão, considerar a regra:__

Esse campo identifica à data de emissão do documento fiscal\. Preencher com a informação do campo __DATA\_EMISSAO __da tabela __DWT\_DOCTO\_FISCAL \(campo 11 da SAFX07\)__

Tem o formato __AAAA\-MM\-DD__ onde:
...
Formato: AAAA\-MM\-DD Exemplo: 2019\-08\-07
...
__\[ALTERAÇÃO MFS\-68956\]__ __Para o município de Cubatão__

- Nossa tabela permite gravar no tamanho de 3,4 \(3 inteiros/ 4 decimais\), então para atender a obrigação deverão ser desconsideradas as duas primeiras posições do número inteiro e as duas posições finais da parte de decimais para atender o tamanho exigido pela Prefeitura\. *Exemplo:* 123,4567, gravar 3\.45
...
Apresentar este campo, antes do campo Complemento da TAG </Complemento>\(regra indicada na RN38\)
...
__\[ALTERAÇÃO MFS\-68956\] Para o município de Cubatão__

__Regra para o campo <InfDeclaracaoPrestacaoServico> __ Tag relacionada à abertura da estrutura da declaração da prestação do serviço  com o texto fixo: __<InfDeclaracaoPrestacaoServico> __ TAG obrigatória\.
...
__ALTERAÇÃO MFS\-68956\]__ __Para o município de Cubatão__
...
__Regra para o campo  <CodigoPais> da TAG </CodigoPais>__

Identifica o Código do País \(BACEN\) do Prestador\. 

Preencher com o campo COD\_PAIS \+ DIG\_VERIFICADOR da tabela PAIS relacionado ao IDENT\_ESTADO do município informado no campo <CodigoMunicipio> \(RN76\)\.
...
__Regra para o campo </ ConsultarNfseFaixaResposta > __TAG relacionada ao encerramento da chamada dos serviço da resposta do serviço com o texto fixo:__ </ ConsultarNfseFaixaResposta > __TAG obrigatória\.
...
__Regra p/ inclusão do módulo no Manager – Cubatão:__

O módulo “Cubatão” deve ficar localizado no grupo “Municipal”\.

Descrição do módulo: “Consiste no envio e processamento da declaração mensal das notas fiscais de serviços eletrônica tomados do município de Cubatão”\.

__MFS\-68956__

__RN129__

__Regra p/ abertura do módulo no Manager – Cubatão:__

Caso esteja selecionado no Manager um estabelecimento que não pertença à UF “SP” e ao código de município do IBGE igual a “13504” \(Cubatão\), o sistema abre o módulo, porém exibe a seguinte mensagem de alerta:

“Este estabelecimento não pertence ao município de Cubatão, São Paulo\. Alguns dados não estarão disponíveis\. Deseja continuar?”
