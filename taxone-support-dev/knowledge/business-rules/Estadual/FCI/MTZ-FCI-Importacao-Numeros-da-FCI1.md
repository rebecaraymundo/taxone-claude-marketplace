# MTZ-FCI-Importacao-Numeros-da-FCI1

- **Fonte:** MTZ-FCI-Importacao-Numeros-da-FCI1.docx
...
__com os Números da FCI__

__Localização__: Menu Estadual, Módulo FCI à Obrigações à Importação dos Números da FCI
...
Nova regra apenas para o Tax One para incluir o prefixo “EPCARQ\_” na nomenclatura do arquivo para importação do FCI\.
...
__Período de referência da geração dos arquivos  à __Neste campo o usuário informará o mês e ano \(MMAAAA\) dos arquivos a serem processados\. 
...
__Selecione o diretório dos arquivos a serem processados __ à Este campo trabalha com janela de seleção que exibirá a árvore de diretórios, considerando os diretórios da máquina local, como também das unidades mapeadas __\(\*\)__\. O usuário irá selecionar o diretório dos arquivos a serem processados\.

__\(\*\) __Semelhante ao menu “Obrigações à Importação dos Arquivos da Sefaz\-AM” do módulo DIA\-AM\.

__Alteração da OS4417:   __\(criação do parâmetro “Nomenclatura a ser utilizada p/identificação dos arquivos”\)

__Nomenclatura a ser utilizada p/identificação dos arquivos __ à Este campo oferece duas opções para seleção do usuário:

\- Nomenclatura utilizada na geração dos arquivos

\- Nomenclatura utilizada no retorno dos arquivos pela Sefaz

__\[Alteração MFS1059921\] Apenas para o Tax One: __para ambas as opções faz\-se necessário que a nomenclatura do arquivo possua o prefixo “EPCARQ\_”\.
...
__Mês/Ano do retorno__ àEste campo é referente à opção “Nomenclatura utilizada no retorno dos arquivos pela Sefaz” do parâmetro descrito acima, e o usuário informará o mês/ano em que a Sefaz retornou os arquivos\. 
...
__Estabelecimentos__ àNeste campo é exibida a lista dos estabelecimentos da Empresa do login\. 
...
<Sim> à Apaga a mensagem e inicia o processamento

<Não> à Apaga a mensagem e aguarda decisão do usuário, que poderá alterar algum parâmetro e solicitar novamente a execução, ou sair da rotina\. 
...
__Opção 1 __= “Nomenclatura utilizada na geração dos arquivos”:       *\(opção original\)*
      ...
      “Obrigações à Geração do Meio Magnético”\), e o período informado no campo “Período de referência da 

      geração dos arquivos”\.

__\[Alteração MFS1059921\] Apenas para o Tax One: __faz\-se necessário que a nomenclatura do arquivo possua o prefixo “EPCARQ\_”\.

      Nomenclatura = EPCARQ\_ \+  Número do Processo \+ Código do Estab \+ “\_FCI\_” \+ MMAAAA \+ “\_” \+ Volume \+ “__\.__txt”
...
__\[Alteração MFS1059921\] Apenas para o Tax One: __faz\-se necessário que a nomenclatura do arquivo possua o prefixo “EPCARQ\_”\.
       ...
       Nomenclatura =  EPCARQ\_ \+ CNPJ \+ “\_” \+ AAAAMMDD \+ “\_” \+ HHMMSS
...
__Detalhes sobre a nomenclatura dos arquivos__:
     ...
     \- No caso da opção \(1\), os arquivos devem manter o nome original com o qual foram gerados, tendo o mês
       ...
       e ano = mês e ano do período de geração informado em tela, além do prefixo “EPCARQ\_”;
     ...
     \- No caso da opção \(2\), o mês e ano do nome do arquivo indica apenas a data em que a Sefaz fez o envio
       ...
       quando a Sefaz só retornar o arquivo em dia posterior ao mês e ano que consta no nome do arquivo, além do prefixo “EPCARQ\_”\.
