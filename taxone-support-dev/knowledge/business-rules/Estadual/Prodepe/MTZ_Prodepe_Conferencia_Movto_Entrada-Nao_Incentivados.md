# MTZ_Prodepe_Conferencia_Movto_Entrada-Nao_Incentivados

- **Fonte:** MTZ_Prodepe_Conferencia_Movto_Entrada-Nao_Incentivados.docx
...
__                                             Conferência dos Movimento de Entradas – Não Incentivados __

__Localização__: Menu Estadual, Módulo Prodepe, item Obrigações à Conferência Entradas / Entradas <a id="_Hlk87627679"></a>🡪 Movimento de Entrada 🡪 Não Incentivados 
...
Recuperação das notas fiscais para a conferência dos movimentos de Entradas \- Item Principal Entradas:
...
Importante à A regra acima que define qual o tipo de nota deve ser gerada no livro incentivado deve ser usada em todos os itens de relatório \(Principal, Resumo CFO, Resumo p/ Alíquota\.\.\.\)\.
...
- Classificação do Documento Fiscal igual a 1, 3 ou 4;
- Nota que não seja de Transferência \(IND\_TRANSF\_CRED = ’0’\)
- [Produto](file:///C:/Doc_andrea/Meus%20Documentos/Sprint_300/Sprint%20300/MFS83974/MTZ_Prodepe_Conferencia_Movto_Saida-Nao_Incentivados.docx#ProdutoouNCMsujeitosaICMSST) não parametrizado para Produto Incentivado  
