# MTZ-ICMS-GIA-ST_Geracao-Registros

- **Fonte:** MTZ-ICMS-GIA-ST_Geracao-Registros.docx
...
__Localização__: Menu Estadual, Módulo ICMS, item de menu Apuração 🡪 Guias de Recolhimento 🡪 Guia de Informação de Substituição Tributária 🡪 Geração
...
\+ __Valor Recolhimento da Apuração do P9 __quando__ __o código de obrigação for igual a “006\-ICMS resultante da alíquota adicional dos itens incluídos no FCP” \( __Origem: __Estadual >> ICMS >> Apuração >> Apuração ICMS >> Lançamentos Complementares >> Apuração do ICMS 🡪 Ajuste SINIEF – Opção da Aba \- Guia \)\.
...
Esse campo deverá ser preenchido com o somatório do ICMS ST das notas fiscais de Devolução \(Quando o campo NORM\_DEV da SAFX07 for igual a ‘2’\)\.
