# MTZ_Relatorios_Acessorios_Resumo_da_Apuracao_do_ICMS_por_IEU

- **Fonte:** MTZ_Relatorios_Acessorios_Resumo_da_Apuracao_do_ICMS_por_IEU.docx
...
Relatório Resumo da Apuração do ICMS por Insc\. Estadual Única

Resumo da Apuração do ICMS por Insc\. Estadual Única – Livro Modelo 165
...
Este documento tem como objetivo definir o funcionamento do Relatório Resumo da Apuração do ICMS por Insc\. Estadual Única\.
...
__Localização da tela:__ Estadual\\ ICMS\\ Relatórios\\ Acessórios\\ Resumo da Apuração do ICMS por Insc\. Estadual Única

__Título da tela: __Relatório Resumo da Apuração do ICMS por Insc\. Estadual Única
...
- Deverão ser listados somente os estabelecimentos centralizadores que foram configurados no módulo Controle de Obrigações Estaduais, em Obrigações >> Empresas/ Estabelecimentos c/ Insc\. Estadual Única;
...
- Se o usuário logou com um estabelecimento que não é centralizador, o mesmo não será apresentado obrigando\-o a parametrizar o estabelecimento vinculado à centralização;
- Caso o usuário tenha selecionado primeiramente uma UF, neste campo serão exibidos todos os estabelecimentos cadastrados com a unidade de federação selecionada\. Podendo emitir o resumo com todos os estabelecimentos com essa UF, até mesmo os centralizados;
...
Estadual >> Controle das Obrigações Estaduais >> Obrigações: Registro do Livro de modelo 165 no item de menu Obrigações Fiscais\.
