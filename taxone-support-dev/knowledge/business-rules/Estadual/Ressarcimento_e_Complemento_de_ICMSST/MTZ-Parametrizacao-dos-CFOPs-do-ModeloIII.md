# MTZ-Parametrizacao-dos-CFOPs-do-ModeloIII

- **Fonte:** MTZ-Parametrizacao-dos-CFOPs-do-ModeloIII.docx
...
__                                   Parametrização dos CFOP’s para o Modelo III__

__Localização:__ Menu Estadual, Módulo: Ressarcimento e Complemento de ICMS\-ST,  item Parâmetros 🡪 CAT 17/1999 e CAT 99/2005 🡪 CFOP/Natureza para o Modelo III 🡪 Por CFOP’s
...
O valor default a ser exibido na inclusão de novos CFOP’s é o seguinte:	
...
No caso do campo “Parâmetro” = “Saídas com Isenção ou Não Incidência” 
      ...
      Na inclusão de novos CFOP’s, o campo terá o default = “VC na coluna 15”, conforme a tabela acima, mas o usuário poderá alterá\-lo;

 No caso do campo “Parâmetro” = qualquer uma das demais opções \(exceto as duas citadas na condição anterior\):

      Na inclusão de novos CFOP’s, o campo mostrará sempre o conteúdo default do sistema, __conforme a tabela acima__, e o usuário __não__ poderá

      alterá\-lo, já que o campo ficará desabilitado nesses casos;
