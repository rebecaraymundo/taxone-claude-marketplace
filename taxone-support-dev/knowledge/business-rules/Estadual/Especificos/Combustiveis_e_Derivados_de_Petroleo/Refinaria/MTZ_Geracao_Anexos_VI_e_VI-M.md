...
[1\.	Introdução	1](#_Toc140516741)

[2\.	Parâmetros de Tela	1](#_Toc140516742)

[3\.	Regras de Negócio	1](#_Toc140516743)

[RN00 – Regra Geral	1](#_Toc140516744)

[RN01 \- Geração do Anexo VI\-M \- Quadro 1	1](#_Toc140516745)

[RN02 \- Geração do Anexo VI\-M \- Quadro 2	1](#_Toc140516746)

[RN03 \- Geração do Anexo VI\-M \- Quadro 3	1](#_Toc140516747)

[RN04 \- Geração do Anexo VI\-M \- Quadro 4	1](#_Toc140516748)

[RN05 \- Geração do Anexo VI\-M \- Quadro 5	1](#_Toc140516749)

[RN06 \- Geração do Anexo VI\-M \- Quadro 6	1](#_Toc140516750)

[RN07 \- Geração do Anexo VI\-M \- Quadro 7	1](#_Toc140516751)

[RN08 \- Geração do Anexo VI\-M \- Quadro 8	1](#_Toc140516752)

[RN09 \- Geração do Anexo VI\-M \- Quadro 9	1](#_Toc140516753)

[RN10 \- Geração do Anexo VI\-M \- Quadro 10	1](#_Toc140516754)

[RN11 \- Geração do Anexo VI\-M \- Quadro 11	1](#_Toc140516755)

[RN12 \- Geração do Anexo VI\-M \- Quadro 12	1](#_Toc140516756)

[RN13 \- Geração do Anexo VI\-M \- Quadro 13	1](#_Toc140516757)

[RN14 \- Geração do Anexo VI\-M \- Quadro 14	1](#_Toc140516758)

[RN15 \- Geração do Anexo VI\-M \- Quadro 15	1](#_Toc140516759)

# <a id="_Toc140516741"></a>Introdução 

O Anexo VI\-M vem para substituir o Anexo VI para os combustíveis no regime de tributação monofásica do ICMS\. Segundo a legislação que regulamenta o regime monofásico sobre combustíveis, o Diesel, Biodiesel e GLP/GLGN entram para o monofásico em Maio/2023, portando, a partir desse mês devem ser apresentados no Anexo VI\-M e não mais no Anexo VI\. A Gasolina e EAC aderem ao monofásico do ICMS a partir de Junho/2023\. Uma vez que o combustível é apresentado no Anexo VI\-M ele deixa de compor o Anexo VI\.
...
O arquivo txt contém os seguintes anexos: III, III\-M, V, V\-M, V\-M\-AJ, XI\-A, XI\-M\. Um arquivo pode conter todos esses anexos, que devem ser lidos e as informações direcionada para o Anexo VI ou VI\-M\.

Os anexos III, V e XI\-A são utilizados para a geração do Anexo VI\. E os III\-M, V\-M, V\-M\-AJ e XI\-M para a geração do VI\-M\.
...
Relação dos quadros do Anexo VI\-M com os lidos do arquivo txt \(anexos III\-M, V\-M, V\-M\-AJ ou XI\-M\)
...
# <a id="_Toc140516742"></a>Parâmetros de Tela
...
# <a id="_Toc140516743"></a>Regras de Negócio

## <a id="_Toc140516744"></a>RN00 – Regra Geral
...
## <a id="_Toc140516745"></a>RN01 \- Geração do Anexo VI\-M \- Quadro 1
...
Gravar os campos do Quadro 1 conforme regras abaixo\. O registro gerado está disponível para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadros 1 e 2\.
...
SUB\-TOTAL \(1\.1\.1 \+ 1\.1\.2\.1 \+ 1\.1\.2\.2 \+ 1\.1\.3 \+ 1\.1\.4 \+ 1\.1\.5 \+ 1\.1\.6\)

vlr\_icms\_st\_117

Somatório dos campos Vlr 1\.1\.1, Vlr 1\.1\.2, Vlr 1\.1\.3, Vlr 1\.1\.4, Vlr 1\.1\.5 e Vlr 1\.1\.6\.
...
__SUB\-TOTAL DAS DEDUÇÕES \(1\.2\.1 \+ 1\.2\.2 \+ 1\.2\.3 \+ 1\.2\.4 \+ 1\.2\.5 \+ 1\.2\.6 \+ 1\.2\.7\)__

vlr\_icms\_st\_128

Somatório dos campos Vlr 1\.2\.1, Vlr 1\.2\.2, Vlr 1\.2\.3, Vlr 1\.2\.4, Vlr 1\.2\.5, Vlr 1\.2\.6 e Vlr 1\.2\.7\.
...
## <a id="_Toc140516746"></a>RN02 \- Geração do Anexo VI\-M \- Quadro 2
...
Gravar os campos do Quadro 2 conforme regras abaixo\. O registro gerado está disponível para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadros 1 e 2\.
...
## <a id="_Toc140516747"></a>RN03 \- Geração do Anexo VI\-M \- Quadro 3
...
\- O Grupo de Combustível parametrizado para o produto, deve estar com o flag Anexo VI\-M selecionado, no menu Parâmetros à Grupos de Combustíveis e Derivados\.
...
Gravar os campos do Quadro 3 conforme regras abaixo\. O registro gerado está disponível para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadro 3\.
...
## <a id="_Toc140516748"></a>RN04 \- Geração do Anexo VI\-M \- Quadro 4
...
Os registros gerados estão disponíveis para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadros 4 a 15\.
...
UF recuperada do registro A3MHD – campo UFDESTPR posição ini\-fim 19\-20
...
Pessoa Fis/Jur emitente recuperada do registro A3MHD – campo CNPJ posição ini\-fim 26\-39

UF do Quadro

ident\_estado\_quad    

UF emitente recuperada do registro A3MHD – campo UF posição ini\-fim 252\-253
...
UF recuperada do registro A11MHD – campo 7\-UFORIGEM posição ini\-fim 22\-23  
...
Pessoa Fis/Jur emitente recuperada do registro A11MHD – campo CNPJ posição ini\-fim 27\-40

UF do Quadro

ident\_estado\_quad    

UF emitente recuperada do registro A11MHD – campo UF posição ini\-fim 253\-254
...
UF recuperada do registro A11MHD – campo 5\- UFDESTPR posição ini\-fim 20\-21  
...
## <a id="_Toc140516749"></a>RN05 \- Geração do Anexo VI\-M \- Quadro 5
...
## <a id="_Toc140516750"></a>RN06 \- Geração do Anexo VI\-M \- Quadro 6

__Quadro 6\.1 \- REPASSE DE ICMS SOBRE BIOCOMBUSTÍVEIS DECORRENTE DE AJUSTES DE REPARTIÇÃO DE RECEITA__

Quadro gerado a partir da leitura dos Anexos V\-M e V\-M\-AJ, contido no arquivo txt informado na geração\. 

Anexo V\-M\-AJ \- quadro A5MAQ1 \- valor __VLRQ3__\.

Anexo V\-M \- quadro A5MQ4 \- valores __VLRQ42  e VLRQ43__\.

Para cada registro lido dos quadros A5MAQ1 com valor __VLRQ3__,  A5MQ4 com valor VLRQ42  e A5MQ4 com valor VLRQ43 será gravado um registro no quadro 6\.1 e outro no quadro 9\.1\.
...
UF recuperada do registro A5MAHD – campo 5\- UFDESTPR posição ini\-fim 20\-21
...
Pessoa Fis/Jur emitente recuperada do registro A5MAHD – campo CNPJ posição ini\-fim 30\-43

UF do Quadro

ident\_estado\_quad    

UF recuperada do registro A5MAHD – campo 7\-UFORIGEM posição ini\-fim 22\-23  
...
## <a id="_Toc140516751"></a>RN07 \- Geração do Anexo VI\-M \- Quadro 7
...
## <a id="_Toc140516752"></a>RN08 \- Geração do Anexo VI\-M \- Quadro 8
...
## <a id="_Toc140516753"></a>RN09 \- Geração do Anexo VI\-M \- Quadro 9
...
## <a id="_Toc140516754"></a>RN10 \- Geração do Anexo VI\-M \- Quadro 10
...
Gravar os campos do Quadro 10 conforme regras abaixo\. O registro gerado está disponível para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadros 4 a 15\.
...
## <a id="_Toc140516755"></a>RN11 \- Geração do Anexo VI\-M \- Quadro 11
...
O registro gerado está disponível para manutenção no item de Menu Movimento de Refinaria à Manutenção Anexo VI\-M à Quadros 4 a 15\.
...
## <a id="_Toc140516756"></a>RN12 \- Geração do Anexo VI\-M \- Quadro 12
...
## <a id="_Toc140516757"></a>RN13 \- Geração do Anexo VI\-M \- Quadro 13
...
## <a id="_Toc140516758"></a>RN14 \- Geração do Anexo VI\-M \- Quadro 14

Esse quadro não é gerado\.

## <a id="_Toc140516759"></a>RN15 \- Geração do Anexo VI\-M \- Quadro 15
