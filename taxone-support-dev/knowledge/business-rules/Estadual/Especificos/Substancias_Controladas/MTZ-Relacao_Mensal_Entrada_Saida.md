# MTZ-Relacao_Mensal_Entrada_Saida

- **Fonte:** MTZ-Relacao_Mensal_Entrada_Saida.docx
- **Modificado:** 2020-03-11
- **Tamanho:** 34 KB

---

# Atendimento – Polícia Federal – Relação Mensal de Entradas/Saídas por Classificação de Produto
...
__Regra para tela Relação Mensal de Entradas/Saídas por Classificação de Produto__

Ao clicar no menu Atendimento > Polícia Federal > Relação Mensal de Entradas/Saídas por Classificação de Produto, o sistema deve exibir a tela de seleção conforme abaixo, com o seguinte campo, além dos campos já existentes: 
