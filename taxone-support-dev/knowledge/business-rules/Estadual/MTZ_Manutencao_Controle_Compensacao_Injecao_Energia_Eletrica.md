...
Manutenção do Controle de Compensação de Injeção de Energia Elétrica
...
Vlr. Tarifa Energia Compensada (VLR_TARIFA_COMP)
Obrigatoriedade: Campo opcional.
Tipo: Numérico (5 inteiros e 6 decimais).

Qtde Energia Compensada (kWh) (QTD_ENERGIA_COMP)
Obrigatoriedade: Campo opcional.
...
| --- | --- | --- |
| MFS981989 | Liliane Assaf | Criação da tela de manutenção |
|  |  |  |
|  |  |  |
