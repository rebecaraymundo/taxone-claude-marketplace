...
Inclusão das informações referentes à Comercialização Internacional
...
__\[MFS630251\] __Habilitação da opção__ __Comercialização Internacional
...
Data Restrição Embarque 

__\[MFS630251\] __Inclusão das informações de Comercialização Internacional

Campo “Data Restrição Embarque ” \(DAT\_EMBARQUE\) do Movimento do Produto \(SAFX70\)

Data Conhec\. Embarque 

__\[MFS630251\] __Inclusão das informações de Comercialização Internacional

Campo “Data Conhecimento Embarque” \(DAT\_CONHEC\_EMB\) do Movimento do Produto \(SAFX70\)

Número do Registro de Exportação/Importação

__\[MFS630251\] __Inclusão das informações de Comercialização Internacional

Campo “Número do Registro de Exportação/Importação” \(NUM\_REG\_EXP\_IMP\) do Movimento do Produto \(SAFX70\)

CPF / CNPJ Entrega

__\[MFS630251\] __Inclusão das informações de Comercialização Internacional

Esta coluna é preenchida com o CNPJ ou CPF do cadastro da Pessoa Fis/Jur da Entrega do Movimento do Produto \(SAFX70\), da seguinte forma:
...
\(campo CPF\_CGC\_ENTREGA da view SC\_PRE\_V\) 

CPF / CNPJ Adquirente

__\[MFS630251\] __Inclusão das informações de Comercialização Internacional

Esta coluna é preenchida com o CNPJ ou CPF do cadastro da Pessoa Fis/Jur Adquirente do Movimento do Produto \(SAFX70\), da seguinte forma:
...
\(campo CPF\_CGC\_ADQ da view SC\_PRE\_V\) 
