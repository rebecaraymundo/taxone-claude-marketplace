# ECD_Livros_SPED_Matriz_V5

> Fonte: ECD_Livros_SPED_Matriz_V5.doc
...
Porém, quando da geração do SPED Contábil o NIRE deve ser levado para o registro I030 no campo 07 sem dos separadores, uma vez que o campo é do tipo “number”.		2328-V	Colocar mensagem no relacionamento entre as contas no De/Para	Colocação de uma mensagem que informe ao usuário a associação de uma Conta Empresa a mais de uma Conta Referencial.		2328-R4	Melhoria na tela de seleão do signatário	Alteração na tela de seleção do signatário nos dados inciais do SPED Contábil.		OS2328-R3	Relatório valorado do B.P e da DRE 	Será criado um relatório que irá apresentar a estrutura de códigos de aglutinação criada para o Balanço Patrimonial e para a Demonstração de Resultado. Além da estrutura o relatório irá demonstrar os valores referentes a cada um dos códigos de aglutinação, de acordo com a parametrização de aglutinação feita nesse mesmo módulo.		2328-N2	Geração registro J005	Alteração na forma de geração da data inicial e final do registro J005		OS2848	Parametrização do Número de Ordem
	Disponibilizar para o usuário uma parametrização prévia do número de ordem a ser utilizado nos arquivos da ECD de cada período, assim, o usuário poderá informar antecipadamente o número de ordem para todos os arquivos da ECD que serão gerados no ano calendário.		CH77588	Alteração na regra de geração do registro J100 e J150	Alteração na forma de geração dos registro J100 e J150
		CH62988-A	Incluir a coluna ‘Num CRC’ na seleção do responsável legal.	Deve ser adicionada a coluna ‘Num CRC’ na janela de seleção do responsável legal existente nos dados iniciais da ECD.		OS3042	Parâmetro Controle da Obrigação	Alteração do processo de exclusão do Histórico dos Livros Gerados.		OS2328-N1	Não gerar centro de custo sem movimento	Alterar geração dos registros I051, I052 e I100, para não gerar registros cujo centro de custo estejam sem movimento.		CH109729	Não gerar registro 0150 duplicado quando selecionada geração Centralizada.	Não apenas um registro 0150 quando há Cadastros de Pessoas Físicas/Jurídicas com o mesmo código para mais de um Grupo de Estabelecimento quando a geração é efetuada de maneira centralizada.		CH13882_2012	ECD – Escrituração Contábil Digital – Gerar campo DT_INI do registro I150 a partir da Data de Início da Atividade	O objetivo desse Documento de Requisito é permitir que o campo “Data Inicial” do registro “I150” do módulo ECD – Escrituração Contábil Digital seja gerada com a data inicial condizente com a Data Inicial do arquivo gerado no registro “0000”.		CH14409_2012	Geração do 04 - NAT_LIVR do Registro I030 para Livros Auxiliares do Tipo A e Z	O objetivo deste requisito é definir a regra para geração do campo 04 - NAT_LIVR do Registro I030 quando a geração do arquivo da ECD for referente a um livro do Tipo A – Livro Diário Auxiliar e Tipo Z – Razão Auxiliar.		CH15368_2012	Livro Auxiliar	Considerar as contas parametrizadas na tela ‘Livros Auxiliares ao Diário’, localizada no módulo SPED / ECD – Escrituração Contábil Digital , menu: Parâmetros.
		OS3676	ECD – Escrituração Contábil Digital – Demonstração de Resultados  com Periodicidade Trimestral	Os registros J005, J100, J150 e J800 devem ter a quebra por trimestre, se a demonstração de resultados for trimestral.		CH24421_2012	Geração do registro I150, nos casos de situação especial.	Alterar forma de geração do registro I150 para gerar corretamente os arquivos nas situações especiais (cisão, fusão, incorporação).		
CH14409_2012	Geração dos registros I012, I030 e J900.	Alterar a geração do campo NAT_LIVR dos registros I012, I030 e J900 para os livros A- Diário Auxiliar, B- Livros e Balancetes Diários e Balanças, G-Diário Geral, R-Diário Geral com Escrituração Resumida e Z-Razão Auxiliar.		CH28131_2012	Geração dos registros I012, I030 e J900	Alterar a geração do campo NAT_LIVR dos registros I012, I030 e J900 para os livros A- Diário Auxiliar, B- Livros e Balancetes Diários e Balanças, G-Diário Geral, R-Diário Geral com Escrituração Resumida e Z-Razão Auxiliar.		OS4123	Geração do Registro I020 com impactos nos registros I050, I200 e I250	Definição das regras de geração do registro I020 e atualização da geração dos registros I050, I200 e I250 que são impactados pelo I020.		CH10431/2014	Geração do Registro J100	Definição da regra de geração do registro J100.		CH12515_2104	Geração do Registro J800	Tratamento para periodicidade Anual do Registro J800.		CH18978_2014	Geração do Registro I051	Tratamento para periodicidade das contas referenciais a partir da TFIX64.		CH11806_2014	Geração por parâmetro “Somente contas + centro de custo movimentados no período da geração”	Alteração do tratamento do parâmetro “Somente contas + centro de custo movimentados no período da geração” para permitir que considere as contas que tenham movimentação no período mesmo sem vinculação do CC mais contas vinculadas ao CC (regra já atendida atualmente).		OS4745	Atualização da importação da SAFX2101	Atualização das opções válidas de Código da Entidade Responsável na importação da SAFX2101 (RN192).		CH7858/2015	Atualização da importação da SAFX2101	Ajuste da regra de importação/manutenção da SAFX2101 para permitir a inserção de dados de uma mesma conta para entidades distintas (RN191).		CH946/2015	Atualização da regra do Parâmetro “Gerar Plano de Contas”.	Alteração de regra para que o registro I015 passe a respeitar o parâmetro "Gerar Plano de Contas" de Dados Iniciais (RN232).		OS4791	Atualização da regra do campo 11 - IND_SIT_ESP do registro 0000.	Definição da regra para geração da situação especial de transferência de sede.		CH12235_2015	Geração do Registro I052	Este documento tem como objetivo incluir tratamento para contas da empresa que estão inativas na SAFX2002 e estão associadas a um código de aglutinação causando duplicidade de registro.		MFS-4039	Regra de Geração do I350	Detalhar as regras de Geração do Registro I350.		MFS-4831	Regra de Geração do Registro J005	Ajuste na regra de geração do Registro J005		CH29645_2015	Atualização da regra do Parâmetro “Gerar Plano de Contas – Completo”.	Alteração de regra para validação do grupo do plano de contas para geração completa (RN232).		MFS-4746	Atualização da regra de Geração do Registro I015	Atualização da regra de Geração do Registro I015 para que considere também as informações da SAFX179.		MFS-4847	Atualização da regra de Geração do J005	Atualização da regra de geração do registro J005 para prever o cenário de geração de um arquivo quebrado em período diferente de mensal.		CH17758_2016	Atualização da regra do Parâmetro “Gerar Plano de Contas – Completo” e “Somente contas + centro de custo movimentados no período da geração”	Alteração de regra para validação do centro de custo de uma conta da empresa referenciada no plano de contas referencial (RN232).		CH25719_2016	Ajuste na regra de parametrização do Controle da Obrigação	Alteração de regra para habilitar a aba Livro Auxiliares ao Diário também para o Livro Principal “G – Livro Diário”. (RN34)		MFS27094	Atualização da regra de Geração do Registro I051	Atualização da regra de Geração do Registro I051 para contemplar as novas opções do campo “Gerar Plano de Contas”		MFS-41465	Atualização do Campo 11 – IND_SIT_ESP do registro 0000	Alteração da Regra para não gerar o Campo 11 – IND_SIT_ESP (registro 0000), após uma data de situação especial (RN287)		MFS-69118	Tratamento da regra do Parâmetro “Gerar Plano de Contas – Completo”.	Tratamento de regra para considerar na geração o Registro I052, para geração Completa (RN232).		MFS-76551	Tratamento da regra do Parâmetro “Gerar Plano de Contas – Completo”.	Tratamento de regra para considerar na geração o Registro I053, para geração Completa (RN232).		MFS-46921	Livro Auxiliar – Perfil R	Alteração nas RN80, RN81, RN82, RN83 e RN147		MFS-83291	Alteração na regra de Geração do Registro I051		
...
“Tipo I012 – Registro não será gerado. Favor informar o Número de ordem da geração. (Livro Auxiliar) de escrituração. Localização: SPED --> ECD Escrituração Contábil Digital --> Parâmetros --> Controle da Obrigação na opção [Livros Auxiliares]”

[ALTERADA – MFS46921] A regra acima também é válida para o livro perfil “B”.
	OS2328IB
MFS46921		RN81	Se durante a geração do livro perfil “R” o sistema verificar que o campo 3 (NAT_LIVR) do registro I012 não estiver preenchido, o mesmo deverá apresentar no Log a seguinte mensagem:
...
[ALTERADA – MFS46921] A regra acima também é válida para o livro perfil “B”.
	OS2328IB
MFS46921		RN81	Se durante a geração do livro perfil “R” o sistema verificar que o campo 4 (TIPO) do registro I012 não estiver preenchido, o mesmo deverá apresentar no Log a seguinte mensagem:
...
[ALTERADA – MFS46921] A regra acima também é válida para o livro perfil “B”.
	OS2328IB
MFS46921		RN83	Se durante a geração do livro perfil “R” o sistema verificar que o campo 2 (COD_CTA_RES) do registro I015 não estiver preenchido, o mesmo deverá apresentar no Log a seguinte mensagem:
...
[ALTERADA – MFS46921] A regra acima também é válida para o livro perfil “B”.
	...
	OS2328IB MFS46921		RN84	[ALTERADA – OS2848] Se durante a geração do livro perfil “A” o sistema verificar que o campo 2 (NUM_ORD) do registro I012 não estiver preenchido, o mesmo deverá apresentar no Log a seguinte mensagem:
...
Os registros que na coluna “Z” estiverem com indicador “O” deverão estar marcados e desabilitados para alteração, os que estiverem com “F” deverão estar habilitados para o usuário marcar ou não esta opção e os que estiverem com “N” não deverão aparecer nessa apresentação. 	OS2328-L		RN146	Na tela de geração do arquivo magnético será habilitado o campo “Livro Auxiliar” para que o usuário selecione qual  auxiliar o mesmo deseja gerar o livro tipo “Z”, assim como funciona hoje para o livro “A”.	OS2328-L		RN147	[ALTERAÇÃO MFS-46921] Os registros 0150, 0180, I012, I015,I075, I150, I155, já são tratados no mastersaf para livros como “G” “B” e “R” estes deverão ser replicados para quando da geração do Livro Tipo “Z – Razão Auxiliar”  os registros já citados sejam gerados também. Lembrando que a base para valores do livro “Z” é a X101 e X102.	OS2328-L
MFS-46921		RN148	Os Registros I500 e I510 já são gerados atualmente, porém como houve alteração na tela que essas informações são buscadas, esses registros terão de ser verificados conforme segue as demais regras:	OS2328-L		RN149	Registro I500
...
É permitido apenas importar contas contábeis analíticas.
	...
	OS2328-U		RN191	Caso o usuário importe a mesma conta contábil (Safx2002) de uma mesma empresa para contas referenciais de diferentes entidades, o sistema deverá permitir impedir essa importação/manutenç.
...
O sistema deverá permitir este cenário. Isso não era válido anteriormente na ECD porque utilizava-se do conceito de entidade, porém, é válido agora por se tratar no conceito de classificação da empresa (lucro real, presumido, etc) e pelo fato de serem utilizadas entidades distintas para a ECD e FCONT.

Esta regra deve ser removida tanto da tela tela quanto importação
...
Plano de contas informado para mais de uma entidade.
	OS2328-U
CH7858/2015		RN192	Caso durante a importação o usuário conter registros de entidades que sejam diferentes da informado na janela de dados iniciais, o sistema não deverá permitir a gravação desse registro.

Se
SEPED_DADOS_INI.COD_ENTIDADE_RESP <> SAFX2101.COD_ENTIDADE_RESP
Então
Bloquear a importação do arquivo.

Códigos de Entidade válidas:
...
Mensagem no Log
Quando a Versão for 1.00 e o Código de Entidade for diferente de 00, 10 e 20, retorna a mensagem: “Código da Entidade diferente da informada no Manual Layout. Campo deve conter: 00 - SUSEP, 10 – SRF ou 20 – COSIF”

Quando a Versão for 3.00 e o Código de Entidade for diferente de 00, 10, 20, 1, 2, 3, 4, 5, 6, 7, 8 e 9, retorna a mensagem: “Código da Entidade deve ser: 00, 10, 20, 1, 2, 3, 4, 5, 6, 7, 8 ou 9”

Modulo SPED Contábil no menu Parâmetros >> Dados Iniciais
	OS2328-U
OS4745		RN193	Durante a importação, o sistema deverá verificar se o centro aparece para a mesma conta referencial  duas vezes, caso sim o sistema irá impedir a importação dos dois registros.
...
Geração do livro “R” (Registro I012 campo 03) – Quando o campo 02 do registro I010 for igual a “R” ou “B" (somente se existirem livros auxiliares), preencher com os dados dos livros auxiliares (“A” ou “Z”) conforme parâmetro do campo Descritivo do Livro para o SPED. Esta informação está disponível na tela “Livros Auxiliares ao Diário” (Módulo ECD >> Parâmetros >> Livros Auxiliares ao Diário).
	CH64346
CH28131_2012		RN225	
Geração do livro “A” (Registro I012 campo 03) – Quando o campo 02 do registro I010 for igual a “A” ou “Z”, preencher com os dados do livro com escrituração resumida (“R”) coluna TERMO_ABERTURA da tabela SPED_TERMOS_LIVRO.

[Alterada CH28131_2012]
Geração do livro “A” (Registro I012 campo 03) – Quando o campo 02 do registro I010 for igual a “A” ou “Z”, preencher com os dados dos com escrituração resumida (“R”) ou balancetes diários e balanços(“B”)  coluna TERMO_ABERTURA da tabela SPED_TERMOS_LIVRO.
	CH64346
CH28131_2012		RN226	Parametrização dos Códigos de Aglutinação do Balanço e da DRE – Em ‘Manutenção > Códigos de Aglutinação’, na aba Balanço Patrimonial, ao selecionar a opção ‘Selecionar Contas da Empresa para Apuração, deve ser possível pesquisar as contas da empresa cuja natureza (campo IND_NATUREZA) seja: 1 - Ativo, 2 - Passivo, 5 - Mutações Ativas, 6 - Mutações Passivas, 7 - Patrimônio Líquido ou 9 – Outros
...
[ALTERADA – CH29645_2015]
Ainda nessa opção de geração “Completo”, devem ser consideradas apenas as contas do Grupo vigente no período de geração ao qual o estabelecimento centralizador e seus centralizados estão associados. Observando que, podemos ter uma mudança de grupo no meio de um período de geração, então neste caso, devemos considerar mais de um grupo na geração. 
Exemplo:
Grupo 001 – Validade 01/01/2013
Grupo 002 – Validade 01/01/2014
Grupo 003 – Validade 01/06/2015
Geração do arquivo da ECD: 01/01/2015 até 31/12/2015
Neste caso, são vigentes os grupos “002” e “003” e as informações destes grupos que devem ser consideradas na geração do arquivo.
[ALTERADA – MFS-69118]
Ainda nessa opção de geração ‘Gerar Plano de Contas: Completo’ também deve ser considerado na geração o registro I052 que estiverem relacionadas ao Plano de Contas referente à empresa e estabelecimento que foi selecionado na tela de geração do arquivo.

[ALTERADA – MFS-76551]
Ainda nessa opção de geração ‘Gerar Plano de Contas: Completo’ também deve ser considerado na geração o registro I053 que estiverem relacionadas ao Plano de Contas referente à empresa e estabelecimento que foi selecionado na tela de geração do arquivo.


[ALTERADA – CH17758_2016]
Precisa ser considerada nessa opção de geração a validação do centro de custo quando não estiver parametrizada no plano de contas referencial, ou seja, eu tenho uma conta da empresa cadastrada vinculada ao um centro de custo que não foi parametrizado no plano de contas referencial. Caso não localizar a parametrização do centro de custo, emitir a mensagem de log: “Tipo I051 - Conta Empresa sem relacionamento de centro de custo no Plano de Contas Referencial (Cadastro de Plano de Contas Referencial x Plano de Contas da Empresa). Conta Empresa = <<código conta>> - Centro de Custo <<código cc>>”.

Quando nos dados iniciais estiver parametrizado ‘Gerar Plano de Contas: Somente Contas Movimentadas no período da geração’, o sistema deve continuar utilizando a regra atual de geração do registro I050 e deverá gerar o registro I051 para as contas que foram geradas no I050 se houver parametrização para aquela conta na empresa e estabelecimento selecionado no momento da geração.

[ALTERADA OS2328-N1/ CH11806_2014]
Quando nos dados iniciais estiver parametrizado ‘Somente contas + centro de custo movimentados no período da geração’: utilizar as mesmas regras da opção acima (a regra acima pega somente as contas movimentadas, independente de Centro de Custo) e aplicar também quando houver centro de custos movimentados, ou seja, gerar as Contas Movimentadas + Contas Movimentadas vinculadas em pelo menos um Centro de Custo no período da geração, mas não gravar os registros I051, I052 e I100 quando não houver movimento para o centro de custo.
Veja exemplo:
Conta sem vinculação de Centro de Custo
- Se a conta não for associada a um CC, mas tiver movimento, gerar I051, I052 e I100, caso contrário não gerar.
E
Conta com vinculação de Centro de Custo
- Se houver para uma mesma conta, dois ou mais centro de custos associados, um com movimento e os demais não, a conta deverá ser gravada, pois um dos centro de custo tem movimento, gerar I051, I052 e I100.
- Se houver para uma mesma conta, dois ou mais centro de custos associados, ambos sem movimento, não gravar centro de custo no I051, I052 e I100.
- Se houver para uma mesma conta, dois ou mais centro de custos associados, ambos com movimento, o centro de custo será gravado normalmente uma vez no I051, I052 e I100.
Atenção: Para a geração dos registros de saldos e lançamentos, prevalece a mesma regra, ou seja, só gravar se houver movimento por conta ou centro de custo.
...
- Precisa ser considerada nessa opção de geração a validação do centro de custo quando não estiver parametrizada no plano de contas referencial, ou seja, eu tenho uma conta da empresa cadastrada vinculada ao um centro de custo que não foi parametrizado no plano de contas referencial. Caso não localizar a parametrização do centro de custo, permitir que o registro I051 seja gerado, e gravar a mensagem de log: 

“Tipo I051 - Conta Empresa sem relacionamento de centro de custo no Plano de Contas Referencial (Cadastro de Plano de Contas Referencial x Plano de Contas da Empresa), caso a informação do Centro de Custo interferir na identificação do código do plano de consta referencial, esse campo deverá ser preenchido. Conta Empresa = <<código conta>> - Centro de Custo <<código cc>>


[ALTERADA – MFS27094]
Quando nos dados iniciais estiver parametrizado ‘Gerar Plano de Contas: Somente contas movimentadas no ano da geração (até a data da geração)’, o sistema deve continuar utilizando a regra atual de geração do registro I050 e deverá gerar o registro I051 para as contas que foram geradas no I050 se houver parametrização para aquela conta na empresa e estabelecimento selecionado no momento da geração.  Recuperar as contas que foram movimentadas no ano da geração até a data final da geração.

[ALTERADA – MFS27094]
Quando nos dados iniciais estiver parametrizado ‘Somente contas + centro de custo movimentados no ano da geração (até a data da geração)’: utilizar as mesmas regras da opção acima (a regra acima pega somente as contas movimentadas, independente de Centro de Custo) e aplicar também quando houver centro de custos movimentados, ou seja, gerar as Contas Movimentadas + Contas Movimentadas vinculadas em pelo menos um Centro de Custo no período da geração, mas não gravar os registros I051, I052 e I100 quando não houver movimento para o centro de custo.

[ALTERADA – CH946_2015]
Extender a funcionalidade da parametrização de “Gerar Plano de Contas” da tela de Dados Iniciais (Módulo ECD / Menu Parâmetros) para a geração do Registro I015, considerando:

Se o parâmetro “Gerar Plano de Contas” estiver parametrizado com a opção “Completo”, na geração do registro I015 serão geradas todas as contas parametrizadas na tela “Livros Auxiliares ao Diário” (Módulo ECD / Menu Parâmetros) para o livro auxiliar indicado na geração ou livro resumido ao qual o livro auxiliar parametrizado tenha sido associado*.

Se o parâmetro “Gerar Plano de Contas” estiver parametrizado com a opção “Somente Contas Movimentadas no Período de Geração” OU “Somente Contas + Centro de Custo Movimentadas no Período de Geração”, na geração do registro I015 serão geradas as contas parametrizadas na tela “Livros Auxiliares ao Diário” (Módulo ECD / Menu Parâmetros) para o livro auxiliar indicado na geração ou livro resumido ao qual o livro auxiliar parametrizado tenha sido associado* e que tenham movimentação no período (saldos ou lançamentos), tendo como critério para identificação de movimentação as tabelas SAFX01, SAFX02, SAFX80, SAFX101,ou SAFX102 ou SAFX179.

* O Livro Resumido é o resumo de um ou mais Livros Auxiliares. Nele são demonstradas as contas contábeis associadas aos livros auxiliares que a empresa gera e é possível relacionar 1 ou N livros auxiliares a 1 resumido através da tela de Controle da Obrigação (Módulo ECD / Menu Parâmetros). No Livro Resumido demonstramos as contas contábeis associadas aos auxiliares e na geração deste livro a regra do parâmetro “Gerar Plano de Contas” também deve ser respeitada, conforme descrito acima.

Esta alteração do CH946/2015 apenas extende a funcionalidade do parâmetro “Gerar Plano de Contas” para o registro I015. A geração dos registros I050, I051, I052 e I100 não devem ser afetadas.
	CH63450 / OS2328-N1/
CH11806/2014/
CH946/2015/
CH29645/2015
...
MFS27094
MFS-69118
MFS-76551		RN233	[ALTERADA – CH18978_2014]
O Relacionamento do Plano de contas do referencial x Plano de contas empresa não deverá levar em conta a data de validade constante na TFIX64 (não leva em consideração para carregar as contas, pois a conta nunca é duplicada e sim substituída pelas entidades).
Atualmente o mastersaf importa a TFIX 64 com sucesso com novas contas adicionadas, porém quando o usuário utiliza essas novas contas para parametrização a gravação das mesmas não é feita, por que o sistema leva em conta a data de validade da conta da empresa com a data de validade da conta do referencial na TFIX 64 e isso não pode ocorrer, pois essas datas de validades da TFIX são apenas informativas, para as empresas (isso ocorre somente quando a data da conta da empresa está fora da validade da conta referencial).

Atenção: 
Na geração do Registro I051 a data inicial e final da TFIX64 deverá ser considerada para casos em que a conta referencial é substituída por outra conta de acordo com cada entidade;
Considerar contas referenciais que estejam com data inicial e data final igual a nulo.	OS2328Z
CH18978_2014		RN234	[ALTERADA – CH18978_2014]
A geração do arquivo magnético deverá ocorrer com sucesso, gerando os registros I051 corretamente considerando o De/Para com as novas contas.
1ª Verificação: Em casos de contas referenciais em que na TFIX64 não recebem data inicial e nem a data de validade final, nesse caso na geração do Registro I051:
Quando os campos DAT_VALIDADE_INI e DAT_VALIDADE_FIM da tabela SPED_CONTAS_REF não estiverem preenchidos considerar a conta referencial em qualquer período de geração do arquivo magnético.
Quando o campo DAT_VALIDADE_INI não estiver preenchido e o campo DAT_VALIDADE_FIM da tabela SPED_CONTAS_REF estiver preenchido e for maior que a data início de geração do arquivo magnético considerar a conta referencial.

Tratamento para não ocorrer advertência no PVA para contas referenciais que foram substituídas:
2ª Verificação: Em casos de contas referenciais substituídas a TFIX64 recebe data de validade final, nesse caso na geração do Registro I051:
Quando o campo DAT_VALIDADE_FIM da tabela SPED_CONTAS_REF não estiver preenchida considerar a conta referencial em qualquer período de geração, mas que esteja dentro da data de validade campo DAT_VALIDADE_INI da tabela SPED_CONTAS_REF de acordo com a parametrização do DExPARA.
Quando o campo DAT_VALIDADE_FIM da tabela SPED_CONTAS_REF estiver preenchida e for menor que a data de geração do arquivo magnético, desconsiderar a conta referencial de acordo com a parametrização do DExPARA.
Quando o campo DAT_VALIDADE_FIM da tabela SPED_CONTAS_REF estiver preenchida deverá ser considerada a conta referencial quando a mesma tiver os campos DAT_VALIDADE_INI e DAT_VALIDADE_FIM dentro do período de geração do arquivo magnético de acordo com a parametrização do DExPARA.

Observação: Na tabela disponibilizada pela RFB as datas de encerramento estão dentro do período das contas que foram substituídas, por exemplo, conta 2.01.01.05.00 foi encerrada em 01/01/2011, mas a conta que a substitui, por exemplo, conta 2.01.01.05.01 recebeu sua data inicial 01/01/2010, pois na época estenderam o prazo das contas encerradas para que os contribuintes conseguissem enviar o arquivo magnético, porém não mudaram a regra de validação do PVA e por isso estamos fazendo esse tratamento para que não ocorra advertência de que a conta informada está fora do período, esse tratamento só será 100% para casos ocorridos em 2011, nos casos de 2008 não será necessário porque já passou o prazo de entrega de retificação.

Segue exemplo de como proceder à geração:

Conta referencial na TFIX64:
...
Conta da Empresa: 133.0000.00000.236500.0000.000.BRPIS
Vinculada na conta referencial 2.01.01.05.00

Geração do arquivo em 2009:
|I050|01012004|01|A|4|133.0000.00000.236500.0000.000.BRPIS||PIS A RECOLHER|
|I051|10||2.01.01.05.00|

Conta da Empresa: 133.0000.00000.236500.0000.000.BRPIS
Vinculada nas contas referenciais 2.01.01.05.00 e pela substituta 2.01.01.05.01 (o contribuinte não deve retirar o parâmetro anterior, ou seja, conta 2.01.01.05.00 para caso precise retificar o arquivo)

Geração do arquivo em 2010:
|I050|01012004|01|A|4|133.0000.00000.236500.0000.000.BRPIS||PIS A RECOLHER|
|I051|10||2.01.01.05.00|
|I051|10||2.01.01.05.01| >>>>> Gera a nova conta de acordo com a data parametrizada, porém não ocorre advertência no validador.

Geração do arquivo em 2011:
|I050|01012004|01|A|4|133.0000.00000.236500.0000.000.BRPIS||PIS A RECOLHER|
|I051|10||2.01.01.05.01|

Atualmente o arquivo magnético está gerando esse registro da seguinte forma, sendo incorreta no caso do ano de 2011, pois não está considerando a data final na TFIX64:
|I050|01012004|01|A|4|133.0000.00000.236500.0000.000.BRPIS||PIS A RECOLHER|
|I051|10||2.01.01.05.00| >>>>> Gera a conta encerrada e ocorre advertência no validador.
|I051|10||2.01.01.05.01|

Para conseguirmos o resultado dessa geração, foi necessário também ajustar a TFIX64 encerrando as contas em 2010, das que estavam como 2011 e essa alteração foram feitas para as Versões 1.00 e 3.00 do plano de contas referencial.	OS2328Z
CH18978_2014		RN235	Os Relatórios sintéticos e analíticos deverão considerar as novas contas no de/para com sucesso, sem críticas.	OS2328Z		RN236	Na geração do registro J150 quando a opção ‘Omitir Informações de Centro de Custo’ estiver marcada nos dados iniciais, o MasterSAF não deve validar se existe parametrização por centro de custo na tabela SPED_CONTAS_AGLUT_EMP_CUSTO e se existe saldo por centro de custo na TMP_SPED_CONTAS_CUSTO, pois, quando essa opção é marcada, ao preencher a tabela TMP_SPED_CONTAS_CUSTO o aplicativo despreza a informação do Centro de Custo, então, nunca existirá saldo por centro de custo nessa tabela e existirá parametrização da DRE por centro de custo, causando o erro “Existe Código de Aglutinação parametrizado com Regra por Centro de Custo, porém não há saldo por centro de custo.”
...
Na geração do relatório analítico a coluna ‘Cód. Aglutinação – Descrição’ deverá se chamar ‘Cód. Aglutinação – Descrição (Cód. Conta – Cód Centro de Custo)’.
Quando o usuário tiver selecionado um código de aglutinação específico na tela de geração o processamento acima deve ser feito apenas para aquele código de aglutinação.	OS2388-R3		RN253	Ao gerar o registro J005 o sistema deverá verificar se a data final de geração for igual a 31/12/XXXX, e a data inicial for 01/12/XXXX, então no registro J005 deverá ser gerado como data inicial e data final o ano todo, ou seja, a Data inicial do registro J005 será 01/01/XXXX, e a data final será 31/12/XXXX.

O registro J005 sempre será gerado no arquivo e os campos 02 – DT_INI e 03 – DT_FIN respeitarão a seguinte regra:

Se na Tela de Geração os parâmetros “Balanço Patrimonial” E “Demonstração do Resultado” não forem selecionados (nenhum dos dois), teremos um registro J005 com a informação de período:
02 – DT_INI = será igual a Data Inicial de Geração informada pelo usuário
03 – DT_FIN = será igual a Data Final de Geração informada pelo usuário

Se na Tela de Geração o parâmetro “Balanço Patrimonial” OU “Demonstração do Resultado” for selecionado (pelo menos um dos dois), será gerado um registro J005 com informações de cada intervalo entre os lançamentos de encerramento (registro da SAFX01 com TIPO_LANCTO = E) ocorridos no ano de geração do arquivo até a Data Final informada. Considerando esta regra, teremos o registro J005 com a informação de período:
02 – DT_INI = Data do Último Lançamento de Encerramento + 1 dia. 
Considerar o lançamento de encerramento ocorrido em dezembro do ano imediatamente anterior ao ano informado na Data Final de geração para gerar o primeiro J005 do arquivo. Para os próximos J005 (se existirem, conforme cenários), considerar os encerramentos do próprio ano de geração.

No caso do Inicio de Atividade, o campo “Data Inicio de Atividade” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido e será uma data contida no ano de geração da obrigação. Neste caso, este campo será gerado com a Data Inicio de Atividade informada no Cadastro do Estabelecimento para o primeiro J005 do arquivo. Para os próximos J005 (se existirem, conforme cenários), considerar os encerramentos do próprio ano de geração.

03 – DT_FIN = Data do Lançamento de Encerramento

Cenários mapeados:

Geração Anual com encerramento anual, geração de arquivo único (sem situação especial):
[Tela de Geração] Data Inicial: 01/01/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados ou selecionados (para este cenário, isso é indiferente).
Geração do J005 será:
|J005|01012015|31122015|1||

Geração Mensal com encerramento anual (sem situação especial):
[Tela de Geração] Data Inicial: 01/12/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
|J005|01122015|31122015|1||

Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|31122015|1||

Geração com mais de um Mês e com encerramento anual (sem situação especial):
[Tela de Geração] Data Inicial: 01/08/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
|J005|01182015|31122015|1||
...
Geração Anual com encerramento Trimestral, geração de arquivo único (sem situação especial):
[Tela de Geração] Data Inicial: 01/01/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados
Geração do J005 será:
|J005|01012015|31122015|1||
...
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|31032015|1||
|J005|01042015|30062015|1||
|J005|01072015|30092015|1||
|J005|01102015|31122015|1||

Geração Mensal com encerramento Trimestral (sem situação especial):
[Tela de Geração] Data Inicial: 01/11/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
|J005|01112015|30112015|1||
...
Geração com mais de um Mês com encerramento Trimestral (sem situação especial):
[Tela de Geração] Data Inicial: 01/07/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
|J005|01072015|30112015|1||
...
Geração Anual com encerramento Semestral, geração de arquivo único (sem situação especial):
[Tela de Geração] Data Inicial: 01/01/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados
Geração do J005 será:
|J005|01012015|31122015|1||
...
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|30062015|1||
|J005|01072015|31122015|1||

Geração Mensal com encerramento Semestral (sem situação especial):
[Tela de Geração] Data Inicial: 01/11/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
...
Geração com mais de um Mês com encerramento Semestral (sem situação especial):
[Tela de Geração] Data Inicial: 01/07/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
...
Geração Anual com encerramento Mensal, geração de arquivo único (sem situação especial):
[Tela de Geração] Data Inicial: 01/01/2015 / Data Final: 31/12/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/01/2015 / 28/02/2015 / 31/03/2015 / 30/04/2015 / 31/05/2015 / 30/06/2015 / 31/07/2015 / 31/08/2015 / 30/09/2015 / 31/10/2015 / 30/11/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados
Geração do J005 será:
|J005|01012015|31122015|1||
...
|J005|01022015|28022015|1||
|J005|01032015|31032015|1||
|J005|01042015|30042015|1||
|J005|01052015|31052015|1||
|J005|01062015|30062015|1||
|J005|01072015|31072015|1||
|J005|01082015|31082015|1||
|J005|01092015|30092015|1||
|J005|01102015|31102015|1||
|J005|01112015|30112015|1||
|J005|01122015|31122015|1||

Geração Mensal com encerramento Mensal (sem situação especial):
[Tela de Geração] Data Inicial: 01/11/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/01/2015 / 28/02/2015 / 31/03/2015 / 30/04/2015 / 31/05/2015 / 30/06/2015 / 31/07/2015 / 31/08/2015 / 30/09/2015 / 31/10/2015 / 30/11/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
...
Geração com mais de um Mês com encerramento Mensal (sem situação especial):
[Tela de Geração] Data Inicial: 01/07/2015 / Data Final: 30/11/2015
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/01/2015 / 28/02/2015 / 31/03/2015 / 30/04/2015 / 31/05/2015 / 30/06/2015 / 31/07/2015 / 31/08/2015 / 30/09/2015 / 31/10/2015 / 30/11/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não selecionados.
Geração do J005 será:
...
Geração Com Situação Especial:
No caso da Geração com Situação Especial, o arquivo será gerado com a Data Final de Geração preenchida com a mesma data informada para a Situação Especial, conforme informada no Cadastro do Estabelecimento (Data da Cisão, Fusão, Incorporação, Extinção). Neste caso, haverá encerramento das contas de resultado na mesma data da situação especial.

A situação especial pode ocorrer em cada um dos cenários já mapeados:

Geração Anual com encerramento anual, geração de arquivo único
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/01/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|10112015|1||

Geração Mensal com encerramento anual
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/11/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|10112015|1||

Geração com mais de um Mês e com encerramento anual
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/07/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|10112015|1||

Geração Anual com encerramento Trimestral, geração de arquivo único
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/01/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|31032015|1||
|J005|01042015|30062015|1||
|J005|01072015|30092015|1||
|J005|01102015|10112015|1||

Geração Mensal com encerramento Trimestral
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/11/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
...
Geração com mais de um Mês com encerramento Trimestral
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/07/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 31/03/2015 / 30/06/2015 / 30/09/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
...
Geração Anual com encerramento Semestral, geração de arquivo único
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/01/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|01012015|30062015|1||
|J005|01072015|10112015|1||

Geração Mensal com encerramento Semestral
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/11/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
...
Geração com mais de um Mês com encerramento Semestral
Neste contexto, se a situação especial ocorrer em 10/11/2015, teremos uma geração onde será informada Data Inicial: 01/07/2015 / Data Final: 10/11/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2014 / 30/06/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
...
Geração Com Situação Especial de Início de Atividade:
No caso da Geração com Situação Especial de Início de Atividade no ano de geração do meio magnético, a Data Inicial do J005 será gerada conforme informada no Cadastro do Estabelecimento (Data Início Atividade).

Esta situação especial pode ocorrer em cada um dos cenários já mapeados:

Geração Anual com encerramento anual, geração de arquivo único
Neste contexto, o Início da Atividade pode ocorrer em 07/03/2015, teremos uma geração onde será informada Data Inicial: 07/03/2015 / Data Final: 31/12/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|07032015|31122015|1||

Geração Mensal com encerramento anual
Neste contexto, o Início da Atividade pode ocorrer em 07/03/2015, teremos uma geração onde será informada Data Inicial: 01/12/2015 / Data Final: 31/12/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|07032015|31122015|1||
...
Geração com mais de um Mês e com encerramento anual
Neste contexto, o Início da Atividade pode ocorrer em 07/03/2015, teremos uma geração onde será informada Data Inicial: 01/08/2015 / Data Final: 31/12/2015;
[SAFX01 com Encerramento] Encerramento em 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|07032015|31122015|1||
...
Geração Anual com encerramento Trimestral, geração de arquivo único
Neste contexto, o Início da Atividade pode ocorrer em 07/03/2015, teremos uma geração onde será informada Data Inicial: 07/03/2015 / Data Final: 31/12/2015;
[SAFX01 com Encerramento] Encerramento em 31/03/2015 / 30/06/2015 / 30/09/2015 / 31/12/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|07032015|31032015|1||
|J005|01042015|30062015|1||
|J005|01072015|30092015|1||
|J005|01102015|31122015|1||
...
Geração Anual com encerramento Semestral, geração de arquivo único
Neste contexto, o Início da Atividade pode ocorrer em 07/03/2015, teremos uma geração onde será informada Data Inicial: 07/03/2015 / Data Final: 31/12/2015;
[SAFX01 com Encerramento] Encerramento em 30/06/2015 / 10/11/2015
Parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” selecionados.
Geração do J005 será:
|J005|07032015|30062015|1||
|J005|01072015|31122015|1||
...
Para situações onde os parâmetros “Balanço Patrimonial” / “Demonstração do Resultado” não foram selecionados, serão considerados os cenários acima indicados.
	2328-N2
MFS-4847		RN254	No caso de não cair na situação acima, então o sistema deverá gerar a data incial e final do registro J005 com a mesma data do registro 0000, pois caso o cliente gere o arquivo trimestral, o registro J005 será gerado também desta forma, assim atendendo ao que exige a legislação

Deve ser avaliado também o cenário de situação especial, onde temos as seguintes possibilidades:

Cisão: No caso da Cisão, o campo “Data Cisão” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido. Neste caso, o cliente irá preencher como Data Final da Geração a Data da Cisão e o J005 será gerado com data inicial igual a Data Inicial parametrizada na tela de geração e a Data Final também, que corresponde ao momento da Cisão. Para o arquivo gerado após a Cisão, a data inicial do J005 será preenchida com a Data da Cisão + 1 dia e a Data Final igual a Data Final parametrizada na tela de geração. Observar que esta regra se aplica inclusive para geração mensal, onde, no momento em que o usuário indicar que devem ser gerados os demonstrativos, devemos gerar o J005 com a regra descrita. Ex.: empresa teve uma Cisão em 28/06/2015 e está gerando o arquivo mensal. Na geração de dezembro, o parametrizado será de 01/12/2015 até 31/12/2015. Neste momento ele indica que devem ser gerados os demonstrativos, então, neste contexto, a Data Inicial do J005 será 29/06/2015 e a Data Final 31/12/2015.

Fusão: No caso da Fusão, o campo “Data Fusão” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido. Neste caso, o cliente irá preencher como Data Final da Geração a Data da Fusão e o J005 será gerado com data inicial igual a Data Inicial parametrizada na tela de geração e a Data Final também, que corresponde ao momento da Fusão. Para o arquivo gerado após a Fusão, a data inicial do J005 será preenchida com a Data da Cisão + 1 dia e a Data Final igual a Data Final parametrizada na tela de geração. Observar que esta regra se aplica inclusive para geração mensal, onde, no momento em que o usuário indicar que devem ser gerados os demonstrativos, devemos gerar o J005 com a regra descrita. Ex.: empresa teve uma Fusão em 28/06/2015 e está gerando o arquivo mensal. Na geração de dezembro, o parametrizado será de 01/12/2015 até 31/12/2015. Neste momento ele indica que devem ser gerados os demonstrativos, então, neste contexto, a Data Inicial do J005 será 29/06/2015 e a Data Final 31/12/2015.

Incorporação: No caso da Incorporação, o campo “Data Incorporação” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido. Neste caso, o cliente irá preencher como Data Final da Geração a Data da Incorporação e o J005 será gerado com data inicial igual a Data Inicial parametrizada na tela de geração e a Data Final também, que corresponde ao momento da Incorporação. Para o arquivo gerado após a Incorporação, a data inicial do J005 será preenchida com a Data da Incorporação + 1 dia e a Data Final igual a Data Final parametrizada na tela de geração. Observar que esta regra se aplica inclusive para geração mensal, onde, no momento em que o usuário indicar que devem ser gerados os demonstrativos, devemos gerar o J005 com a regra descrita. Ex.: empresa teve uma Incorporação em 28/06/2015 e está gerando o arquivo mensal. Na geração de dezembro, o parametrizado será de 01/12/2015 até 31/12/2015. Neste momento ele indica que devem ser gerados os demonstrativos, então, neste contexto, a Data Inicial do J005 será 29/06/2015 e a Data Final 31/12/2015.

Extinção: No caso da Extinção, o campo “Data Encerramento” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido. Neste caso, o cliente irá preencher como Data Final da Geração a Data do Encerramento e o J005 será gerado com data inicial igual a Data Inicial parametrizada na tela de geração e a Data Final também, que corresponde ao momento da Encerramento. No caso de extinção, não há arquivo gerado após a situação especial.

Inicio de Atividade: No caso do Inicio de Atividade, o campo “Data Inicio de Atividade” do Cadastro do Estabelecimento que está gerando o arquivo estará preenchido. Neste caso, o cliente irá preencher como Data Inicial da Geração a Data de início da Atividade e o J005 será gerado com data inicial igual a Data Inicio de Atividade informada no Cadastro do Estabelecimento. Observar que esta regra se aplica inclusive para geração mensal, onde, no momento em que o usuário indicar que devem ser gerados os demonstrativos, devemos gerar o J005 com a regra descrita. Ex.: empresa teve Inicio de Atividade em 28/06/2015 e está gerando o arquivo mensal. Na geração de dezembro, o parametrizado será de 01/12/2015 até 31/12/2015. Neste momento ele indica que devem ser gerados os demonstrativos, então, neste contexto, a Data Inicial do J005 será 28/06/2015 e a Data Final 31/12/2015.
 	2328-N2
MFS-4831		RN255	A tela para parametrização do número de ordem será denominada ‘Número de Ordem’ e deverá conter:
...
Primeiramente o usuário deverá selecionar o registro a ser excluído, ao clicar no registro deverá apresentar uma seta do lado esquerdo das colunas e a linha inteira deverá ser destacada na cor “azul”. Em seguida, ao clicar no Botão Excluir, surgirá a mensagem de alerta, se o usuário confirmar a exclusão, somente a linha selecionada deverá ser apagada do Histórico.

Mensagem de Alerta: Manter a mesma da funcionalidade. “Confirma a exclusão do registro?”

A rotina deverá permitir que o usuário selecione um ou mais registros da lista, usando a funcionalidade do CTRL + clicar na linha selecionada ou arrastando o mouse nas linhas. Quando clicar no botão Excluir, surgirá a mensagem de alerta, se o usuário confirmar a exclusão, todas  as linhas selecionadas deverão ser apagadas do Histórico.

Mensagem de Alerta: “Confirma a exclusão dos registros?”

Como a tela de Controle da Obrigação possui duas ABAS, Livros Principais e Livros Auxiliares ao Diário, a alteração deverá ser feitas nas duas opções destacadas na tela.

	OS3042		RN269	Regra para registro 0150 – Cadastro de Participantes:

Um registro para cada pessoa fis/jur que consta na movimentação das notas fiscais do período. 

Considerar o registro da X04 de maior data de validade, que seja <= a data final do período.

Quanto aos campos 05 e 06 (CNPJ/CPF), preencher apenas um deles, dependendo do conteúdo do campo “CPF/CNPJ” da pessoa fis/jur.

ALTERADA CH109729
Para evitar duplicidade de códigos, a identificação do participante será gravada sempre com a concatenação do indicador da pessoa fis/jur (coluna IND_FIS_JUR) com o código (coluna COD_FIS_JUR), separados por hífen, no formato a seguir: [Indicador + “-“ + Código], deve trazer o registro da X04 de maior data de validade (campo VALID_FIS_JUR da tabela X04_ PESSOA_FIS_JUR) mesmo que haja grupos (GRUPO_FIS_JUR da tabela X04_ PESSOA_FIS_JUR) diferentes cadastrados para a mesma pessoa física/jurídica (Para não haver duplicidade nos casos de geração com estabelecimento centralizador).

OBS1: Nas situações de notas especiais, em que o campo COD_PART não é preenchido, deve-se estar atento para não gravar o participante em questão no registro 0150. Caso contrário, pode acontecer de existir apenas uma nota fiscal deste participante, e neste caso, o validador acusa erro devido à existência de um código de participante no registro 0150 que não aparece em nenhum documento do arquivo (exemplo: situação das notas canceladas).

OBS2: Na geração centralizada, gravar os participantes envolvidos nos documentos de todos os Estabelecimentos. Nesse caso, os registros 0150 serão gerados abaixo do registro 0140 do estabelecimento centralizador.	CH109729		RN270	Recuperar Data de Saldo por centro de custo, na qual estará sempre com o ultimo dia do período. Para preenchimento do campo "03 – DT_INI" recuperar o dia informado no campo “Data Inicial” da tela de geração do SPED Contábil (módulo: SPED Contábil – menu: Geração >> Meio Magnético). Para o campo 04 – DT_FIN recuperar o último dia do mês do Saldo informado por centro de custo.	CH13882_2012		RN271	Na geração do arquivo da ECD para os Livros do Tipo A – Livro Diário Auxiliar e Tipo Z – Razão Auxiliar, gerar no campo 04 - NAT_LIVR do Registro I030 do livro gerado a informação parametrizada no campo Descritivo do Livro para o SPED do cadastro correspondente ao livro que está sendo gerado. Esta informação está disponível na tela “Livros Auxiliares ao Diário” (Módulo ECD >> Parâmetros >> Livros Auxiliares ao Diário).

Para geração da ECD para os Livros do Tipo G – Diário Geral, Tipo R – Diário Resumido e Tipo B – Balancete Diário a informação para geração do campo 04 - NAT_LIVR do Registro I030 do livro gerado deve ser recuperada do campo Natureza do Livro referente ao Termo de Abertura, disponível na tela “Termo de Abertura/Encerramento” (Módulo ECD >> Parâmetros >> Termo de Abertura/Encerramento).	CH14409_2012
CH28131_2012		RN272	Na geração do arquivo da ECD para os Livros do Tipo A – Livro Diário Auxiliar e Tipo Z – Razão Auxiliar, gerar no campo 04 - NAT_LIVRO do Registro J900 do livro gerado a informação parametrizada no campo Descritivo do Livro para o SPED do cadastro correspondente ao livro que está sendo gerado. Esta informação está disponível na tela “Livros Auxiliares ao Diário” (Módulo ECD >> Parâmetros >> Livros Auxiliares ao Diário).

Para geração da ECD para os Livros do Tipo G – Diário Geral, Tipo R – Diário Resumido e Tipo B – Balancete Diário a informação para geração do campo 04 - NAT_LIVRO do Registro J900 do livro gerado deve ser recuperada do campo Natureza do Livro referente ao Termo de Encerramento, disponível na tela “Termo de Abertura/Encerramento” (Módulo ECD >> Parâmetros >> Termo de Abertura/Encerramento).	CH14409_2012		RN273	Só deve ser considerado para a geração do Livro Auxiliar as informações das contas que estão parametrizadas na tela ‘Livros Auxiliares ao Diário’, localizada no módulo SPED / ECD – Escrituração Contábil Digital , menu: Parâmetros.
	CH15368_2012		RN274	A geração do bloco J será alterada, se a demonstração de resultados for TRIMESTRAL.

Para a demonstração Trimestral, deve ser gerado um registro J005, J100, J150 e J800 por trimestre (01/01 à 31/03, 01/04 à 30/06, 01/07 à 30/09 e 01/10 à 31/12).  Com relação aos demais registros nada será alterado. 

Para a demonstração ANUAL, nada será alterado.


Identificando uma demonstração de resultados:

A periodicidade da demonstração de resultado será considerada com base na geração dos Registros I350, ou seja:

 - Lançamentos de encerramento na safx01 por trimestre (31/03/XXXX, 30/06/XXXX,30/09/XXXX e 31/12/XXXX), a Demonstração será considerada Trimestral

-  Apenas um registro I350 com data de 31/12/XXXX, na safx01, a Demonstração será considerada Anual.

Obs. Se existir na base do cliente situações distintas, das definidas nesta regra, a demonstração será considerada como ANUAL.

IMPORTANTE: Utilizamos como critério a geração dos registros I350, na identificação da periodicidade das demonstrações, pois  esses registros  exibem os saldos das contas de resultados antes do encerramento, sendo que essas contas são encerradas no final de cada período da apuração. Período este,  que deve ser considerado também nos demonstrativos.
	
OS3676		RN275	A RN274 deve ser aplicada para os livros G, R e B.

	OS3676		RN276	
Geração do Registro I150 – Regra Geral
Mastersaf DW (ECD Escrituração Contábil Digital(Geração(Meio Magnético(Data inicial(Data final.
A geração será mensal, devendo existir um registro I150 para cada mês do período compreendido entre a data inicial e final de geração do arquivo, obrigatório no caso de escrituração do tipo G, R ou B. 

Se os campos DATA_CISAO/ DATA_FUSAO/ DATA_INCORPORAÇÃO não estiverem preenchidos a data inicial do primeiro Registro I150 será igual à data inicial da geração (Mastersaf DW (ECD Escrituração Contábil Digital(Geração(Meio Magnético(Data inicial) e a data final será a do campo 04- DATA_SALDO da SAFX02 do mesmo mês/ano da data inicial.  

Para os demais Registros I150 a data inicial será sempre o primeiro dia do mês e a data final será igual a do campo 04- DATA_SALDO da SAFX02 do mesmo mês/ano da data inicial. 
	CH24421-2012		RN277	Geração do Registro I150 – Situação Especial (cisão, fusão, incorporação e transferência de sede)

Mastersaf DW ( ECD Escrituração Contábil Digital ( Geração ( Meio Magnético ( Data inicial( Data final.

A geração será mensal, devendo existir um registro I150 para cada mês do período compreendido entre a data inicial e final de geração do arquivo, obrigatório no caso de escrituração do tipo G, R, S ou B. 

Se um destes campos DATA_CISAO/ DATA_FUSÃO/ DATA_INCORPORAÇAO/ DATA TRANSF. DE SEDE/ DATA TRANSFORMAÇÃO da tabela estabelecimento estiver preenchido a data inicial do primeiro Registro I150 será a igual da data inicial da geração (Mastersaf DW (ECD Escrituração Contábil Digital(Geração(Meio Magnético(Data inicial) e a data final será igual a do campo 04- DATA_SALDO (que será igual a data da situação especial) da SAFX02 do mesmo mês/ano da data inicial. Esta regra é válida somente para o mês/ano em que ocorreu a cisão/fusão/incorporação.

Para os meses seguintes ao da cisão/fusão/incorporação a data inicial será o primeiro dia de cada mês e a data final igual ao campo 04- DATA_SALDO da SAFX02 do mesmo mês/ano da data inicial.
	CH24421-2012
OS4791
MFS1282		RN278	O registro J800 será gerado com base na seleção do parâmetro "Gerar conteúdo do arquivo RTF armazenado na base de dados - J800 Outras Inf. Demonstrações Contábeis (BP e DRE)" e considerando também as seguintes regras:

Se for definida periodicidade Mensal, deverá ser gerado o J800 no mês de referência da geração. Se na geração for parametrizado um período superior a um mês, os arquivos parametrizados neste critério não serão gerados.

Se for definida periodicidade Trimestral, deverá ser gerado o J800 no arquivo quando for parametrizado na tela de geração o período trimestral, considerando a informação parametrizada no campo referência da tela de demonstrações contábeis (1º - 31/03, 2º - 30/06, 3º - 30/09 ou 4º - 31/12). Se for parametrizado na tela de geração o período de um ano, gerar os registros do J800 cuja referência atenda ao período de geração (um para cada trimestre). Deverá ser levado em conta o ano de geração do arquivo e o parametrizado para geração do J800.

Se for definida periodicidade Semestral, deverá ser gerado o J800 no arquivo quando for parametrizado na tela de geração o semestre, considerando a informação parametrizada no campo referência da tela de demonstrações contábeis (1º - 30/06 ou 2º - 31/12). Se for parametrizado na tela de geração o período de um ano, gerar os registros do J800 cuja referência atenda ao período de geração (um para cada semestre). Deverá ser levado em conta o ano de geração do arquivo e o parametrizado para geração do J800.

[ALTERADA - CH12515_2014]
Se for definida periodicidade Anual, deverá ser gerado o arquivo quando for parametrizado na tela de geração o período anual. Deverá ser levado em conta o ano de geração do arquivo e o parametrizado para geração do J800.
Tratamento: Considerar o Período da Data de Atividade da tabela de Estabelecimento como data inicial e a data final de geração do arquivo magnético. Por exemplo: 15/03/2013 a 31/12/2013, pois pode ocorrer que um determinado estabelecimento inicie às suas atividades, posterior a data anual considerada, que seria janeiro.	OS3676
CH12515_2014		RN279	
A geração do bloco J será alterada, se a demonstração de resultados for SEMESTRAL.

Para a demonstração Semestral, deve ser gerado um registro J005, J100, J150 e J800 por semestre (01/01 a 30/06, 01/07 a 31/12).  Com relação aos demais registros nada será alterado. 
...
- Lançamentos de encerramento na safx01 por semestre (30/06/XXXX e 31/12/XXXX), a Demonstração será considerada Semestral.

- Apenas um registro I350 com data de 31/12/XXXX, na safx01, a Demonstração será considerada Anual.

Obs. Se existir na base do cliente situações distintas, das definidas nesta regra e da trimestral, a demonstração será considerada como ANUAL.

IMPORTANTE: Utilizamos como critério a geração dos registros I350, na identificação da periodicidade das demonstrações, pois esses registros exibem os saldos das contas de resultados antes do encerramento, sendo que essas contas são encerradas no final de cada período da apuração. Período este,  que deve ser considerado também nos demonstrativos.
	
OS3676		RN280	A RN279 deve ser aplicada para os livros G, R e B.
	OS3676		RN281	
Registro I051

As informações das Contas Referenciais geradas no Registro I051 devem ser demonstradas considerando a versão do Plano Referencial parametrizada na tela de geração do meio magnético. Devem ser apresentadas somente informações da versão selecionada pelo usuário no momento da geração, e considerando que o registro I051 tenha sido selecionado para o Perfil que está gerando a obrigação.
	OS4007		RN282	
Registro I020

Este registro será gerado com base no que foi parametrizado na tela “Registro I020 – Campos Adicionais” (menu Parâmetros), sempre que na tela de Perfil o registro I020 estiver selecionado e for indicado o Tipo de Livro e Perfil a ele vinculado. Ele terá a seguinte estrutura:
...
01
REG
Informação fixa: “I020”

02
REG_COD
Será gerado com o código do registro informado no campo “Código do Registro”.

03
NUM_AD
Será gerado com o conteúdo do campo “Sequencial do campo adicional”

04
CAMPO
Será gerado com o conteúdo do campo “Nome do campo adicional”

05
DESCRICAO
Será gerado com o conteúdo do campo “Descrição do campo adicional”

06
TIPO
Será gerado com o tipo informado no campo “Formato do conteúdo do campo adicional”

 	OS4123		RN283	
Registro I050 – Impactos gerados pelo I020

Se na geração do registro I020 – Campos Adicionais, no campo “Código do Registro” for informada a opção “Registro I050 – Plano de Contas”, na geração do registro I050 será adicionado um ou mais campos (considerando os campos parametrizados) ao final da estrutura do registro gerando o conteúdo da SAFX2002, campo informado na tela no campo “Origem do campo adicional”.

Se for incluído mais de um campo adicional para o registro, ele será demonstrado considerando a sequencia informada no campo “Sequencial do campo adicional”.

Exemplo:

Na tela foi parametrizado:

Código do Registro -> Registro I050 – Plano de Contas
Sequencial do campo adicional -> 001
Nome do campo obrigatório -> Campo Teste
Descrição do campo adicional -> Descrição Teste
Origem do campo adicional -> Código Reduzido da Conta
Formato do conteúdo do campo adicional -> C – Caracter

No registro I050 teremos:

|I050|01012012|04|A|4|1.00.00.00.01|1.00.00.00|Receita 1.00.00.00.01|1.00.00|

Neste exemplo, o que está em cinza é a estrutura padrão do registro e o campo |1.00.00| foi gerado por conta do campo adicional informado no I020, com o conteúdo informado no campo Código Reduzido da Conta da SAFX2002.
	OS4123		RN284	
Registro I200 – Impactos gerados pelo I020

Se na geração do registro I020 – Campos Adicionais, no campo “Código do Registro” for informada a opção “Registro I200 – Lançamentos Contábeis”, na geração do registro I200 será adicionado um ou mais campos (considerando os campos parametrizados) ao final da estrutura do registro gerando o conteúdo da SAFX01, campo informado na tela no campo “Origem do campo adicional”.

Se for incluído mais de um campo adicional para o registro, ele será demonstrado considerando a sequencia informada no campo “Sequencial do campo adicional”.

Como o registro I200 é resultado do agrupamento de informações de lançamentos contábeis consolidando pelo campo NUM_LCTO e podemos ter conteúdos de campos adicionais distintos para um mesmo NUM_LCTO, pelo fato da nossa tabela permitir essa situação. Caso ocorra este cenário, na geração deve ser considerado o conteúdo do primeiro registro lido e deve ser demonstrada na log a seguinte mensagem: “Para o campo adicional do I200 foi identificado conteúdo que conflita com a chave do registro. Foi gerado o conteúdo do primeiro registro lido”.

Exemplo:

Na tela foi parametrizado:

Código do Registro -> Registro I200 – Lançamentos Contábeis
Sequencial do campo adicional -> 001
Nome do campo obrigatório -> Campo Teste
Descrição do campo adicional -> Descrição Teste
Origem do campo adicional -> Código do Serviço
Formato do conteúdo do campo adicional -> C – Caracter

No registro I200 teremos:

|I200|1234|10012013|1000|N|1117|

Neste exemplo, o que está em cinza é a estrutura padrão do registro e o campo |1117| foi gerado por conta do campo adicional informado no I020, com o conteúdo informado no campo Código do Serviço da SAFX01.

Se para os registros que compõe o NUM_LCTO 1234 fosse informado os códigos de serviço 1117 e 1118, seria gerado apenas um código de serviço e retornaria mensagem no log.
	OS4123		RN285	
Registro I250 – Impactos gerados pelo I020

Se na geração do registro I020 – Campos Adicionais, no campo “Código do Registro” for informada a opção “Registro I250 – Partidas do Lançamento Contábil”, na geração do registro I200 será adicionado um ou mais campos (considerando os campos parametrizados) ao final da estrutura do registro gerando o conteúdo da SAFX01, campo informado na tela no campo “Origem do campo adicional”.
...
No registro I250 teremos:

|I250|1.00.00.00.01|CCUSTO|1000|D|||teste||1117|

Neste exemplo, o que está em cinza é a estrutura padrão do registro e o campo |1117| foi gerado por conta do campo adicional informado no I020, com o conteúdo informado no campo Código do Serviço da SAFX01.
	OS4123		RN286	Registro J100 – Campos 06 - VL_CTA e 07 - IND_DC_BAL

Os valores que irão compor o campo 06 - VL_CTA do registro J100 serão obtidos com base no valor do Saldo Final das Contas Contábeis associadas ao código de aglutinação, considerando como período de referência para seleção dos registros de saldo o mês e ano da data informada no campo 03 - DT_FIN do registro J005 (desta forma atendemos geração anual, trimestral e semestral).

Teremos o seguinte cálculo: (Somatória do Valor do Saldo Final das Contas Contábeis cujo Ind. De Débito/Crédito seja igual a “D”) menos (Somatória do Valor do Saldo Final das Contas Contábeis cujo Ind. De Débito/Crédito seja igual a “C”). Mostrar sempre o valor absoluto (positivo).

O campo 07 - IND_DC_BAL será obtido com base no resultado gerado no campo 06 - VL_CTA. Se o resultado do cálculo for positivo ou zero, gerar o indicador “D”. Se for negativo, gerar o indicador “C”.
...
Observar que, na seleção da SAFX80 há segregação por centro de custo, mas a totalização deve considerar apenas Conta Contábil.
	CH10431/2014		RN287	Registro 0000 – Campo 11 – IND_SIT_ESP
...
Para saber se ocorreu situação especial, verificar se, para o período parametrizado, há no cadastro do estabelecimento selecionado um dos campos que indicam data de situação especial preenchido com a mesma data final parametrizada para geração do arquivo, considerando:

Se o campo “Data Cisão” estiver com a mesma data informada no campo Data Final de geração, este campo será gerado com conteúdo “1”.

Se o campo “Data Fusão” estiver com a mesma data informada no campo Data Final de geração, este campo será gerado com conteúdo “2”.

Se o campo “Data Incorporação” estiver com a mesma data informada no campo Data Final de geração, este campo será gerado com conteúdo “3”.

Se o campo “Data Encerramento” estiver com a mesma data informada no campo Data Final de geração, este campo será gerado com conteúdo “4”.
...
[Alterada - MFS-41465] Se no cadastro do estabelecimento, pelo menos um dos campos “Data Cisão” “Data Fusão”, “Data Incorporação”, “Data Encerramento”, “Data Transformação” e ou Data Transf. de Sede”, estiver informado, e a data inicial de geração do arquivo for diferente da data do evento, indicada em um destes campos do cadastro do estabelecimento, este campo não deve ser preenchido.
	OS4791
MFS_1282
MFS-41465		RN288	Registro I052 – Regra Geral

As informações deste registro serão utilizadas para a elaboração das demonstrações contábeis nos registros do bloco J. 

Deve ser utilizado o código de aglutinação (Campo 03 – COD_AGL) válido na data de encerramento e de maior detalhamento utilizado nas demonstrações contábeis.

[ALTERADA – CH12235_2015]
Para essa geração, o sistema deverá observar a conta da SAFX2002 que foi associada ao código de aglutinação, em SPED >> ECD – ESCRITURAÇÃO CONTÁBIL DIGITAL >> Manutenção >> Códigos de Aglutinação – Botão “Selecionar Contas da Empresa para Apuração”.
Tratamento:
Desconsiderar as contas da empresa que estiverem com o campo 13-Indicador de Situação da Conta igual a “I – Inativa” da SAFX2002, pois no próprio Registro I050 essas contas já estão sendo desconsideradas, onde somente as contas ativas serão consideradas na geração destes registros;
Serão consideradas as contas de maior validade para não duplicar o registro.                   

Exemplo:
A empresa possui um cadastro de conta 133.0000.00000.245110.0000.000.0000 com início de validade a partir do ano de 2013;
Essa conta foi vinculada ao plano de contas referencial determinado pela Receita Federal;
Essa conta foi vinculada ao um código de aglutinação em determinado período de entrega da ECD;
Porém, essa conta teve alteração e foi inativada no cadastro, ou seja, campo 13-Indicador de Situação da Conta igual a “I – Inativa” da SAFX2002;
A empresa recadastrou essa conta novamente com o início de validade a partir do ano de 2014 e a vinculou ao mesmo código de aglutinação, por ser a conta que teve movimentação no período de entrega da ECD.

Geração dos Registros referente o contexto anterior:

Plano de Contas da Empresa (SAFX2002)
|I050|01012013|01|A|0|133.0000.00000.245110.0000.000.0000||ENCARGOS SOCIAIS A RECOLHER|

Plano de Contas Referencial vinculada no DW (Plano de Contas Referencial x Plano de Contas da Empresa)
|I051|1||2.01.01.01.03|

Indicação dos Códigos de Aglutinação vinculada no DW (Selecionar Contas da Empresa para Apuração)
|I052||2.1.3|

Assim como não considerou (não duplicou) o código da conta 133.0000.00000.245110.0000.000.0000 para o Registro I050, não deve ser considerado na geração do Registro I052 se a conta vinculada estiver como inativa no cadastro SAFX2002.
	CH12235_2015		RN289	
Registro I350 e I355

O registro I350 é utilizado para Demonstração dos Saldos das Contas de Resultado Antes do Encerramento. Este registro será gerado sempre que existir pelo menos um Lançamento de Encerramento na SAFX01 no período de geração do arquivo e será gerado com a data do último dia do mês em que o lançamento de encerramento for identificado, ou no caso de situações especiais (identificadas no cadastro do estabelecimento) com a data da situação especial.

O registro I355 é filho do registro I350. Nele será demonstrado o detalhe do saldo das contas de resultado antes do encerramento, consolidando os valores por Conta Contábil e Centro de Custo, recuperando da SAFX01 os lançamentos de encerramento para a data informada no registro pai, I350. Nele teremos:

02 – COD_CTA
Conta Contábil indicada na SAFX01

03 – COD_CCUS
Centro de Custo informado na SAFX01. Se o parâmetro “Omitir Informações de Centro de Custo em Lançamentos Contábeis e Saldos” estiver selecionado, não será gerado conteúdo.

04 – VL_CTA
Será resultado do cálculo:
Somatória do Valor dos Lançamentos de Encerramento a Débito menos Somatória do Valor dos Lançamentos de Encerramento a Crédito.
Deve ser demonstrado sempre o valor positivo.
