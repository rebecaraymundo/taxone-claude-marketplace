...
Localização: Menu Sped, Módulo: Escrituração Fiscal Digital, item Parâmetros à Registro 1400  à Específico Por UF à BA – Produto Diferido
...
| --- | --- | --- | --- |
| MFS61948 | Aline Melo | Criação da parametrização de produtos diferidos para geração do 1400, formato Especifico por UF, para o Estado da Bahia. | 22/03/2021 |
|  |  |  |  |
|  |  |  |  |
...
| --- | --- | --- |
| 1 | Usuário | Usuário seleciona o item de menu Parâmetros à Registro 1400  à Específico Por UF à BA – Produto Diferido |
...
| 5 | Sistema | Abre a tela de Parametrização dos Produtos, com os campos Estabelecimento e Grupo preenchidos e bloqueados. Os campos Grupo Produto, Indicador, Código Inicial, Código Final são apresentados “em branco”. |
| 6 | Usuário | Usuário seleciona um grupo de produto na lista do campo “Grupo Produto” |
| 7 | Usuário | Usuário seleciona um indicador do produto na lista do campo “Indicador”. |
| 8 | Sistema | Sistema habilida os campos Código Inicial, Código Final. |
| 9 | Usuário | Digita ou seleciona na pastinha o Código Inicial. |
| 10 | Sistema | Valida o Código Inicial no Cadastro de Produtos (SAFX2013). Vide regra do campo “Início Validade” descrita no tópico “5 – Regras de Funcionamento dos Campos”. |
| 11 | Usuário | Digita ou seleciona na pastinha o Código Final. |
| 12 | Sistema | Valida o Código Final no Cadastro de Produtos (SAFX2013). Vide regra do campo “Início Validade” descrita no tópico “5 – Regras de Funcionamento dos Campos”. |
| 13 | Usuário | Usuário escolhe “Informar Exclusões”. |
| 14 | Sistema | Sistema apresenta o conjunto de produtos cujo código está compreendido entre os Códigos Inicial e Final informados. |
| 15 | Usuário | Seleciona alguns produtos a serem excluídos da faixa. |
| 16 | Usuário | Seleciona botão confirma. |
| 17 | Sistema | Executa validações descritas no tópico 6- Validações.  Caso os dados estejam consistentes, grava as parametrizações na tabela definitiva. |
| 18 | Usuário | Seleciona outras ações disponíveis na barra de menu da janela. Vide tópico “4 - Botões da barra de menu” |
...
| --- | --- | --- | --- | --- | --- | --- |
| Estabelecimento | Alfanumérico | S | N |  | Neste campo será exibido o código e a razão social do estabelecimento do Grupo selecionado pelo usuário na abertura da tela, ou através da opção “SELECIONAR GRUPO” da barra de menu.  Somente devem ser mostrados os estabelecimentos do estado do “BA”. |  |
...
| Grupo Produto | Alfanumérico | S | N | Lista | Neste campo será exibida uma lista contendo o grupo de produtos, para selecionar o tipo de produto diferido que será atendido de acordo com o Registro 1400. Devem ser listados os grupos:  Eucalipto (código 791) Materiais para combustão (código 792) Embalagens e insumos (código 793) |  |
...
| COD_PARAM | Alfanumérico |  |  |  | Esse campo não deve ser demonstrado na tela nem no relatório. Gravar o registro com COD_PARAM de acordo com Código do Grupo Produto informado  Esse código é carregado pela TFIX31. |  |
