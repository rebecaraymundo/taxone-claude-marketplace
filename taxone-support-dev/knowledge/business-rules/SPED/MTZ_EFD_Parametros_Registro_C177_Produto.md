...
Localização: Menu Sped, Módulo: Escrituração Fiscal Digital, item Parâmetros  Registro C177 – Comércio Atacadista  Produto
...
Registro 2   Código inicial = 1000600 e Código final = 1000699
...
| --- | --- | --- | --- |
| MFS80572 | Andréa Rocha | Criação da parametrização de Produto para geração dos dados do registro C177 – Comércio Atacadista. | 11/11/2022 |
|  |  |  |  |
