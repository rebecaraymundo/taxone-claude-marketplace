...
| --- | --- | --- | --- |
| OS3169-DW17 | Criação da tela Retenções a Utilizar na Apuração – COFINS | Criação da tela de Retenções a Utilizar na Apuração – COFINS |  |
| OS3169-GE28 | Alteração na tela Retenções a Utilizar na Apuração – COFINS | Incluir na tela Retenções a Utilizar na Apuração (COFINS) o campo Retenção Disponível | 07/11/2011 |
|  |  |  |  |
