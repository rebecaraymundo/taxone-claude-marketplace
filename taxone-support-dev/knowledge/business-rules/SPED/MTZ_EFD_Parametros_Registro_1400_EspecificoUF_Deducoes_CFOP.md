...
Parametrização por CFOP das Operações a serem Deduzidas
na Geração do Registro 1400 (regras específicas por UF)


Localização: Menu Sped, Módulo EFD - Escrituração Fiscal Digital, item Parâmetros  Registro 1400  Específico por UF  Deduções  CFOP
...
A princípio, ela será utilizada apenas para um dos códigos da tabela do estado de MG, e também para dois códigos do ES: ESIPM05 e ESIPM10 (ver RN02).
...
| MFS1566 | Portaria N. 34-R, Sefaz-ES | Inclusão dos códigos 05 e 10 para o estado do ES (ver RN02 e RN03) | 14/09/20915 |
| MFS3248 | Orientação Técnica EFD nº 011/2016 – Versão 1.10 | Inclusão dos códigos para o estado do RN (ver RN02 e RN03) | 11/11/2016 |
| MFS7449 | Alteração do 1400 p/ SP | Inclusão dos códigos 23 e 24 de SP na parametrização das deduções. | 24/01/2017 |
...
| MFS35318 | Inclusão de código | Inclusão do código TOIPMS10 para o estado de Tocantins. | 19/08/2021 |
...
| RN04 | Campo Replicar para os estabelecimentos: |
| --- | --- |
