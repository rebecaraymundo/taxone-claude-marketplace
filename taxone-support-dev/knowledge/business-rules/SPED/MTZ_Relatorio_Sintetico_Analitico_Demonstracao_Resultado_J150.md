...
Layout: vide planilha “Layout-Relatorios-BP-DRE-DMPL-DLPA.xlsx”, abas “Relatório DRE - Sintético” e “Relatório DRE – Analítico”.
...
| --- | --- | --- | --- |
| MFS31024 | Alessandra Cristina Navatta | Criação dos Relatórios (Sintético e Analítico) da Demonstração de Resultados – J150. | 18/10/2019 |


| Campo | Campo | Tipo | Formato / Default | Regra |
| --- | --- | --- | --- | --- |
| Cabeçalho | Cabeçalho | Cabeçalho | Cabeçalho | Cabeçalho |
| Título | Título | Texto |  | Demonstração de Resultado – Relatório Sintético |
...
| Página | Página | Texto | - | Exibir o numero da página do relatório |
