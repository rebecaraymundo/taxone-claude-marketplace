...
Se não houver parametrização em “Perfil por estabelecimento” então o a tela de geração do SPED continuará buscando todos estabelecimentos associados à empresa, da forma como já é feito hoje. Não alterar o produto.

OBS.: A lista dos estabelecimentos deverá continuar respeitando a regra onde são filtrados por inscrição estadual.

	


OS-2388-A7		RN02	Campo “Leiaute”
...
MFS-45380
MFS73692
MFS85388		RN03	Filtro do Estabelecimento

A listagem dos estabelecimentos deve mostrar todos os estabelecimentos e Inscrições Estaduais cadastradas em Parâmetros > Funcionais > Inscrições Estaduais do Estabelecimento (AM).
	OS3369