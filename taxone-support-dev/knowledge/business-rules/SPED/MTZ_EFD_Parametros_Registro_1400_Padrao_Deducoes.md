# MTZ_EFD_Parametros_Registro_1400_Padrao_Deducoes

> Fonte: MTZ_EFD_Parametros_Registro_1400_Padrao_Deducoes.doc

Módulo Sped Fiscal – Parametrização das Deduções do Registro 1400 (Valor Adicionado)

Localização: 
Menu Estadual, Módulo EFD, menu Parâmetros ( Registro 1400 ( Padrão (Deduções ( CFOP
                                                                                                                                                  ( CFOP / Natureza de Operação

Obs: Esta parametrização foi replicada para o Módulo SEF II – PE (OS3065-B1), para atender a geração dos registros do Valor Adicionado do SEF II (registro 8040). Itens de menu da parametrização no Módulo SEF II – PE (menu Estadual):

                                Parâmetros ( Cálculo do Valor Adicionado (QVA) ( Deduções ( CFOP
                                                                                                                                        ( CFOP / Natureza de Operação
...
No quadro dos CFOP’s será exibida a lista de todos os CFOP’s, tanto entradas como saídas.
...
Serão considerados todos os CFOP’s, tanto entradas como saídas.
