...
Módulo EFD - REINF
Relatório de Conferência do Evento R-2020 - Sintético
...
| --- | --- | --- | --- |
| MFS15341 | Lara Aline | Alteração do Modulo REINF para criação de um relatório de conferência do evento R-2020. Novo relatório  “Relatório de Conferência do Evento R-2020”. | 08/02/2018 (criação do documento) |
...
| Versão | Texto | S | S | Default: Versão atual | Este campo exibe todas as versões de layout do Reinf. | MFS15341 |
| Tipo do Relatório | Checkbox | S | S | Default: Habilitado | Permitir que o usuário informe qual o tipo de relatório será emitido entre as opções:  - Analítico - Sintético | MFS15341 |
...
| Título | Texto |  | Título do relatório: “Relatório de Histórico das Alterações - Dados Iniciais” | MFS15341 |
...
| Tipo de Arquivo | Numérico |  | Tipo de Arquivo, gerado no campo indRetif do evento R-2020. | MFS15341 |
| Número Recibo | Alfanumérico |  | Número Recibo, gerado no campo nrRecibo do evento R-2020. | MFS15341 |
| Tipo Ambiente | Alfanumérico |  | Tipo Ambiente, gerado no campo tpAmb do evento R-2020. | MFS15341 |
| Processo de Emissão | Alfanumérico |  | Processo de Emissão, gerado no campo procEmi do evento R-2020. | MFS15341 |
| Versão do Processo de Emissão | Alfanumérico |  | Versão do Processo de Emissão, gerado no campo procEmi do evento R-2020. | MFS15341 |
| Tipo de Inscrição Contribuinte | Alfanumérico |  | Tipo de Inscrição Contribuinte, gerado no campo tpInsc do evento R-2020. | MFS15341 |
| Número de Inscrição Contribuinte | Data | DD/MM/AAAA | Número de Inscrição Contribuinte, gerado no campo nrInsc do evento R-2020. | MFS15341 |
| Corpo do Relatório – SERVIÇOS PRESTADOS - CESSÃO DE MÃO DE OBRA OU EMPREITADA / Identificação do Estabelecimento "prestador" de serviços mediante cessão de mão de obra | Corpo do Relatório – SERVIÇOS PRESTADOS - CESSÃO DE MÃO DE OBRA OU EMPREITADA / Identificação do Estabelecimento "prestador" de serviços mediante cessão de mão de obra | Corpo do Relatório – SERVIÇOS PRESTADOS - CESSÃO DE MÃO DE OBRA OU EMPREITADA / Identificação do Estabelecimento "prestador" de serviços mediante cessão de mão de obra | Corpo do Relatório – SERVIÇOS PRESTADOS - CESSÃO DE MÃO DE OBRA OU EMPREITADA / Identificação do Estabelecimento "prestador" de serviços mediante cessão de mão de obra | Corpo do Relatório – SERVIÇOS PRESTADOS - CESSÃO DE MÃO DE OBRA OU EMPREITADA / Identificação do Estabelecimento "prestador" de serviços mediante cessão de mão de obra |
| Tipo Inscrição Estabelecimento | Alfanumérico |  | Tipo Inscrição Estabelecimento, gerado no campo tplnsEstab do evento R-2020. | MFS15341 |
| Número Inscrição Estabelecimento | Alfanumérico |  | Número Inscrição Estabelecimento, gerado no campo nrlnscEstab do evento R-2020. | MFS15341 |
| Corpo do Relatório – Identificação dos tomadores dos serviços | Corpo do Relatório – Identificação dos tomadores dos serviços | Corpo do Relatório – Identificação dos tomadores dos serviços | Corpo do Relatório – Identificação dos tomadores dos serviços | Corpo do Relatório – Identificação dos tomadores dos serviços |
...
| Indicativo Obra | Alfanumérico |  | Indicativo Obra, gerado no campo indObra do evento R-2020. | MFS15341 |
| Valor Total Bruto | Numérico | Default: 0,000 | Valor Total Bruto (VLR_TOT) da SAFX09, gerado no campo vlrTotalBruto do evento R-2020. | MFS15341 |
| Valor Total Base Retenção | Numérico | Default: 0,000 | Valor Total Base Retenção (VLR_BASE_INSS) da SAFX09, gerado no campo vlrTotalBaseRet do evento R-2020. | MFS15341 |
| Valor Total Retenção Principal | Numérico | Default: 0,000 | Valor Total Retenção Principal (VLR_INSS_RETIDO – VLR_RET_SERV) da SAFX09, gerado no campo vlrTotalRetPrinc do evento R-2020. | MFS15341 |
| Valor Total Retenção Adicional | Numérico | Default: 0,000 | Valor Total Retenção Adicional (VLR_TOT_ADIC) da SAFX09, gerado no campo vlrTotalRetAdic do evento R-2020. | MFS15341 |
| Valor Total Não Retenção Principal | Numérico | Default: 0,000 | Valor Total Não Retenção Principal (VLR_N_RET_PRINC) da SAFX09, gerado no campo vlrTotalNRetPrinc do evento R-2020. | MFS15341 |
| Valor Total Não Retenção Adicional | Numérico | Default: 0,000 | Valor Total Não Retenção Adicional (VLR_N_RET_ADIC) da SAFX09, gerado no campo vlrTotalINRetAdic do evento R-2020. | MFS15341 |
