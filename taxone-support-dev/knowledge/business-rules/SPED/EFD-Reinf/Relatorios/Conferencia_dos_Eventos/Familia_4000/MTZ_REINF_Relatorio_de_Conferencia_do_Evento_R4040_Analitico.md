...
__Relatório de Conferência do Evento Família 4000 \(R\-4040 – Analítico\)__
...
Criação de um relatório de conferência do evento R\-4040 \(analítico\)\. Relatórios à “Conferência dos Eventos àR\-4040”\.
...
- Data Escr\. Cont\., no agrupamento – Informações de Pagamentos a Beneficiários não Identificados
...
Título do relatório: “Relatório de Conferência do Evento R\-4040 \- Analítico”
...
__Corpo do Relatório – Informações de Pagamentos a Beneficiários não Identificados__
...
Data do movimento vinculado ao evento R4040
...
Valor Líquido vinculado ao evento R\-4040\.
...
Valor Reajustado vinculado ao evento R\-4040\.
...
Valor do Imposto de Renda Retido na Fonte vinculado ao evento R\-4040\.
...
Descrição vinculada ao evento R\-4040\.
...
Tipo de Processo , correspondente o evento R\-4040
...
Número Processo \(NUM\_PROC\) correspondente gerado no campo nrProc do evento R\-4040\.  
...
Código Suspenção \(COD\_SUSP\) correspondente gerado no campo codSusp do evento R\-4040\.  
...
Valor da Base com Exigibilidade Suspensa gerado no evento R\-4040
...
Valor da Retenção que Deixou de ser Efetuada gerado no evento R\-4040
...
Valor do Depósito Judicial gerado no evento R\-4040
...
__                                                        			 Relatório de Conferência do Evento R\-4040 – Analítico__
...
__Informações de Pagamentos a Beneficiários não Identificados__

__Data do Fato Gerador__
