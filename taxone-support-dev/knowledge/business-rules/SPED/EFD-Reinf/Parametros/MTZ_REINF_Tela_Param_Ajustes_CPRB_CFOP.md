...
__Tela de Parâmetros dos Ajustes da CPRB – Por CFOP__
...
Criação da Tela de <a id="_Hlk520717298"></a>Parâmetros dos Ajustes da CPRB por CFOP
...
__Localização da tela:__ Menu SPED, Módulo: EFD\-REINF, item de menu Parâmetros > CPRB > Parâmetros dos Ajustes da CPRB > Por CFOP

__Título da tela: __Parâmetros dos Ajustes da CPRB por CFOP
...
<a id="_Hlk520306845"></a>Código da Receita
...
Exibir a lista de CFOP´s\.

Nesse campo será exibido apenas os CFOP´s que não possuam cadastro para outro Código de Ajuste\.

Obs: O CFOP só pode ser associado a um código de atividade\.
