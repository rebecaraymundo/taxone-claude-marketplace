...
Funcionalidade Upload – Validações
...
| CH17950 | Funcionalidade Upload | Criação de nova mensagem de log, se não for encontrado no XML lido a TAG <LISTADADOS> | 05/07/2012 |
...
| --- | --- | --- |
| RN02 | Se não for encontrado no XML lido a TAG <LISTADADOS> , exibir a seguinte msg no log: Atencao nao foi encontrada TAG raiz(<LISTADADOS>) no arquivo. O arquivo sera desconsiderado. | CH17950 |
