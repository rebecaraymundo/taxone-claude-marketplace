...
| --- | --- | --- |
| MFS-2552 | EFD Fiscal Tipo de Item X Indicador Produto | Criação de tela Tipo de Item X Indicador de Produto |
| MFS-5400 | EFD Fiscal Tipo de Item X Indicador Produto | Replicar parametrização para EFD- Contribuições |
