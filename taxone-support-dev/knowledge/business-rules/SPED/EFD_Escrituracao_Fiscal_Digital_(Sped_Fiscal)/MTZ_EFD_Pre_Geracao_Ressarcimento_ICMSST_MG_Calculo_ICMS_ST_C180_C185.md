...
__  \[MFS47958\]__
  ...
  Se o campo “__%Redução BC__” da parametrização de Produto ou NCM está preenchido com valor > 0, então:
      ...
      \* Aliquota / 100\] / quantidade do item
...
O preenchimento do campo seria:
 ...
 \(Valor do ICMS\-ST \+ Valor do FECEP\-ST \+ VLR\_FECP\_FONTE\) / QTD\_CONV
...
Se o item de mercadoria foi recuperado das tabelas “normais” \(X07/X08\), então:
      ...
      Se o campo “Vlrs de FECEP estão embutidos nos vlrs de ICMS/ICMS\-ST nos itens \(SAFX08\)” foi marcado, então:
             ...
             Se for considerado o “52\-Valor ICMS Substituição Tributária” p/ 

             __Valor do ICMS\-ST__ \(\*\):

    Preencher com: \(Valor do ICMS\-ST \+ Valor do FECEP Regime Fonte\) / QTD\_CONV 

Senão:

                  Preencher com:

                    \(Valor do ICMS\-ST \+ Valor do FECEP\-ST \+ Valor do FECEP Regime Fonte\) / QTD\_CONV
...
Se o item de mercadoria foi recuperado das tabelas “normais” \(X07/X08\) ou DATAMART, então:
      ...
      Se o campo “Vlrs de FECEP estão embutidos nos vlrs de ICMS\-ST não destacado/não escriturado” foi marcado, então:
           ...
           Se for considerado o “145\- VLR\_ICMSS\_N\_ESCRIT” ou “133\- 

                VLR\_ICMSS\_NDESTAC” p/ __Valor do ICMS\-ST__ \(\*\):
  ...
  Preencher com: \(Valor do ICMS\-ST \+ Valor do FECEP Regime Fonte\) / QTD\_CONV 
      ...
      Se o campo ““145\- VLR\_ICMSS\_N\_ESCRIT” ou “133\- VLR\_ICMSS\_NDESTAC” nos itens \(SAFX08\)” não foi marcado, então:
...
Considerar o resultado da expressão: \(Campo 140 \-VLR\_FECP\_ICMS\_ST \+ Campo 141 \- VLR\_FECP\_FONTE\) do item de entrada recuperado / QTD\_CONV \(calculado na RP01\) 
...
__               Obs\.:  __Se o resultado da diferença entre os dois campos der um valor negativo, preencher com zero\.
...
__Relatório de Conferência do Registro C185:__

\[MFS511653\]: Criação do Relatório de Conferência do C185:

Caso o parâmetro “Gerar Relatórios de Conferência” da tela de pré\-geração seja marcado, disponibilizar um arquivo Excel com as notas de saída consideradas para o registro C185\.
