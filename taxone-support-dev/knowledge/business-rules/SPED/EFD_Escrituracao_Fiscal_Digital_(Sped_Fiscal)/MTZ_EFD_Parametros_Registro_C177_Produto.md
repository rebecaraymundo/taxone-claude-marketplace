# MTZ_EFD_Parametros_Registro_C177_Produto

- **Fonte:** MTZ_EFD_Parametros_Registro_C177_Produto.docx
...
__Localização__: Menu Sped, Módulo: Escrituração Fiscal Digital, item Parâmetros 🡪 Registro C177 – Comércio Atacadista 🡪 Produto
...
Criação da parametrização de Produto para geração dos dados do registro C177 – Comércio Atacadista\.
...
Registro 1 🡪  Código inicial = 1000500 e Código final = 1000599

Registro 2 🡪  Código inicial = 1000600 <a id="_Hlk119062073"></a>e Código final = 1000699

Registro a ser incluído 🡪  Código inicial = 1000540 e Código final = 1000545
...
Registro 2 🡪  Código inicial = 1000600 e Código final = 1000900

Registro a ser incluído 🡪  Código inicial = 1000000 e Código final = 1000800

Neste exemplo, também teríamos erro na parametrização, pois a faixa do registro a ser importado engloba toda faixa do registro 1, além disso, se intercala com a faixa do registro 2\.
