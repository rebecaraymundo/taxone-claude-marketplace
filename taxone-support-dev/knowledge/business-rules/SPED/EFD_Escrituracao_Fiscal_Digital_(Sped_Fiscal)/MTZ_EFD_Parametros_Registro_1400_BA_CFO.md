...
__Localização__: Menu Sped, Módulo: Escrituração Fiscal Digital, item menu Parâmetros à Registro 1400  à Específico por UF à BA – CFOPs \(Compras, Vendas e Devoluções\)
...
Criação da parametrização de CFOP’s para a pré\-geração do registro 1400 – DMA BA
