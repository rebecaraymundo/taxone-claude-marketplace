...
__Parametrização de Produtos para o código 12 da DIPAM\-B \(Registro 1400 p/ SP\)__
...
Criação da parametrização de produto específica para o código 12 da DIPAM\-B, para tratar a situação das notas fiscais escrituradas geradas neste registro
