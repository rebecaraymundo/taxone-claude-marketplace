# SPED_Fiscal_Regras_BlocoG_OutrasOrigens_PIM

> Fonte: SPED_Fiscal_Regras_BlocoG_OutrasOrigens_PIM.doc
...
Data	OS / Chamado	Descrição 	Responsável		11/02/2011	OS3114-A2	Criação do documento contendo as regras para a geração do Bloco G do SPED Fiscal por Inscrição Estadual a partir das tabelas SAFX133, SAFX134, SAFX135 e SAFX136.	Natália Resino		06/02/2023	MFS435439	Inclusão de tratamento do campo de DT_FIN, para considerar o novo campo de DAT_ENCERRAMENTO da tabela de Inscrição Estadual para os clientes que encerrarem a Inscrição Estadual. G110.	Rogério Ohashi		


Bloco G – Controle do Crédito de ICMS do Ativo Permanente – CIAP

RN00	Os dados deste registro não serão gerados com base nos valores calculados pelo módulo Ativo Permanente. Essas informações serão recuperadas a partir das seguintes tabelas SAFX (tabelas criadas através da OS2931-B4):
...
RNG110	Deverá ser gerado apenas 1 registro G110 por período de apuração, ou seja, no arquivo.

Devem ser recuperadas as informações da tabela SAFX133 para a empresa, estabelecimento, inscrição estadual e período informado.		RNG110-01	Campo REG
...
Devem ser recuperados as informações da tabela SAFX134 para a empresa, estabelecimento, inscrição estadual e período informados.		RNG125-01	Campo REG
...
Devem ser recuperados as informações da tabela SAFX136 para a empresa, estabelecimento, inscrição estadual e período informados.		RNG126-01	Campo REG
...
Devem ser recuperados as informações da tabela SAFX135 para a empresa, estabelecimento, inscrição estadual e período informados.		RNG130-01	Campo REG
...
Gravar no campo 03 – COD_PART a informação que estiver contida nos campos “Indicador de Pessoa” e “Código da Pessoa Física/Jurídica” da tabela SAFX135.  A informação deve ser gravada de forma concatenada, separada pelo caracter “-“.		RNG130-04	Campo COD_MOD
...
Gravar no campo 08 – DT_DOC a informação que estiver contida no campo “Data da emissão do documento fiscal” da tabela SAFX135.		
...
Devem ser recuperados as informações da tabela SAFX135 para a empresa, estabelecimento, inscrição estadual e período informados. Vale salientar que embora os registros G130 e G140 sejam separados, as informações pertencem à mesma tabela – SAFX135.		RNG140-01	Campo REG
...
Para cada item informado nesse campo deverá ser gerado um registro do tipo 0200 com as informações cadastrais do mesmo. As regras são as mesmas existentes no documento “Sped_Fiscal_Regras.doc”.