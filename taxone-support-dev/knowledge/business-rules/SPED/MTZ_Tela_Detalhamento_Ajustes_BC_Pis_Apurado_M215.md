# MTZ_Tela_Detalhamento_Ajustes_BC_Pis_Apurado_M215

> Fonte: MTZ_Tela_Detalhamento_Ajustes_BC_Pis_Apurado_M215.docx
...
Matriz da tela Detalhamento dos Ajustes da BC do Pis/Pasep Apurada - M215
...
Deverá ser criada a tela “Detalhamento dos Ajustes da BC do Pis/Pasep Apurada - M215” para que seja possível realizar a geração do registro M215 da EFD- Financeira.

Esta tela será acessada através de nova aba inserida na tela de Apuração PIS/PASEP. Estará em um nível abaixo do nível das abas de Detalhamento por Código de Receita – M205 e Detalhamento da Contribuição – M210. Na estrutura dos registros da EFD- Financeira este é um registro filho do M210 – Detalhamento da Contribuição para o PIS/Pasep do Período.
...
| --- | --- | --- |
| MFS25094 | Andréa Rocha | Criação da tela de Detalhamento dos Ajustes da Base de Cálculo do PIS/Pasep Apurada - M215. |
