# MTZ_EFD_Parametros_Registro_1400_EspecificoUF_CFOP

> Fonte: MTZ_EFD_Parametros_Registro_1400_EspecificoUF_CFOP.docx
...
Parametrização de CFOP p/ Geração do Registro 1400
(a partir das regras específicas de cada UF)


Localização: Módulo EFD - Escrituração Fiscal DigitaI, item Parâmetros  Registro 1400  Específico por UF  CFOP
...
Na MFS59468 (Fev/2021) foi incluído a operação PEIPMS0 para PE.

Na MFS61948 (Mar/2021) foram incluídos as operações BAE07, BAE13 e BAE14 para BA.

Na MFS61950 (Abr/2021) foram incluídos as operações BAE05 e BAS05.

Na MFS61951 (Abr/2021) foram incluídos as operações BAE06 e BAS06.
...
Na MFS68577 (Julho/2021) foi incluída a operação BAE20 para BA.

Na MFS43147 (Agosto/2021) foi incluída a operação ACIPMS04 para AC.

Na MFS35318 (Agosto/2021) foi incluída a operação TOIPMS10 para TO.

Na MFS59472 (Agosto/2021) foi incluída a operação PEIPMS3 para PE.

Na MFS35221 (Setembro/2021) foram incluídas as operações RJVAF20002 e RJVAF20003 para RJ.
...
Estabelecimento  Este campo é uma lista dos estabelecimentos da empresa do login para seleção do usuário. Quando for informado um estabelecimento no login, o campo mostrará fixo este estabelecimento, e usuário não poderá alterá-lo.
...
(*) Conforme descrito na RN03 a lista de CFOP’s a serem disponibilizados para seleção, depende do tipo de operação.
...
CFOP’s  Neste campo será demonstrada a lista dos cfop’s que poderão ser selecionados pelo usuário.
...
Forma de Cálculo  Este campo é uma lista fixa de opções, utilizado apenas nas operações “SPDIPAM22” e “SPDIPAM31”:
...
“Para utilizar o código 22 ou 31 da DIPAM-B a forma de cálculo deverá ser parametrizada para cada CFOP”
...
| OS/CH | OS/CH | Nome | Descrição | Data | Data |
| --- | --- | --- | --- | --- | --- |
| OSs4728 OSs4735 | OSs4728 OSs4735 | Atendimento:  Resolução 4.730, de 17/12/14, SEF-MG Portaria CAT 137, de Dez/2014, Sefaz-SP | Criação de parametrização de CFOP’s para geração do registro 1400 de acordo com as regras específicas dos estados de MG e SP. | 04/02/2015 (criação do docto) | 04/02/2015 (criação do docto) |
| MFS1513 | MFS1513 | Portaria N. 34-R, Sefaz-ES | Inclusão dos códigos 01, 02 e 03 para o estado do ES (ver RN02 e RN03) | 08/09/20915 | 08/09/20915 |
| MFS3132 | MFS3132 | Orientação Técnica EFD nº 011/2016 – Versão 1.10 | Inclusão dos códigos 3.1, 3.2 e 3.3 para o estado do RN (ver RN02 e RN03) | 16/02/2016 | 16/02/2016 |
| MFS3248 | MFS3248 | Orientação Técnica EFD nº 011/2016 – Versão 1.10 | Inclusão dos códigos anuais para o estado do RN (ver RN02 e RN03) | 11/11/2016 | 11/11/2016 |
| MFS8625 | MFS8625 | Alteração do 1400 p/o RS | Inclusão dos códigos da tabela do RS (ver RN02 e RN03) | 16/12/2016 | 16/12/2016 |
| MFS16364 | MFS16364 | Convênio ICMS 52/05 | Habilitar todas as operações para o estabelecimento obrigado ao Convênio ICMS 52/2005 (Ver RN02). | 23/02/2018 | 23/02/2018 |
| MFS16811 | MFS16811 | Alteração do 1400 p/a BA | Inclusão de códigos para o estado da BA (ver RN02 e RN03). | 07/03/2018 | 07/03/2018 |
| MFS17764 | MFS17764 | Alteração do 1400 p/o TO | Inclusão de códigos para o estado de TO (ver RN02 e RN03). | 25/04/2018 | 25/04/2018 |
| MFS20147 | MFS20147 | Alteração do 1400 p/o RS | Inclusão de código para o estado do RS (ver RN02 e RN03). | 13/08/2018 | 13/08/2018 |
| MFS30891 | MFS30891 | Inclusão da observação | Inclusão da observação para o campo Operação. | 09/10/2019 | 09/10/2019 |
| MFS31044 | MFS31044 | Alteração do 1400 p/o TO | Inclusão de um código para o estado de TO (ver RN02 e RN03). | 29/10/2019 | 29/10/2019 |
| MFS35133 | MFS35133 | Inclusão de códigos | Inclusão dos códigos TOIPME05 e TOIPMS05 para o estado do Tocantis | 22/06/2020 | 22/06/2020 |
| MFS42617 | MFS42617 | Alteração do 1400 p/ SP | Inclusão de uma coluna nova para o código 12 da DIPAM-B | 04/09/2020 | 04/09/2020 |
| MFS59468 | MFS59468 | Inclusão de código | Inclusão do código PEIPMS0 para o estado de Pernambuco. | 08/02/2021 | 08/02/2021 |
| MFS61948 | MFS61948 | Inclusão de códigos | Inclusão dos códigos BAE07, BAE13 e BAE14 para o estado da Bahia. | 19/03/2021 | 19/03/2021 |
| MFS61950 | MFS61950 | Inclusão de códigos | Inclusão dos códigos BAE05 e BAS05 para o estado da Bahia. | 01/04/2021 | 01/04/2021 |
| MFS61951 | MFS61951 | Inclusao de códigos | Inclusão do código BAE06 e BAS06 para o estado da Bahia. | 07/04/2021 | 07/04/2021 |
| MFS64052 | MFS64052 | Inclusão de código | Inclusão do código IPM 3.5 para o estado do Rio Grande do Norte. | 28/04/2021 | 28/04/2021 |
| MFS64779 | MFS64779 | Inclusão de código | Inclusão do código PEIPMS4 para o estado de Pernambuco | 21/05/2021 | 21/05/2021 |
| MFS67705 | MFS67705 | Inclusão de código | Inclusão do código PEIPME3 para o estado de Pernambuco | 29/06/2021 | 29/06/2021 |
| MFS68577 | MFS68577 | Inclusão de código | Inclusão do código BAE20 para o estado da Bahia. | 08/07/2021 | 08/07/2021 |
| MFS43147 | MFS43147 | Inclusão de código | Inclusão do código ACIPMS04 para o estado do Acre. | 10/08/2021 | 10/08/2021 |
| MFS35318 | MFS35318 | Inclusão de código | Inclusão do código TOIPMS10 para o estado de Tocantis. | 18/08/2021 | 18/08/2021 |
| MFS59472 | MFS59472 | Inclusão de código | Inclusão do código PEIPMS3 para o estado de Pernambuco | 23/08/2021 | 23/08/2021 |
| MFS40285 | MFS40285 | Inclusão de código | Inclusão do código 06 para o estado de Santa Catarina. | 02/09/2021 | 02/09/2021 |
| MFS35221 | MFS35221 | Inclusão de código | Inclusão dos códigos RJVAF20002 e RJVAF20003 para o estado do Rio de Janeiro. | 22/09/2021 | 22/09/2021 |
| MFS47088 | MFS47088 | Inclusão de códigos | Inclusão dos códigos MAVAF005, MAVAF006 e MAVAF007 para o estado de Maranhão. | 15/10/2021 | 15/10/2021 |
| MFS86117 | MFS86117 | Inclusão de códigos | Inclusão dos códigos RJVAF00006 e RJVAF10006 para o estado do Rio de Janeiro. | 27/05/2022 | 27/05/2022 |
| MFS86203 | MFS86203 | Inclusão de código | Inclusão do código IPM 3.6 para o estado do Rio Grande do Norte. | 06/06/2022 | 06/06/2022 |
| MFS94497 | MFS94497 | Inclusão de código | Inclusão do código 1201 para o estado de Alagoas. | 20/10/2022 | 20/10/2022 |
| MFS402300 | MFS402300 | Inclusão de códigos | Inclusão dos códigos BAE80 e BAS80 para o estado da Bahia | 08/03/2023 | 08/03/2023 |
| MFS402301 | MFS402301 | Inclusão de códigos | Inclusão dos códigos BAE81 e BAS81 para o estado da Bahia | 16/03/2023 | 16/03/2023 |
| MFS547634 | MFS547634 | Inclusão de código | Inclusão dos códigos RJVAF00005 e RJVAF10005 para o estado do Rio de Janeiro | 21/07/2023 | 21/07/2023 |
| MFS556958 | MFS556958 | Inclusão de código | Inclusão dos códigos RJVAF00009 e RJVAF10009 para o estado do Rio de Janeiro | 07/08/2023 | 07/08/2023 |
| MFS551008 | MFS551008 | Inclusão de código | Inclusão dos códigos RJVAF00007 e RJVAF10007 para o estado do Rio de Janeiro | 13/09/2023 | 13/09/2023 |
| MFS663539 | MFS663539 | Inclusão de códigos | Inclusão de códigos BAE21... BAE24, BAS21...BAS24 | 30/07/2024 | 30/07/2024 |
| MFS672643 | MFS672643 | Inclusão de códigos | Inclusão do código Outras Entradas a Detalhar por Municipio (especifico para 3.6.14) | 17/01/2025 | 17/01/2025 |
|  |  |  |  |  |  |
|  |  |  |  |  |  |
| RN00 | Regras Gerais | Regras Gerais | Regras Gerais | Regras Gerais |
...
| Códigos do RS: | 05-Vendas fora do Estabelecimento |
| Códigos da BA: | BAE01 |
| Códigos da BA: | BAS01 |
| Códigos da BA: | BAE02 |
| Códigos da BA: | BAS02 |
...
| Códigos de SC: | 06 |
| Códigos de RJ: | RJVAF20002 |
| Códigos de RJ: | RJVAF20003 |
| Códigos de RJ: | RJVAF00006 |
| Códigos de RJ: | RJVAF10006 |
| Códigos de RJ: | RJVAF00005 |
| Códigos de RJ: | RJVAF10005 |
| Códigos de RJ: | RJVAF00007 |
| Códigos de RJ: | RJVAF10007 |
| Códigos de RJ: | RJVAF00009 |
| Códigos de RJ: | RJVAF10009 |
...
| BA | BAE13 | Apenas os CFOP’s de entrada |
| BA | BAE14 | Apenas os CFOP’s de entrada |
...
| RN06 | Campo Replicar para os estabelecimentos: |
| --- | --- |
