...
Alteração da regra do registro C100 para considerar o novo parâmetro “Considerar Notas Fiscais de Entradas Canceladas – Modelo 55”\.
...
Alteração da regra do registro C100 para utilizar o novo parâmetro “Considerar Notas Fiscais de Saídas Canceladas – Modelo 65” para considerar na geração, se marcado, as Notas Fiscais canceladas de Saídas \(Modelo 65\)
...
__\[ALTERAÇÃO\-MFS767289\] __Tratamento na regra para considerar o novo parâmetro ‘__*Considerar Notas Fiscais de Entradas Canceladas – Modelo 55\.*__

 

- Quando se tratar de NF Cancelada \(campo “30 – Situação da nota = “S”\) e
	- __Parâmetro Marcado:__ Se o parâmetro na tela de Dados Iniciais “__*Considerar Notas Fiscais de Entradas Canceladas – Modelos 55”*__, estiver __*marcado*__ o sistema deverá considerar na geração as Notas Fiscais de entrada canceladas \(Modelo 55\), conforme regra atual\. 
	- __Parâmetro Desmarcado:__ Se o parâmetro na tela de Dados Iniciais “__*Considerar Notas Fiscais de Entradas Canceladas – Modelo 55”*__, estiver __*desmarcado*__, o sistema deverá:
- Quando se tratar de Notas Fiscais Eletrônicas de Entrada Canceladas \(modelo 55\), \(Campo 30 – Situação da Nota = “S”\) estas notas não deverão ser geradas no arquivo\.
- Não deverão ser informados registros filhos\.

__ Atenção\!\!\! __Para a correta identificação do modelo do documento deve considerar a seguinte regra \(já implementada no parâmetro de saída\):

- Se o campo 229 \- COD\_MODELO\_COTEPE da SAFX07 não estiver preenchido, considerar a informação do campo 13\-COD\_MODELO da SAFX07\. Caso os campos 13 e 229 estiverem preenchidos, considerar o campo 229 – COD\_MODELO\_COTEPE
...
\[__ALTERAÇÃO\- MFS82775/MFS\-896759\] \-__ Tratamento na regra para considerar o novo parâmetro ‘__*Considerar Notas Fiscais de Saídas Canceladas – Modelos 55 e 65*__’\.

\[__ALTERAÇÃO\- MFS84537__\] Inclusão do Campo de “CHV\_NFE” para as __*Notas Fiscais de Saídas Canceladas – Modelo 55*__’\.

__Parâmetro Desmarcado:__ Se o parâmetro na tela de Dados Iniciais “__*Considerar Notas Fiscais de Saídas Canceladas – Modelos 55 e 65*__”, estiver __*desmarcado*__, o sistema deverá seguir conforme a regra original:

- Quando se tratar de Notas Fiscais Eletrônicas \(modelos 55 e 65\) Canceladas \(Campo 30 – Situação da Nota = “S”\) estas não deverão ser geradas no arquivo\.
- Não deverão ser informados registros filhos\. 

__Parâmetro Marcado:__ Se o parâmetro na tela de Dados Iniciais “__*Considerar Notas Fiscais de Saídas Canceladas – Modelos 55 e 65*__”, estiver __*marcado*__ o sistema deverá considerar na geração as Notas Fiscais \(Modelos 55 e 65\), seguindo a regra abaixo:
