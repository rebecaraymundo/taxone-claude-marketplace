# RNG-Segmento_Utilities_V31

- **Fonte:** RNG-Segmento_Utilities_V31.docx
- **Modificado:** 2024-02-19
- **Tamanho:** 86 KB

---

# EFD \- PIS/PASEP – SEGMENTO UTILITIES – V31
...
__Registro C500 – Nota Fiscal/Conta de Energia Elétrica \(Código 06\), Nota Fiscal de Energia Elétrica Eletrônica – NF3e \(Código 66\), Nota Fiscal/Conta de Fornecimento D’água Canalizada \(Código 29\), Nota Fiscal/Consumo ornecimento de Gás \(Código 28\) e NF\-e \(Código 55\) – Documentos de Entrada / Aquisição com Crédito__
...
__Registro D500 \- NF DE COMUNICAÇÃO \(CÓDIGO 21\), NOTA FISCAL DE SERVIÇO DE TELECOMUNICAÇÃO \(CÓDIGO 22\) – AQUISIÇÃO COM DIREITO A CRÉDITO__
...
__                     Registro D600 – Consolidação Prestação de Serviços \- Comunicação e Telecomunicação \(Códigos 21 e 22\)__
...
__                     Registro D601 \- Complemento da Operação \(Códigos 21 e 22\) – PIS/PASEP__
...
__                     Registro D605 \- Complemento da Operação \(Códigos 21 e 22\) – COFINS__
