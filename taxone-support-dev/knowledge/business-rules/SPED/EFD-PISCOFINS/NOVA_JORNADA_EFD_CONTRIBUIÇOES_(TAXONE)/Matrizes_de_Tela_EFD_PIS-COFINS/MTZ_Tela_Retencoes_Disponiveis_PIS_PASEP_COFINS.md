# MTZ_Tela_Retencoes_Disponiveis_PIS_PASEP_COFINS

- **Fonte:** MTZ_Tela_Retencoes_Disponiveis_PIS_PASEP_COFINS.docx
...
__Localização da tela:__ 
	...
	Menu: Obrigação >> Manutenção >> Controle das Retenções na Fonte – PIS/PASEP

e

Menu: Obrigação >> Manutenção >> Controle das Retenções na Fonte –COFINS
