...
Alteração na tela Créditos a Utilizar na Apuração – PIS/PASEP

Incluir na tela Créditos a Utilizar na Apuração \(PIS/PASEP\) o critério de pesquisa Código do Tipo de Crédito\.
...
Tratamento para os créditos prescritos com mais de 5 anos\.
...
O campo ‘’Valor Limite da Contribuição Não Cumulativa a Descontar’’ é apenas informativo, devendo apresentar o Valor da Contribuição Não Cumulativa a Recolher/Pagar \(campo5\) do registro M200 que foi gerado através da funcionalidade Geração dos Registros\. 
...
Permitir alterar os valores dos campos descritos abaixo, até zerar o valor informado no campo ‘’Valor Limite da Contribuição Não Cumulativa a Descontar’’\.
...
__RN07__
 ...
 Permitir alterar os valores dos campos descritos abaixo, até zerar o valor informado no campo ‘‘Crédito Disponível’’, correspondente a cada registro\.
