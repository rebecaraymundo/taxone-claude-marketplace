# MTZ_Tela_Apuracao_COFINS_SCP

- **Fonte:** MTZ_Tela_Apuracao_COFINS_SCP.docx
...
Matriz da tela Apuração COFINS \- menu SCP
...
__Localização da tela:__ 
	...
	Esta tela deverá ser uma replica da tela de Apuração COFINS disponível no menu Obrigações >> Manutenção >> Apuração COFINS, contemplando a inclusão do campo Código da SCP que servirá para detalhar a qual SCP se refere a apuração\.
