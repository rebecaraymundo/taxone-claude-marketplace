# MTZ_Upload_Validacoes

- **Fonte:** MTZ_Upload_Validacoes.docx
- **Modificado:** 2020-03-11
- **Tamanho:** 36 KB

---

<a id="OLE_LINK3"></a><a id="OLE_LINK4"></a>Funcionalidade Upload –<a id="OLE_LINK1"></a><a id="OLE_LINK2"></a> Validações
...
Criação de nova mensagem de log, se não for encontrado no XML lido a TAG <LISTADADOS>
...
Se não for encontrado no XML lido a TAG <LISTADADOS> , exibir a seguinte msg no log:

Atencao nao foi encontrada TAG raiz\(<LISTADADOS>\) no arquivo\. O arquivo sera desconsiderado\.
