...
Localização: Menu SPED, Módulo: EFD – REINF / Validação de Retenções Previdenciárias à Formato_XLS
...
Regra de apresentação de serviços/repasse parametrizados em múltiplos estabelecimentos:
...
Identi ficação do Tipo de Serviço ou Identificação do Tipo de Repasse + Alíquota (o campo Alíquota não deve ser totalizado);
...
| --- | --- | --- |
| MFS901529 | Rogério Ohashi | Criação Relatório de Validação de Retenções Previdenciárias em Formato XLS |
|  |  |  |
...
| Filial | Texto |  | Código e a razão social do estabelecimento em questão (estabelecimento informado em tela). | MFS7084 |
