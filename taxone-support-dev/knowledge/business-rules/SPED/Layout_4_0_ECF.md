...
Perfil (ajuste planilha Layout_ECF.xlsx)
...
Comparação das tabelas dinâmicas com base na versão do PVA 4.0.1 ( 993 itens alterados, 537 itens excluídos e 1663 incluídos)
Comparação do Plano Referencial - L100 alteração da conta superior, L300B e U150B a conta era Analítica e mudou para Sintética.
...
- Inclusão de opção  0004 no campo 3 - COD_VER – Código da versão do layout.
...
- X300
Alteração da lista de opções. Campo TIP_MET até 3.0 PVA e na 4.0 PGE
...
- Y600
Inclusão da opção 14 na validação país <> 105, se ind_qualif_socio = PF
...
Atenção: Foi identificado no processe de atualização de escrituração, quando não existia mapeamento de tabela dinâmica na base, mas havia ajuste manual de valores, esses ajustes não eram copiados para a nova escrituração. Este ponto está sendo revisto no OneSource.

| Data | MFS | Descrição | Autor |
| --- | --- | --- | --- |
| 26/02/2018 | MFS-16828 | Criação do documento | Alessandra Cristina Navatta |
...
| [X300] | TIP_MET | [PVE; PVA; PVV; CAP; PECEx] |
| --- | --- | --- |
|  |  |  |


| [X300] | TIP_MET | [PVE; PGE; PVV; CAP; PECEx] |
| --- | --- | --- |
|  |  |  |
