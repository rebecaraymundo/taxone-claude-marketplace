# MTZ_Tela_Detalhamento_Ajustes_BC_COFINS_Apurado_M615_SCP

> Fonte: MTZ_Tela_Detalhamento_Ajustes_BC_COFINS_Apurado_M615_SCP.docx
...
Deverá ser criada a tela “Detalhamento dos Ajustes da BC da COFINS Apurada – M615” para que seja possível realizar a geração do registro M615 da EFD-Contribuições.

Esta tela será acessada através de nova aba inserida na tela de Apuração COFINS. Estará em um nível abaixo do nível das abas de Detalhamento por Código de Receita (Visão Débito DCTF) – M605 e Detalhamento da Contribuição – M610. Na estrutura dos registros da EFD-Contribuições este é um registro filho do M610 – Detalhamento da Contribuição para a Seguridade Social - Cofins do Período.
...
| --- | --- | --- |
| MFS-20225 | Julyana Perrucini | Criação da tela de Detalhamento dos Ajustes da Base de Cálculo da COFINS Apurada – M615. |
