# MTZ_ECD_Versao_Leiaute_900

> Fonte: MTZ_ECD_Versao_Leiaute_900.doc

THOMSON REUTERS

ECD

Atualização da Geração do Arquivo para atender ao Leiaute 9.00
...
CÓD	DESCRIÇÃO	OS/CH		RN0000-11	Registro 0000 – Campo 11 – IND_SIT_ESP
...
Importante: Deverá ser reposicionada a numeração dos campos posteriores.	MFS-8216		RN0000-19	Registro 0000 – Campo 19 – IDENT_MF
...
A partir da versão 8.00 do leiaute, este campo não deve ser mais gerado. Ele foi inserido no registro 0000 – campo 23 - COD_PLAN_REF	MFS8620
MFS10727
MFS17883
MFS32556		
...
Se a parametrização for encontrada, porém não existir nenhuma conta com saldo para o período, exibir a mensagem na aba de log: A demonstração de Balanço Patrimonial não será gerada, pois não foi encontrado saldos contábeis para o período. Estabelecimento: XXXX.
	MFS-31020		RNJ100-02	Registro J100 – Campo 02 – COD_AGL
...
MFS-31020
MFS-64717		RNJ100-09	Registro J100 – Campo 09 – IND_DC_CTA_INI (Moeda Corrente)
...
MFS-31020
MFS-64717		RNJ100-11	Registro J100 – Campo 11 – IND_DC_CTA_FIN (Moeda Corrente)
...
CÓD	DESCRIÇÃO	OS/CH		RNJ150-02	Registro J150 – Campo 02 – NU_ORDEM
...
Considerar a informação do campo VL_CTA_INI da demonstração de DRE recuperada gerado na tela de geração das demonstrações contábeis.	MFS-32557		RNJ150-09	Registro J150 – Campo 09 – IND_DC_CTA_INI
...
Considerar a informação do campo VL_CTA_FIN da demonstração de DRE recuperada gerado na tela de geração das demonstrações contábeis.	MFS-32557		RNJ150-11	Registro J150 – Campo 11 – IND_DC_CTA_FIN
...
[MFS-66158] Tratamento na geração dos Registros do Bloco K, não devem gerar as contas contábeis no Registro I050.
...
Obs.: As informações referentes as contas contábeis utilizadas nas escriturações contábeis consolidadas, devem ser informados no Registro K200.
	MFS-66158		RNK001	Registro K001 – Abertura do Bloco K
