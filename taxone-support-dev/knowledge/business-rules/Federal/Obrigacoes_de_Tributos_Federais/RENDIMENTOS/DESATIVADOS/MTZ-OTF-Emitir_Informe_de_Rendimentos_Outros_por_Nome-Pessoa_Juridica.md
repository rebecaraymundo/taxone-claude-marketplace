# MTZ-OTF-Emitir_Informe_de_Rendimentos_Outros_por_Nome-Pessoa_Juridica

- **Fonte:** MTZ-OTF-Emitir_Informe_de_Rendimentos_Outros_por_Nome-Pessoa_Juridica.docx
...
# Emissão de Informe de Rendimento Outros por Nome 
...
Obrigações de Tributos Federais – Gerar Informes de Rendimento Outros por CPF de acordo com a IN RFB nº 1\.215, de 15/12/2011 \(Rendimentos Recebidos Acumuladamente\) criados a partir da DIRF 2012
...
Imprimir o tipo de logradouro no campo 01 Fonte Pagadora do informe de rendimentos pagos a pessoa jurídica

Imprimir no campo 01 do Informe de Rendimentos pagos a pessoa jurídica o tipo de logradouro\.
...
Os parâmetros de “Emissão por Pessoa” – Jurídica, Física e Ambas – da tela de Emissão do Informe de Rendimentos Outros por Nome deverá ser inibida, visto que nesse tipo de Informe, Pessoas Físicas não devem ser informadas já que existe o Informe de Rendimentos Outros por CPF e por Nome\.

__OS3579__

__RN02__

No campo 01\(Fonte Pagadora\) do Informe de Rendimentos pessoa jurídica deve ser impresso o Tipo de Logradouro \(ex: Avenida, Rua\.\.\) 
