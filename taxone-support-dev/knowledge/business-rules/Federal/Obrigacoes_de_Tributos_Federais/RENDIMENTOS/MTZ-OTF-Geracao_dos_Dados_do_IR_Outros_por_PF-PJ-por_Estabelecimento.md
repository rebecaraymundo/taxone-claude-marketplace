# MTZ-OTF-Geracao_dos_Dados_do_IR_Outros_por_PF-PJ-por_Estabelecimento

- **Fonte:** MTZ-OTF-Geracao_dos_Dados_do_IR_Outros_por_PF-PJ-por_Estabelecimento.docx
...
# Geração dos Dados do Informe de Rendimentos Outros por Pessoa Física/Jurídica – por Estabelecimento
...
Ao gerar o Informe de Rendimentos Outros por Estabelecimento, o sistema ao recuperar os registros de retenção do Controle de Tributos \(tabela: X53\_RETENCAO\_IRRF\), deve ignorar os registros estornados, ou seja, os registros cujo campo “Estorno” e “Data do Estorno” estejam preenchidos\.
