...
- **Fonte:** MTZ_OTF_DIRF-2019.docx
- **Modificado:** 2022-09-20
- **Tamanho:** 143 KB

---

# Obrigações de Tributos Federais \- DIRF 2019
...
Alteração na regra de geração da DIRF, onde deverá considerar rendimentos isentos para trabalhos sem vinculo empregatício, alugueis e royalties\. 
...
Inclusão de mensagem no log de geração DIRF referente o campo “Valor Pago a Advogado” e Geração do registro INFPA dentro da estrutura do RRA\.
...
Alterar na tela da ‘Geração DIRF ‘o valor default do campo “Ano Referência\-DIRF” de 2018 para 2019\. Esse campo poderá ser alterado\.

Na tela da ‘Geração DIRF’ quando o parâmetro ‘Extinção’ for selecionado, o default dos campos Ano\-Calendário e Ano Referência\-DIRF serão  2019 e  2019, caso contrário preencher com 2018, 2019 respectivamente\.
...
Alterar na tela da ‘Geração DIRF‘, o nome do parâmetro  IN 1\.587/2015 para IN 1\.671/2016\.

MFS\-21816

Na DIRF2019:O checkbox “<a id="_Hlk530646627"></a>Pagtos\. relacionados aos Jogos Olímpicos/Paraolímpicos de 2016”, deverá ficar desabilitado para seleção na tela quando o “Ano Referência DIRF” for maior ou igual a “2019”\. 
...
Incluir o parâmetro IN 1757/2017 com a opção: “<a id="_Hlk530648442"></a>Indicador de entidade em que a União detém maioria do capital a voto”\.

Incluir o parâmetro IN 1836/2017 com a opção: “Indicador de fundação pública de direito privado”, que será utilizado no preenchimento do __campo 12 do registro DECPJ__ \(vide RN394\)\. Este parâmetro é habilitado na tela de geração quando o “Ano Referência DIRF” for maior ou igual a “2019”\.
...
OBS: as regras contidas nesse documento devem ser referentes ao ano referência 2019\. Os outros ano\-referência devem ser gerados através dos outros layouts\.
...
Gravar no campo 3 – Ano\-calendário a informação do campo “Ano\-Calendário” da tela de geração da DIRF \(módulo: Obrigações de Tributos Federais, menu DIRF >> Geração DIRF\)\. Para tanto a informação deve estar preenchida com as opções 2018 e 2019\. 
...
Gravar no campo 6 – Identificador de Estrutura do leiaute o valor fixo T17BS45 Q84FV63
...
Gravar no campo 3 – Nome empresarial a informação que estiver contida no campo RAZAO\_SOCIAL ou no campo RAZAO\_SOCIAL\_COMPL da tabela ESTABELECIMENTO de acordo com o\(s\) estabelecimento\(s\) selecionado\(s\) para a geração\.
...
Na DIRF2019: Gravar no campo 11 – O “indicador de entidade em que a União detém maioria do capital a voto”\. Vide parâmetro criado na tela \(RN01\)\.
...
Caso o campo esteja marcado, gravar “S” \- significa que existe pagamento de valores a entidades imunes/isentas\.

Caso o campo esteja desmarcado, gravar “N” \- significa que não é uma declaração de situação especial\.
...
Na DIRF 2019: Gravar no campo 12: “Indicador de fundação pública de direito privado”\. 
...
Caso o campo esteja marcado, gravar “S” – Fundação pública de direito privado\.

Caso o campo esteja desmarcado, gravar “N”\- Não é fundação pública de direito privado\.
...
Gravar no campo 13 – Indicador de situação especial da declaração a informação do campo “Extinção” da tela de geração da DIRF – menu: DIRF >> Geração DIRF do módulo Obrigações de Tributos Federais\.
...
Gravar no campo 14 – Data do evento a informação do campo “Data do evento” da tela de geração da DIRF – menu: DIRF >> Geração DIRF do módulo Obrigações de Tributos Federais\. A informação deve ser gravada no formato AAAAMMDD\.

Obs: Obrigatório se o campo de ordem 13 igual a “S”
...
Gravar no campo 5 – Indicador de Identificação do alimentando\.

__\[ALTERADA \- CH1608\_2018 \(MFS\-16323\)\]__

Esse campo é de preenchimento obrigatório na geração do arquivo magnético e deverá ser igual a “S” quando houver registro INFPA e RTPA, caso contrário gerar “N” e apresentar apenas os registros de valores RTPA e/ou ESPA\.
...
Gravar no campo 6 – Indicador de Identificação da previdência complementar

Esse campo é de preenchimento obrigatório na geração do arquivo magnético\. 

Verificar se para o beneficiário em \(Bascios >> Mastersaf DW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Plano Previdência\) SAFX207 possui valor da verba cadastrado para o COD\_FUNC  \- Campo 03  para o respectivo ano calendário da geração da DIRF\.

Caso possua valor da verba, marcar esse campo como “S” , deverá constar o registro INFPC seguido do registro de valor \(RTPP, RTFA, RTSP e/ou ESPP, ESFA, ESSP\) para cada entidade de previdência complementar do beneficiário\.

Senão, gerar como “N”, não apresentar o registro INFPC, deverão constar apenas os registros de valores \(RTPP, RTFA, RTSP e/ou ESPP, ESPA, ESSP\)\.
...
Gravar no campo 1 – Identificador do Registro o valor fixo “INFPC”\.
...
Gravar no campo 1 – Identificador do Registro o valor fixo “INFPA”\.
...
Deve estar associado ao registro do tipo BPFDEC e BPFRRA\.
...
- Gravar o valor fixo “RTFA” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)” e no \(campo 11 da SAFX207\) no módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(FAPI\)\.
- Gravar o valor fixo “RTSP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)” e no \(campo 11 da SAFX207\) no módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Fundo de Previdência do Servidor Público\)\.
- Gravar o valor fixo “RTEP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)” e no \(campo 11 da SAFX207\) no módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Contribuição do Ente Público Patrocinador\)\.
- Gravar o valor fixo “RTEP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)” e no \(campo 11 da SAFX207\) no módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Contribuição do Ente Público Patrocinador\)\.
- Gravar o valor fixo “ESPP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)”\. No \(campo 11 da SAFX207\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Previdência Privada\) e no \(campo 11 da SAFX21\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira com a opção \(Beneficiários com rendimento/imposto cuja tributação está sob exigibilidade suspensa\)\.
- Gravar o valor fixo “ESFA” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)”\. No \(campo 11 da SAFX207\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(FAPI\) e no \(campo 11 da SAFX21\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira com a opção \(Beneficiários com rendimento/imposto cuja tributação está sob exigibilidade suspensa\)\.
- Gravar o valor fixo “ESSP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)”\. No \(campo 11 da SAFX207\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Fundo de Previdência do Servidor Público\) e no \(campo 11 da SAFX21\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira com a opção \(Beneficiários com rendimento/imposto cuja tributação está sob exigibilidade suspensa\)\.
- Gravar o valor fixo “ESEP” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Previdência Complementar\)”\. No \(campo 11 da SAFX207\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira Segregada por Previdência com a opção \(Contribuição do Ente Público Patrocinador\) e no \(campo 11 da SAFX21\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira com a opção \(Beneficiários com rendimento/imposto cuja tributação está sob exigibilidade suspensa\)\.
...
- Gravar o valor fixo “ESPA” caso a Ficha Financeira \(tabela SAFX21\) do período informado para geração tenha na verba informada \(campo 07 da SAFX21\) o campo “Classe para DIRF” do menu Parâmetros >> Parâmetros para Verbas \(Folha de Pagamento\) do módulo Obrigações de Tributos Federais com a opção “Deduções \(Pensão Alimentícia\)” e no \(campo 11 da SAFX21\) módulo Básicos >> MastersafDW >> Manutenção >> Folha de Pagamento >> Ficha Financeira com a opção \(Beneficiários com rendimento/imposto cuja tributação está sob exigibilidade suspensa\)\.
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 2 – Janeiro o valor contido no campo 12 da SAFX207 para a competência de Janeiro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 2 – Janeiro o valor contido no campo 10 da SAFX212 para a competência de Janeiro \(ver campos 04 e 05 da SAFX212\)\. 

No caso da SAFX53/X530\_RETIFICACAO\_IRRF a informação deve ser recuperada da seguinte maneira:
...
- Para os registros RTPO, , RTDP e ver os seguintes campos da SAFX53 ou X530\_RETIFICACAO\_IRRF\.
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 3 – Fevereiro o valor contido no campo 12 da SAFX207 para a competência de Fevereiro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 3 – Fevereiro o valor contido no campo 10 da SAFX212 para a competência de Fevereiro \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 4 – Março o valor contido no campo 12 da SAFX207 para a competência de Março \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 4 – Março o valor contido no campo 10 da SAFX212 para a competência de Março \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 5 – Abril o valor contido no campo 12 da SAFX207 para a competência de Abril \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 5 – Abril o valor contido no campo 10 da SAFX212 para a competência de Abril \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 6 – Maio o valor contido no campo 12 da SAFX207 para a competência de Maio \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 6 – Maio o valor contido no campo 10 da SAFX212 para a competência de Maio \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 7 – Junho o valor contido no campo 12 da SAFX207 para a competência de Junho \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 7 – Junho o valor contido no campo 10 da SAFX212 para a competência de Junho \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 8 – Julho o valor contido no campo 12 da SAFX207 para a competência de Julho \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 8 – Julho o valor contido no campo 10 da SAFX212 para a competência de Julho \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 9 – Agosto o valor contido no campo 12 da SAFX207 para a competência de Agosto \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 9 – Agosto o valor contido no campo 10 da SAFX212 para a competência de Agosto \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 10 – Setembro o valor contido no campo 12 da SAFX207 para a competência de Setembro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 10 – Setembro o valor contido no campo 10 da SAFX212 para a competência de Setembro \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 11 – Outubro o valor contido no campo 12 da SAFX207 para a competência de Outubro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 11 – Outubro o valor contido no campo 10 da SAFX212 para a competência de Outubro \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 12 – Novembro o valor contido no campo 12 da SAFX207 para a competência de Novembro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 12 – Novembro o valor contido no campo 10 da SAFX212 para a competência de Novembro \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 13 – Dezembro o valor contido no campo 12 da SAFX207 para a competência de Dezembro \(ver campos 04 e 05 da SAFX207\)\. 
- Para os registros RTPA, ESPA gravar no campo 13 – Dezembro o valor contido no campo 10 da SAFX212 para a competência de Dezembro \(ver campos 04 e 05 da SAFX212\)\. 
...
- Para os registros RTPP, RTFA, RTSP, RTEP, ESPP, ESFA, ESSP, ESEP gravar no campo 14 – Décimo Terceiro o valor contido no campo 12 da SAFX207\. 
- Para os registros RTPA, ESPA gravar no campo 14 – Décimo Terceiro o valor contido no campo 10 da SAFX212\. Para identificar o Décimo Terceiro Salário, o campo “Indicador Folha” da SAFX21 deve estar preenchido com a opção “Pagamento de 13º\. Salário”\. 
...
Gravar no campo 1 – Identificador do registro o valor fixo “RTPSE”\.
...
Não foi identificada a ficha financeira com a respectiva verba de \(Plano Privado de Assistência a Saúde\) para o beneficiário \(Cód: xxx / Nome: xxxx / CPF: xxxxx\)\. Registros de Reembolso do Titular \(RTPSE\) não serão gerados, pois, não existem os registros \(PSE, OPSE e TPSE\) para serem associados\.
...
Gravar no campo 2 – O CPF/CNPJ do Prestador de Serviço da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Funcionário – SAFX208\)\. 

MFS8984

# RN367

Gravar no campo 3 – O Nome Empresarial do Prestador de Serviço da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Funcionário – SAFX208\)\.

MFS8984

# RN368

Gravar no campo 4 – O Valor do reembolso do ano\-calendário da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Funcionário – SAFX208\)\.

MFS8984

# RN369

Gravar no campo 5 – O Valor do reembolso de anos anteriores da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Funcionário – SAFX208\)\.
...
Gravar no campo 1 – Identificador do registro o valor fixo “RDTPSE”\.
...
Não foi identificada a ficha financeira segregada por dependente com a respectiva verba de \(Plano Privado de Assistência a Saúde\) para o Dependente \(Cód: xxx / Nome: xxxx / CPF: xxxxx\)\. Registros de Reembolso do dependete \(RDTPSE\) não serão gerados, pois, não existem os registros \(PSE, OPSE, TPSE e DTPSE\) para serem associados\.
...
Gravar no campo 2 – O CPF/CNPJ do Prestador de Serviço da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Dependente – SAFX209\)\.

MFS8984

# RN372

Gravar no campo 3 – O Nome Empresarial do Prestador de Serviço da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Dependente – SAFX209\)\.

MFS8984

# RN373

Gravar no campo 4 – O Valor do reembolso do ano\-calendário da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Dependente – SAFX209\)\.

MFS8984

# RN374

Gravar no campo 5 – O Valor do reembolso de anos anteriores da tela \(Módulo Básicos >> MastersafDW Menu Manutenção >> Folha de Pagamento >> Reembolso do Plano Privado de Saúde do Dependente – SAFX209\)\.
...
Deverá ser alterado na tela de Geração da DIRF, o campo “Valor Anual Mínimo de Rendimentos”, o valor default é 25\.661,70\., 28\.559,70
...
- SAFX53/X530\_RETIFICACAO\_IRRF
- Recuperar a informação de acordo com o campo 04 da SAFX53\. Com essa informação, verificar se existe informação no campo 55\- “DSC\_PROVINCIA\_EX” da SAFX04, em caso afirmativo o campo deve ser preenchido com ‘N’\.  
...
Alterar o valor default do campo “Ano Calendário” e “Ano Referência\-DIRF” para 2016 – 2017 respectivamente\. Esse campo poderá ser alterado\.
...
Caso houver beneficiários diferentes com mesmo numero de processo com valores distintos pagos a advogados deverá ser exibida a seguinte mensagem no log de geração da DIRF: “Existem valores diferentes pagos a advogado para o mesmo processo \( n° xxxxxx\)”\.
...
Gravar no campo 7 – Valor Pago para o Advogado, a  informação do campo “Valor Pago para Advogado”, da tela “Rendimentos Recebidos Acumuladamente”\.
...
Gravar no campo 6 – Indicador de Identificação do alimentando\.
...
Registro de Rendimentos Tribuáveis \- Dedução \- Pensão Alimentícia

Gravar no campo 1 – Identificador do Registro o valor fixo “RTPA”\.
...
Alterar o default do campo Ano Referencia\-DIRF para 2017 na tela de Formatação Mídia, localizada no Menu: DIRF / Geração do Meio Magnético / Ano Referência a partir de 2011
...
Regra para tela de Geração do Meio Magnético DIRF

As informações do campo “Responsável Legal” deverão ser listadas em ordem alfabética\.
