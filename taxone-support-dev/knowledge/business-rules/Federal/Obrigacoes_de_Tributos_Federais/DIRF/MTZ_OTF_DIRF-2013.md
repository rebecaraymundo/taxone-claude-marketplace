...
Alterar na tela da ‘Geração DIRF ‘o valor default do campo “Ano Referência\-DIRF” de “2012” para “2013”\. Esse campo poderá ser alterado\.

Na tela da ‘Geração DIRF’ quando o parâmetro ‘Extinção’ for selecionado, o default dos campos Ano\-Calendário e Ano Referência\-DIRF serão “2013” e ”2013”, caso contrário preencher com “2012”, “2013” respectivamente\.

OS3832

# RN01

Alterar na tela da ‘Geração DIRF ‘, o nome do parâmetro IN 1\.033/2010 para IN 1\.297/2012\.
...
OBS: as regras contidas nesse documento devem ser referentes ao ano referência “2013”\. Os outros ano\-referência devem ser gerados através dos outros layouts\.

OS3832

# RN05

Gravar no campo 3 – Ano\-calendário a informação do campo “Ano\-Calendário” da tela de geração da DIRF \(módulo: Obrigações de Tributos Federais, menu DIRF >> Geração DIRF\)\. Para tanto a informação deve estar preenchida com as opções “2012” ou “2013”\. 
...
Gravar no campo 6 – Identificador de Estrutura do leiaute o valor fixo “7C2DE7J”\.
...
A partir do ano de referencia 2013, o campo passa a ter 9 posições \(fixo\)\. Caso o campo num\_fax da tabela RESP\_INFORMACAO conter menos que 9 posições, completar com zeros a esquerda\.
...
Alterar o default do campo Ano Referencia\-DIRF para 2013 na tela de Formatação Mídia, localizada no Menu: DIRF / Geração do Meio Magnético / Ano Referência a partir de 2011

OS3832

# RN303

Este layout é valido, apenas quando o cliente informar na tela da Geração da DIRF, no campo Ano Referencia\-DIRF um ano a partir de 2013, caso contrário manter o layout compatível com os anos anteriores\.
