...
- **Fonte:** MTZ_OTF_DIRF-2017.docx
- **Modificado:** 2020-08-29
- **Tamanho:** 107 KB

---

# Obrigações de Tributos Federais \- DIRF 2017
...
Inclusão de mensagem no log de geração DIRF referente o campo “Valor Pago a Advogado”\.

CH2222\_2017

Inclusão de tratamento no campo 03 – Descrição dos rendimentos isentos – outros do Registro ‘RIO’

Este documento tem como objetivo ajustar a geração do campo 03 – Descrição dos rendimentos isentos – outros do Registro ‘RIO’, para quando houver mais de uma descrição seja separado com virgula \(,\)\.
...
Alterar na tela da ‘Geração DIRF ‘o valor default do campo “Ano Referência\-DIRF” de  2016 para 2017\. Esse campo poderá ser alterado\.

Na tela da ‘Geração DIRF’ quando o parâmetro ‘Extinção’ for selecionado, o default dos campos Ano\-Calendário e Ano Referência\-DIRF serão  2017 e  2017, caso contrário preencher com 2016, 2017 respectivamente\.
...
OBS: as regras contidas nesse documento devem ser referentes ao ano referência 2017\. Os outros ano\-referência devem ser gerados através dos outros layouts\.
...
Gravar no campo 3 – Ano\-calendário a informação do campo “Ano\-Calendário” da tela de geração da DIRF \(módulo: Obrigações de Tributos Federais, menu DIRF >> Geração DIRF\)\. Para tanto a informação deve estar preenchida com as opções 2016 e 2017\. 
...
Gravar no campo 6 – Identificador de Estrutura do leiaute o valor fixo P49VS72\.
...
__\[ALTERADA CH2222\_2017\]__

__Obs\.: __Desde 2011 nesse campo se um funcionário possuía mais de uma verba como separador as descrições dessas verbas eram feitas por “;” \(ponto e virgula\), porém começou a ocorrer erro na validação desse campo com esse caractere, sendo assim efetuamos testes utilizando apenas “,” \(virgula\) para separar as informações e dessa forma não ocorre critica\. 

Ou seja, no caso haver mais de uma verba deverá ser separada essas descrições com a virgula “,”\.
