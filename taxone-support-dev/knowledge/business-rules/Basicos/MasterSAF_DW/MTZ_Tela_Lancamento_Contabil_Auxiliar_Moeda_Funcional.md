# MTZ_Tela_Lancamento_Contabil_Auxiliar_Moeda_Funcional

- **Fonte:** MTZ_Tela_Lancamento_Contabil_Auxiliar_Moeda_Funcional.docx
...
Lançamento Contábil Auxiliar em Moeda Funcional
...
Criação da Tela Lançamento Contábil Auxiliar em Moeda Funcional
...
__                                   __Menu: Manutenção >> Contabilidade >> Movimentos em Moeda Funcional >> Diário Auxiliar

__Título da tela: __Lançamento Contábil Auxiliar em Moeda Funcional
...
__      MFS11427__: Alterado o funcionamento da janela de pesquisa \(opção <Abre>\) para ficar de acordo com o padrão utilizado na manutenção da
                               ...
                               respectiva tabela de lançamentos do menu original, em moeda nacional \(SAFX101\)\. 
