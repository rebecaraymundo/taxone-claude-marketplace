# MTZ_Tela_Transferencia_Saldo_Plano_Contas_Anterior_Moeda_Funcional

- **Fonte:** MTZ_Tela_Transferencia_Saldo_Plano_Contas_Anterior_Moeda_Funcional.docx
...
Transferência de Saldos de Plano de Contas Anterior em Moeda Funcional
...
Criação da Tela Transferência de Saldos de Plano de Contas Anterior em Moeda Funcional
...
__Localização da tela:__ 
                     ...
                     __Módulo:__ MasterSAF\-DW >> Básicos >> MasterSAF DW

__                     Menu__: Manutenção >> Contabilidade >> Movimentos em Moeda Funcional >> Diário Geral >> Saldo Contábil em Moeda Funcional

__Título da tela: __Transferência de Saldos de Plano de Contas Anterior em Moeda Funcional

__Funcionamento da tela__: o acesso a esta tela será realizado através do botão do menu da tela de Saldos por Estabelecimento
