# MTZ_REPORT_FISCAL_Geracao_Relatorio_Analitico_Detalhamento_por_Produto_Via_Servidor

- **Fonte:** MTZ_REPORT_FISCAL_Geracao_Relatorio_Analitico_Detalhamento_por_Produto_Via_Servidor.docx
...
Menu:
    ...
    __No MasterSAF: __Gerenciais >> Documentos Fiscais >> Analíticos >> Detalhamento por Produto \(Via Servidor\)

    __No Tax One: __     Gerenciais >>  Documentos Fiscais   >> Analíticos >>  Detalhamento por produto >> Geração e Emissão
...
Este documento tem como objetivo criar a rotina de geração do relatório analítico Detalhamento por Produto \(Via Servidor\)\.

CH13715\_2015

Julyana Perrucini

Este documento tem como objetivo incluir os campos Base IPI, Alíquota IPI e Valor IPI no relatório Detalhamento por Produto \(Via Servidor\)\.

MFS\_3582

Eric Amorim Celestrino

Este relatório tem o objetivo de incluir os campos Valor FCP UF Destino, Valor ICMS UF Destino e Valor ICMS UF Origem nos relatórios de Detalhamento por Produto \(Via Servidor\)\.

MFS\_4310

João Henrique de Araujo

Este relatório tem o objetivo de incluir os campos: IPI Isentas, IPI Outras, Base ICMSS e alterar a regra do campo Base IPI\.
...
Inclusão de tratamento para selecionar um período máximo de 12 meses, para evitarmos problemas de Performance\.
...
Inclusão de campos solicitados pela Magalu\.

MFS611130

Andréa Rocha

Inclusão da coluna de UF de consumo no relatório\.
...
__\[ALTERAÇÃO\-MFS524569\]__ Tratamento para selecionar um período máximo de 6 anos\.

Para evitarmos problemas de Performance, foi incluído o tratamento para permitir ao usuário selecionar um período máximo de 12 meses\. 

Caso o usuário selecione um período maior de 6 anos, não executar a geração e criar o seguinte Log de Mensagem:  *Favor informar um período de no máximo 6 anos\.*
...
Cod Estado – Campo 07 da SAFX07 de acordo com o cadastrado na SAFX04\.
...
Código de Tributação IPI – Campo 148 da SAFX08\.
...
Campo Percentual Biodiesel B100 \- Recuperar campo PERC\_B100 da SAFX325\.

Campo Percentual GLP \- Recuperar campo PERC\_GLP da SAFX325\.

Campo Percentual GLGNn \- Recuperar campo PERC\_GLGN\_N da SAFX325\.

Campo Percentual GLGNi \- Recuperar campo PERC\_GLGN\_I da SAFX325\.

Campo Origem Mercadoria \- Recuperar campo IND\_ORIGEM\_COM da SAFX325\.

Campo Qtd\. Tributada Mono Proprio \- Recuperar campo QTD\_BC\_MONO da SAFX325\.
...
Campo Qtd\. Tributada Retencao \- Recuperar campo QTD\_BC\_MONO\_RETEN da SAFX325\.
...
Campo Percentual Reducao Ad Rem \- Recuperar campo PERC\_RED\_AD\_REM da SAFX325\.

Campo Motivo Reducao Ad Rem \- Recuperar campo DSC\_RED\_AD\_REM da SAFX325\.

Campo Valor ICMS Mono Operacao \- Recuperar campo VLR\_ICMS\_MONO\_OP da SAFX325\.

Campo Percentual Diferido \- Recuperar campo PERC\_DIF da SAFX325\.

Campo Valor ICMS Mono Diferido \- Recuperar campo VLR\_ICMS\_MONO\_DIF da SAFX325\.

Campo Qtd\. Bc Mono Retido \- Recuperar campo QTD\_BC\_MONO\_RET da SAFX325\.
...
Campo Vlr\_Frete \(Capa\) – Campo 24 \- Valor Frete \(VLR\_FRETE\) da SAFX07

Campo Vlr\_Frete \(Item\) – Campo 39 \- Valor Frete \(VLR\_FRETE\) da SAFX08

Campo DAT\_LANC\_PIS\_COFINS \(Capa\) – Campo 247 – “Data de Lançamento na EFD\-PIS/PASEP\-COFINS” \(DAT\_LANC\_PIS\_COFINS\) da SAFX07

Campo DAT\_LANC\_PIS\_COFINS \(Item\) – Campo 196 – “Data de Lançamento na EFD\-PIS/PASEP\-COFINS” \(DAT\_LANC\_PIS\_COFINS\) da SAFX08

DSC\_CFO: campo DESCRICAO da SAFX2012 referente ao campo 22 – Código Fiscal \(COD\_CFO\) da SAFX08

DSC\_NATUREZA\_OP: campo DESCRICAO da SAFX2006 referente ao campo 23 – Natureza da Operação \(COD\_NATUREZA\_OP\) da SAFX08

__\[MFS611130\]__ Inclusão do campo UF Consumo

Campo UF Consumo – Campo 207 \- UF do Ponto de Consumo/Terminal Faturado \(UF\_CONSUMO\) da SAFX07\.
