# MTZ-Importacao_Batch_SAFX42

- **Fonte:** MTZ-Importacao_Batch_SAFX42.docx
...
# Módulo Job Servidor – Importação Batch SAFX42 \(Documento Fiscal Utilities\)

__Localização: __

__Menu__: Básicos

__Módulo__: Job Servidor 🡪 item Importação 🡪 Execução
...
Alteração do tamanho do campo 42 \- Código Barras
...
Alterar a rotina de Importação Batch para que seja considerado o novo campo:
...
__Campo 13 – Modelo do Documento__

Tabela de Origem: SAFX2024

Codigos de Modelos aceitos: 01, 06, 21, 22, 28, 29 e 66\.

Se o código informado não foi um dos acima mencionados, exibir a seguinte mensagem e não importar o registro:

*“91068 \- Modelo invalido para este tipo de documento \(codigo validos: 01, 06, 21, 22, 28, 29  ou 66\)”*
...
__Campo 42 – Código Barras__

__Item__:__ __42

__Nome do Campo__: COD\_BARRAS

__Descrição__: Código Barras

__Tamanho__:__ __024 048
...
A rotina de Importação Batch do módulo JOB Servidor deve ser ajustada para que contemple a alteração de aumento do campo COD\_CANAL\_DISTRIB da tabela SAFX42\-Capa de Documentos Fiscais de Utilities\. 
...
A rotina de Importação Batch do módulo JOB Servidor deve ser ajustada para que contemple a alteração no campo NUM\_LANCTO\_CONTAIL da tabela SAFX42 – Arquivo de Notas Fiscais para Hotéis, que deve ser criada com a seguinte estrutura:
...
Os conteúdos válidos para este campo são “06”, “21” ou “22” e devem estar cadastrados na SAFX2024\. Se for diferente deste conteúdo, utilizar a mensagem 91068 da TFIX22: “Modelo invalido para este tipo de documento \(codigo validos: 06, 21 ou 22\)”\.
