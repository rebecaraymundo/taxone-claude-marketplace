# MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX268

- **Fonte:** MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX268.docx
- **Modificado:** 2022-01-12
- **Tamanho:** 73 KB
...
Regras de Importação Online e Batch SAFX268
...
<a id="OLE_LINK1"></a><a id="OLE_LINK2"></a><a id="OLE_LINK3"></a>Definição das regras de importação, Online e Batch, da SAFX268 para atender os Registros K292 e K302 da EFD\-ICMS/IPI/ISS\.
...
Alteração da importação online e importação batch para considerar a informação de Data Fim valid\_produto
...
A rotina de importação, online e batch, do módulo JOB Servidor deve ser ajustada para que contemple as informações da tabela SAFX268 – Produção Conjunta – Insumo Consumido, que deve ser criada com a seguinte estrutura:
...
__Tratamento: __Considerar a Data Fim da geração para recuperar o Código de Produto\.

Recuperar a informação do campo de COD\_PRODUTO da tabela X13\_PRODUTO, considerando a regra abaixo:

  \- VALID\_PRODUTO da tabela X13\_PRODUTO <= TO\_DATE\(DATA\_INI\_W, 'YYYYMMDD'\)

  \- VALID\_PRODUTO da tabela X13\_PRODUTO <= TO\_DATE\(DATA\_FIM\_W, 'YYYYMMDD'\)

  \- Identificar o GRUPO\_PRODUTO;

  \- IND\_PRODUTO da tabela X13\_PRODUTO = IND\_PRODUTO da tabela SAFX268;

  \- COD\_PRODUTO da tabela X13\_PRODUTO = COD\_PRODUTO da tabela SAFX268;
...
__Campo Quantidade Consumida__
