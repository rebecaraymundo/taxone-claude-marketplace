...
# Módulo Job Servidor – Carga SAFX42 \(Documento Fiscal de Utilities\)
...
A rotina de Carga do módulo JOB Servidor deve ser ajustada para que contemple a alteração no campo NUM\_LANCTO\_CONTAIL da tabela SAFX42 – Arquivo de Notas Fiscais para Hotéis, que deve ser criada com a seguinte estrutura:
...
A rotina de Carga do módulo JOB Servidor deve ser ajustada para que contemple a alteração de aumento do campo COD\_CANAL\_DISTRIB da tabela SAFX42\-Capa de Documentos Fiscais de Utilities\. 
