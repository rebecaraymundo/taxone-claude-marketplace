# MTZ_JOB_SERVIDOR_CARGA_SAFX531

- **Fonte:** MTZ_JOB_SERVIDOR_CARGA_SAFX531.docx
...
Definição das regras de carga da SAFX531\.
...
Inclusão de validação nos campos \(23 à 27\) \(regra documentada na matriz de importação\)

Inclusão de regra de exclusão de registros \(regra documentada/detalhada na matriz de importação\) 
...
Inclusão de validação nos campos \(28 à 37\) \(regra documentada/detalhada na matriz de importação\)
...
A rotina de carga do módulo JOB Servidor deve ser ajustada para que contemple as informações da tabela SAFX531 \- Rendimentos de Decisão Judicial, que deve ser criada com a seguinte estrutura:
