...
# Módulo Job Servidor – Carga SAFX147 \(Demais Documentos e Operações Geradoras de Crédito\)
...
A rotina de Carga do módulo JOB Servidor deve ser ajustada para que contemple a alteração no campo NUM\_LANCTO da tabela SAFX147 – Demais documentos e Operações Geradoras de crédito, que deve ser criada com a seguinte estrutura:
