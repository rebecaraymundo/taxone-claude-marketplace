# MTZ_JOB_SERVIDOR_Exportacao_SAFX126

- **Fonte:** MTZ_JOB_SERVIDOR_Exportacao_SAFX126.docx
...
<a id="OLE_LINK1"></a><a id="OLE_LINK2"></a><a id="OLE_LINK3"></a>Definição das regras de exportação dos novos campos incluídos na SAFX126\.
