# MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX252

- **Fonte:** MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX252.docx
...
Definição das regras de importação, Online e Batch, da SAFX252\.
...
A rotina de importação, online e batch, do módulo JOB Servidor deve ser ajustada para que contemple as informações da tabela SAFX252 \- Ajuste da Contribuição Previdenciária Apurada, que deve ser criada com a seguinte estrutura:
...
__Campo Tipo de Ajuste__

Tipo de ajuste, sendo:

0 – Ajuste de redução;

1 – Ajuste de acréscimo\.

Como o campo é obrigatório de preenchimento, deve ser exibida mensagem de erro caso não esteja preenchido: “Tipo de Ajuste não informado”\. 

MFS14997

RN10

__Campo Código de Ajuste __

Código de ajuste, sendo:
...
9. Receita bruta reconhecida pela construção, recuperação, reforma, ampliação ou melhoramento da infra\-estrutura, cuja contrapartida seja ativo intangível representativo de direito de exploração, no caso de contratos de concessão de serviços públicos\.
...
Como o campo é obrigatório de preenchimento, deve ser exibida mensagem de erro caso não esteja preenchido: “Código de Ajuste não informado”\. 
...
__Campo Valor de Ajuste__

O valor informado neste campo deve ser maior que zero, senão exibir a seguinte msg ao usuário: “O valor informado no campo Valor de Ajuste deve ser maior que zero\.”\.

Como o campo é obrigatório de preenchimento, deve ser exibida mensagem de erro caso não esteja preenchido: “Valor de Ajuste não informado\.”\.

MFS14997

RN12

__Campo Descrição do Ajuste__

Como o campo é obrigatório de preenchimento, deve ser exibida mensagem de erro caso não esteja preenchido: “Descrição do Ajuste não informado”\. 

MFS14997

RN13

__Campo Data do Ajuste__

Como o campo é obrigatório de preenchimento, deve ser exibida mensagem de erro caso não esteja preenchido: “Data do Ajuste não informado”\. 
