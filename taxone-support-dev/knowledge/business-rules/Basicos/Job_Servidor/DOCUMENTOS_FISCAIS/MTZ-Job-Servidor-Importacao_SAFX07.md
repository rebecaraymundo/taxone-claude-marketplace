...
Ajuste nos campos Finalidade Emissão da Nfe e Modelo Doc\. Fiscal NF Substituída para atendimento ao Modelo de Documento 57  atendimento ao Infolegis nº 198/23 – Z – 649 \- EFD ICMS/IPI – CT\-e Substituição – SPED Fiscal Registro D100 \- campo 14\.
...
Inclusão de Cte Simplificado no campo Situação Especial para atendimento ao Sped Fiscal 2025
...
Inclusão de tratamento na importação quando o parâmetro “Parâmetro por Data Fiscal” estiver marcado, passara a considerar a data do Campo 20 – Data saída/recebimento\.
...
__Regra para o Parâmetro “Parametrização para Data Fiscal”__

__Se o parâmetro estiver marcado:__

Com a empresa/estabelecimento devidamente parametrizada, então incluir ou alterar uma nota fiscal de saída de mercadoria no sistema, sendo por importação ou digitação, o sistema deverá assumir a “Data Fiscal” como sendo a “Data de Saída/Recebimento” \(Campo 20\), ou seja:

Se o campo 03 \(MOVTO\_E\_S\) da SAFX07 = ‘9’

E campo 12 \(COD\_CLASS\_DOC\_FIS\) = ‘1’ ou ‘3’ ou ‘7’, então

A importação deverá considerar como “Data INI” e “Data FIM” preenchido na tela do” Job Servidor” a data do “Campo 20 \- Data de Saída/Recebimento” ou verificar se o documento já existe na base com a DATA\_FISCAL igual a data de escrituração ORIGINAL do sistema, ou seja, Data Fiscal = Data de Saída/Recebimento \(Campo 20 da SAFX07\)

Se sim, então não importar e emitir a seguinte mensagem no log de importação:

“Documento fiscal não importado, pois já existe na base com “Data Fiscal” igual a “Data de Saída/Recebimento” 

Se não, então importar o documento e considerar DATA\_FISCAL = DATA\_SAIDA\_REC \(Campo da SAFX07\)\.

__Se o parâmetro estiver Desmarcado:__

Se o campo 03 \(MOVTO\_E\_S\) da SAFX07 = ‘9’

E campo 12 \(COD\_CLASS\_DOC\_FIS\) = ‘1’ ou ‘3’ ou ‘7’, então

A importação deverá considerar como Data INI e Data Fim, preenchido na tela do” Job Servidor” a data do “Campo 11 \- Data Emissão” ou verificar se o documento já existe na base com a DATA\_FISCAL igual a data de escrituração ORIGINAL do sistema, ou seja, Data Fiscal = Data Emissão \(Campo 11 da SAFX07\)

Se sim, então não importar e emitir a seguinte mensagem no log de importação:

“Documento fiscal não importado, pois já existe na base com “Data Fiscal” igual a “Data de Emissão” 

Obs\.: Esta regra somente será válida Se campo 01 \(COD\_EMPRESA\) OU campo 02 \(COD\_ESTAB\) estiver corretamente parametrizado em "Módulo: Básicos > Parâmetros, Menu: Preliminares > Parametrização para Data Fiscal"

__Se não__, então importar o documento e continuar escriturando da forma como é feita hoje:
...
H \- Substituição CT\-e Simplificado
...
\[__MFS695271\]:__ inclusão do código “G” e “H”
...
Poderá ser preenchido apenas quando o Modelo do Documento = 66 \(NF3e\) ou 62 \(NFCom\) e 57 \(CT\-e\)\. Se for preenchido para qualquer outro modelo de documento, o registro não será importado e será gravada uma mensagem de erro no log\. \(“<a id="_Hlk118835205"></a>*O* *campo Finalidade Emissão NFe deve ser informado apenas quando se tratar de modelo de documento = 62 ou 66 ou 57*”\)\.
...
Os conteúdos válidos para este campo são “01”, “06”, “21”, “22” ou “66” ou “62” ou “57” e devem estar cadastrados na SAFX2024\. Se for diferente deste conteúdo, gerar a mensagem de erro no log: “<a id="_Hlk118835150"></a>*Código do Modelo de Documento Fiscal NF Substituída invalido\. Os codigos validos são: 01, 06, 21, 22, 57, 62 ou 66*”\. Código erro: <a id="_Hlk118835138"></a>913177

\[__MFS591806\] __Inclusão do__ __modelo de documento = “57” \(CT\-e – Conhecimento de Transporte Eletrônico\)
