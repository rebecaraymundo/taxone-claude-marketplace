# MTZ-Importacao_SAFX431

- **Fonte:** MTZ-Importacao_SAFX431.docx
...
Se classificação da nota = 1 \(Mercadoria\) 🡪 neste caso, a classificação dos itens só pode ser = 1 \(Mercadoria\);

Se classificação da nota = 2 \(Serviço\) 🡪 neste caso, a classificação dos itens só pode ser = 2 \(Serviço\);

Se classificação da nota = 3 \(Mista\) 🡪 neste caso, a classificação dos itens pode ser = 1 \(Mercadoria\) ou 2 \(Serviço\);
