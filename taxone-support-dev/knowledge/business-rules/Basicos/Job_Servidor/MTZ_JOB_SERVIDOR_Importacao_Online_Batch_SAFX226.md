# MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX226

- **Fonte:** MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX226.docx
...
Regras de Importação Online e Batch SAFX226
...
Definição das regras de importação, Online e Batch, da SAFX226\.
...
A rotina de importação, online e batch, do módulo JOB Servidor deve ser ajustada para que contemple as informações da tabela SAFX226 – Saldo Contábil em Moeda Funcional, que deve ser criada com a seguinte estrutura:
...
Se o valor do Saldo Final for igual a zero, esta regra não será aplicada\.
