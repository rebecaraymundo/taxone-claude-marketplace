# MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX189

- **Fonte:** MTZ_JOB_SERVIDOR_Importacao_Online_Batch_SAFX189.docx
...
Regras de Importação Online e Batch SAFX189
...
Definição das regras de importação, Online e Batch, da SAFX189\.

MFS10643

Lara Aline

Ajuste na importação para considerar o novo campo Grupo X189 na tela de Programação de Jobs de Importação\.
...
Quando o campo “Grupo X189” da tela de programação da importação on line e da importação batch estiver preenchido, na importação os campos conta contábil e centro de custos do Plano de Contas Anterior \(campos 06 e 07 da SAFX189\) serão validados com dados da SAFX2002 do grupo indicado\. Se o campo estiver desmarcado, a importação deve considerar o mesmo grupo do estabelecimento da importação, conforme padrão\. 

MFS10643

RN00

A rotina de importação, online e batch, do módulo JOB Servidor deve ser ajustada para que contemple as informações da tabela SAFX189 \- Transferência de Saldos de Plano de Contas Anterior por Centro de Custo, que deve ser criada com a seguinte estrutura:
...
Verificar através dos campos Código da Empresa, Código do Estabelecimento, Conta Débito/Crédito do Lançamento, Centro de Custo e Data da Operação se existe registro correspondente na tabela SAFX80 – Arquivo de Saldos Contábeis por Centro de Custo\. Caso não exista, retornar mensagem de erro: “Saldo Mensal não encontrado\.”\.
...
Verificar a existência do código do Centro de Custo do Plano de Contas Anterior na tabela SAFX2003\. Caso não exista, retornar mensagem de erro: “Não existe cadastro para a Centro de Custo do Lançamento do Plano de Contas Anterior informado”\.
