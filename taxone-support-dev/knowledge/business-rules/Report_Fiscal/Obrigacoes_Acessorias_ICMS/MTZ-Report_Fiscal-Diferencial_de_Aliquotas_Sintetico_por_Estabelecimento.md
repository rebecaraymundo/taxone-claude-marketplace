---
source: "MTZ-Report_Fiscal-Diferencial_de_Aliquotas_Sintetico_por_Estabelecimento.doc"
category: Report_Fiscal
converted: auto
---

Report Fiscal - Relatório de Diferencial de Alíquota Sintético por Estabelecimento
...
Senão
  Se (parâmetro 92 Marcado):
     ...
     Se UF do Estabelecimento = "PR" ou "MG" --> Neste caso será utilizada a regra de cálculo descrita na RN106.c;
