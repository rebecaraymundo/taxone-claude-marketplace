---
source: "MTZ-RF-ICMS-UTILITIES-CFOP.doc"
category: Report_Fiscal
converted: auto
---

Report Fiscal - Resumo do ICMS Utilities por Código Fiscal Operação - CFOP

Localização:
Módulo: Básicos --> Report Fiscal
Menu: Obrigações Acessórias --> ICMS --> Resumo do ICMS Utilities --> por Código Fiscal Operação - CFOP
