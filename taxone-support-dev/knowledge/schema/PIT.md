...
| 21 | COD_TRIB_INT | NUMBER(5) | Y |  |  |
| 22 | COD_ESTAB | VARCHAR2(6) | Y | ' ' |  |
| 23 | VLR_PISS | NUMBER(17,2) | Y |  |  |
| 24 | VLR_ICMSS_CF | NUMBER(17,2) | Y |  |  |
| 25 | VLR_COFINSS | NUMBER(17,2) | Y |  |  |

**Indexes**:
- IX_PIT_BASE_CFO: (COD_EMPRESA, COD_ESTAB, GRUPO_PIS, ANO_COMP, MES_COMP, IND_TIPO, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP)
...
**Indexes**:
- IX_PIT_BASE_ECF: (COD_EMPRESA, COD_ESTAB, DATA_FISCAL, COD_EQUIPAMENTO, SEQUENCIAL, GRUPO_PRODUTO, IND_PRODUTO, COD_PRODUTO, COD_TRIB_INT, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP)
...
| 15 | ALIQ_PIS | NUMBER(7,4) | Y |  |  |
| 16 | VLR_PIS | NUMBER(17,2) | Y |  |  |
| 17 | ALIQ_COFINS | NUMBER(7,4) | Y |  |  |
| 18 | VLR_COFINS | NUMBER(17,2) | Y |  |  |
...
| 24 | VLR_PISS | NUMBER(17,2) | Y |  |  |
| 25 | VLR_ICMSS_CF | NUMBER(17,2) | Y |  |  |
| 26 | VLR_COFINSS | NUMBER(17,2) | Y |  |  |

**Indexes**:
- IX_PIT_BASE_MONTAD: (COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP, IND_TIPO, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP, COD_NBM)
...
| 16 | VLR_BASE_PIS | NUMBER(17,2) | Y |  |  |
| 17 | ALIQ_PIS | NUMBER(7,4) | Y |  |  |
| 18 | VLR_PIS | NUMBER(17,2) | Y |  |  |
| 19 | NRO_PROCESSO | NUMBER(12) | Y |  |  |
| 20 | USUARIO | VARCHAR2(40) | Y |  |  |
| 21 | IND_DIG_CALC | CHAR(1) | Y |  |  |
| 22 | VLR_ICMS | NUMBER(17,2) | Y |  |  |
...
**Indexes**:
- IX_PIT_BASE_PROD: (COD_EMPRESA, COD_ESTAB, GRUPO_PIS, ANO_COMP, MES_COMP, IND_TIPO, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP, GRUPO_PRODUTO)
...
| 14 | ALIQ_PIS | NUMBER(7,4) | Y |  |  |
| 15 | VLR_PIS | NUMBER(17,2) | Y |  |  |
| 16 | VLR_BASE_COFINS | NUMBER(17,2) | Y |  |  |
| 17 | ALIQ_COFINS | NUMBER(7,4) | Y |  |  |
| 18 | VLR_COFINS | NUMBER(17,2) | Y |  |  |
...
| 23 | COD_ESTAB | VARCHAR2(6) | N | ' ' |  |

**PK**: COD_EMPRESA, COD_ESTAB, GRUPO_PIS, ANO_COMP, MES_COMP, IND_TIPO, GRUPO_SERVICO, COD_SERVICO, NUM_DOCFIS, DAT_DOC
...
| 6 | CLASSE_PIS | NUMBER(3) | N |  |  |
| 7 | VALID_CLASSE | DATE | N |  |  |
| 8 | VLR_BASE_PIS | NUMBER(17,2) | Y |  |  |

**PK**: COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP, GRUPO_MONOF, CLASSE_PIS, VALID_CLASSE

**FKs**:
- GRUPO_MONOF, CLASSE_PIS, VALID_CLASSE → PIT_GRP_CLASSE(GRUPO_MONOF, CLASSE_PIS, VALID_CLASSE)
...
**Indexes**:
- IX_PIT_COMIS_MONTAD: (COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP)
...
**Indexes**:
- IX_PIT_CRED_EST: (COD_EMPRESA, COD_ESTAB, DAT_INVENT)
...
| 42 | VLR_PIS | NUMBER(17,2) | Y |  |  |

**Indexes**:
- IX_PIT_DEM_APUR: (COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP)
...
| 8 | CLASSE_PIS | NUMBER(3) | N |  |  |
| 9 | COD_NBM | VARCHAR2(10) | N |  |  |
| 10 | VLR_BASE_PIS | NUMBER(17,2) | Y |  |  |
| 11 | NUM_PROCESSO | NUMBER(12) | Y |  |  |
| 12 | USUARIO | VARCHAR2(40) | Y |  |  |

**PK**: COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP, SEQ_CLASSE, COD_PARAM, GRUPO_MONOF, CLASSE_PIS, COD_NBM
...
**Indexes**:
- IX_PIT_DOC_FRETE: (COD_EMPRESA, COD_ESTAB, DATA_FISCAL, IDENT_DOCTO, IDENT_FIS_JUR, NUM_DOCFIS, SERIE_DOCFIS, SUB_SERIE_DOCFIS, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP)
...
**Indexes**:
- IX_PIT_DOC_MERC: (COD_EMPRESA, COD_ESTAB, DATA_FISCAL, IDENT_DOCTO, IDENT_FIS_JUR, NUM_DOCFIS, SERIE_DOCFIS, SUB_SERIE_DOCFIS, GRUPO_PRODUTO, IND_PRODUTO, COD_PRODUTO, COD_NBM, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP)
...
**Indexes**:
- IX_PIT_DOC_SERV: (COD_EMPRESA, COD_ESTAB, DATA_FISCAL, IDENT_DOCTO, IDENT_FIS_JUR, NUM_DOCFIS, SERIE_DOCFIS, SUB_SERIE_DOCFIS, GRUPO_SERVICO, COD_SERVICO)
...
| # | Coluna | Tipo | Null | Default | Comment |
|---|--------|------|------|---------|--------|
| 1 | GRUPO_PIS | NUMBER(2) | N |  |  |
| 2 | VALID_GRUPO | DATE | N |  |  |
| 3 | ALIQ_PIS | NUMBER(7,4) | Y |  |  |
| 4 | ALIQ_COFINS | NUMBER(7,4) | Y |  |  |
| 5 | ALIQ_CRED_INV | NUMBER(7,4) | Y |  |  |
| 6 | ALIQ_CRED_ALIM | NUMBER(7,4) | Y |  |  |

**PK**: GRUPO_PIS, VALID_GRUPO
...
| 2 | ANO_COMP | NUMBER(4) | N |  |  |
| 3 | MES_COMP | NUMBER(2) | N |  |  |
| 4 | VLR_COMP_DEB_PIS | NUMBER(17,2) | Y |  |  |
...
| 4 | CLASSE_PIS | NUMBER(3) | N |  |  |
| 5 | VALID_CLASSE | DATE | N |  |  |
| 6 | COD_NBM | VARCHAR2(10) | N |  |  |

**PK**: COD_EMPRESA, COD_ESTAB, GRUPO_MONOF, CLASSE_PIS, VALID_CLASSE, COD_NBM
...
| 21 | IND_DED_PISS | CHAR(1) | Y |  |  |
| 22 | IND_DED_COFINSS | CHAR(1) | Y | 'N' | Indicador de dedução do COFINS-ST na base de calculo do PIS, caso este campo seja S, o valor sera sempre deduzido da base |
...
| 19 | VLR_PISS | NUMBER(17,2) | Y |  |  |
| 20 | VLR_ICMSS_CF | NUMBER(17,2) | Y |  |  |
| 21 | VLR_COFINSS | NUMBER(17,2) | Y |  |  |

**Indexes**:
- IX_PIT_VEND_COM_EX: (COD_EMPRESA, COD_ESTAB, ANO_COMP, MES_COMP, COD_CFO, GRUPO_NATUREZA_OP, COD_NATUREZA_OP, GRUPO_FIS_JUR, IND_FIS_JUR, COD_FIS_JUR)
